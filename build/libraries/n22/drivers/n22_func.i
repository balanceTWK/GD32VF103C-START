# 1 "libraries/n22/drivers/n22_func.c"
...
# 3 "libraries/n22/drivers/n22_func.c" 2
...
# 18 "/home/tang/toolchains/riscv-none-gcc/8.2.0-2.2-20190521-0004/riscv-none-embed/include/newlib.h" 3
...
# 216 "/home/tang/toolchains/riscv-none-gcc/8.2.0-2.2-20190521-0004/lib/gcc/riscv-none-embed/8.2.0/include/stddef.h" 3 4
...
# 4 "libraries/n22/drivers/n22_func.c" 2
...
# 5 "libraries/n22/drivers/n22_func.c" 2
...
# 21 "/home/tang/toolchains/riscv-none-gcc/8.2.0-2.2-20190521-0004/riscv-none-embed/include/string.h" 2 3
...
# 6 "libraries/n22/drivers/n22_func.c" 2
# 1 "/home/tang/toolchains/riscv-none-gcc/8.2.0-2.2-20190521-0004/riscv-none-embed/include/unistd.h" 1 3

#define _UNISTD_H_ 

# 1 "/home/tang/toolchains/riscv-none-gcc/8.2.0-2.2-20190521-0004/riscv-none-embed/include/sys/unistd.h" 1 3
...
#define offsetof(TYPE,MEMBER) __builtin_offsetof (TYPE, MEMBER)
# 15 "/home/tang/toolchains/riscv-none-gcc/8.2.0-2.2-20190521-0004/riscv-none-embed/include/sys/unistd.h" 2 3
...
# 44 "/home/tang/toolchains/riscv-none-gcc/8.2.0-2.2-20190521-0004/riscv-none-embed/include/sys/unistd.h" 3
int daemon (int nochdir, int noclose);

int dup (int __fildes);
int dup2 (int __fildes, int __fildes2);
# 56 "/home/tang/toolchains/riscv-none-gcc/8.2.0-2.2-20190521-0004/riscv-none-embed/include/sys/unistd.h" 3
...
pid_t vfork (void);
# 283 "/home/tang/toolchains/riscv-none-gcc/8.2.0-2.2-20190521-0004/riscv-none-embed/include/sys/unistd.h" 3
...
# 5 "/home/tang/toolchains/riscv-none-gcc/8.2.0-2.2-20190521-0004/riscv-none-embed/include/unistd.h" 2 3
# 7 "libraries/n22/drivers/n22_func.c" 2
...
# 9 "libraries/n22/drivers/n22_func.c" 2
# 1 "libraries/n22/drivers/n22_func.h" 1
# 10 "libraries/n22/drivers/n22_func.c" 2


# 11 "libraries/n22/drivers/n22_func.c"
void switch_m2u_mode() {
...
uint32_t mtime_lo(void) {
    return *(volatile uint32_t *) (0xd1000000 + 0x0);
}

uint32_t mtime_hi(void) {
    return *(volatile uint32_t *) (0xd1000000 + 0x0 + 4);
}

void enable_timer_interrupt(void) {
    *(volatile uint32_t *) (0xd1000000 + 0x0 + 0xffc) = 1;
}

void clear_timer_interrupt(void) {
    *(volatile uint32_t *) (0xd1000000 + 0x0 + 0xffc) = 0;
}

void close_timer(void) {
    *(volatile uint32_t *) (0xd1000000 + 0x0 + 0xff8) = 1;
}

void open_timer(void) {
    *(volatile uint32_t *) (0xd1000000 + 0x0 + 0xff8) = 0;
}
...
uint32_t get_timer_freq() {
    return ((uint32_t)SystemCoreClock/4);
}
...
void eclic_init(uint32_t num_irq) {
    ...
    *(volatile uint8_t*) (0xd2000000 + 0x0) = 0;


    *(volatile uint8_t*) (0xd2000000 + 0xB) = 0;


    vuint32_t * ptr;

    vuint32_t * base = (vuint32_t*) (0xd2000000 + (0x1000UL));
...
void eclic_enable_interrupt(uint32_t source) {
    *(volatile uint8_t*) (0xd2000000 + (0x1001UL) + source * 4) =
            1;
}
...
void eclic_set_pending(uint32_t source) {
    *(volatile uint8_t*) (0xd2000000 + (0x1000UL) + source * 4) =
            1;
}
...
void eclic_set_intctrl(uint32_t source, uint8_t intctrl) {
    *(volatile uint8_t*) (0xd2000000 + (0x1003UL) + source * 4) =
            intctrl;
}

uint8_t eclic_get_intctrl(uint32_t source) {
    return *(volatile uint8_t*) (0xd2000000 + (0x1003UL)
            + source * 4);
}

void eclic_set_intattr(uint32_t source, uint8_t intattr) {
    *(volatile uint8_t*) (0xd2000000 + (0x1002UL) + source * 4) =
            intattr;
}

uint8_t eclic_get_intattr(uint32_t source) {
    return *(volatile uint8_t*) (0xd2000000 + (0x1002UL)
            + source * 4);
}

void eclic_set_ecliccfg(uint8_t ecliccfg) {
    *(volatile uint8_t*) (0xd2000000 + 0x0) = ecliccfg;
}

uint8_t eclic_get_ecliccfg() {
    return *(volatile uint8_t*) (0xd2000000 + 0x0);
}

void eclic_set_mth(uint8_t mth) {
    *(volatile uint8_t*) (0xd2000000 + 0xB) = mth;
}

uint8_t eclic_get_mth() {
    return *(volatile uint8_t*) (0xd2000000 + 0xB);
}
...
void eclic_set_nlbits(uint8_t nlbits) {
    ...
    uint8_t new_ecliccfg = (old_ecliccfg & (~(0x1EUL)))
            | ((0x1EUL) & nlbits_shifted);
...
uint8_t eclic_get_int_priority(uint32_t source) {
    ...
    uint8_t priority = intctrl >> (nlbits + (8 - 4));
