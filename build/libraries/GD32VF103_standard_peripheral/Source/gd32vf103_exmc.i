# 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_exmc.c"
...
# 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_exmc.c"
# 35 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_exmc.c"
...
# 39 "libraries/GD32VF103_standard_peripheral/Include/gd32vf103_exmc.h" 2
...
# 36 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_exmc.c" 2
...
# 58 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_exmc.c"
void exmc_norsram_deinit(uint32_t norsram_region)
{

    if(((uint32_t)0x00000000U) == norsram_region){
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0xA0000000U)) + 0x08U * (norsram_region))) = ((uint32_t)0x000030DAU);
    }

    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0xA0000000U)) + 0x04U + 0x08U * (norsram_region))) = ((uint32_t)0x0FFFFFFFU);
}
...
void exmc_norsram_struct_para_init(exmc_norsram_parameter_struct* exmc_norsram_init_struct)
{
    ...
    exmc_norsram_init_struct->norsram_region = ((uint32_t)0x00000000U);
    exmc_norsram_init_struct->address_data_mux = ENABLE;
    exmc_norsram_init_struct->memory_type = (((0xFFFFFFFFUL << (2)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3)))) & ((uint32_t)(0) << 2));
    exmc_norsram_init_struct->databus_width = (((0xFFFFFFFFUL << (4)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(5)))) & ((uint32_t)(1) << 4));
    exmc_norsram_init_struct->nwait_polarity = ((uint32_t)0x00000000U);
...
# 108 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_exmc.c"
void exmc_norsram_init(exmc_norsram_parameter_struct* exmc_norsram_init_struct)
{
    uint32_t snctl = 0x00000000U, sntcfg = 0x00000000U;


    snctl = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0xA0000000U)) + 0x08U * (exmc_norsram_init_struct->norsram_region)));


    snctl &= ((uint32_t)~(((uint32_t)((uint32_t)0x01U<<(6))) | ((0xFFFFFFFFUL << (2)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3)))) | ((0xFFFFFFFFUL << (4)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(5)))) | ((uint32_t)((uint32_t)0x01U<<(9))) |
                          ((uint32_t)((uint32_t)0x01U<<(12))) | ((uint32_t)((uint32_t)0x01U<<(13))) | ((uint32_t)((uint32_t)0x01U<<(15))) | ((uint32_t)((uint32_t)0x01U<<(1)))));

    snctl |= (uint32_t)(exmc_norsram_init_struct->address_data_mux << ((uint32_t)1U)) |
                        exmc_norsram_init_struct->memory_type |
                        exmc_norsram_init_struct->databus_width |
                        exmc_norsram_init_struct->nwait_polarity |
                       (exmc_norsram_init_struct->memory_write << ((uint32_t)12U)) |
                       (exmc_norsram_init_struct->nwait_signal << ((uint32_t)13U)) |
                       (exmc_norsram_init_struct->asyn_wait << ((uint32_t)15U));

    sntcfg = (uint32_t)((exmc_norsram_init_struct->read_write_timing->asyn_address_setuptime - 1U ) & ((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3)))) )|
                       (((exmc_norsram_init_struct->read_write_timing->asyn_address_holdtime - 1U ) << ((uint32_t)4U) ) & ((0xFFFFFFFFUL << (4)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) ) |
                       (((exmc_norsram_init_struct->read_write_timing->asyn_data_setuptime - 1U ) << ((uint32_t)8U) ) & ((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(15)))) ) |
                       (((exmc_norsram_init_struct->read_write_timing->bus_latency - 1U ) << ((uint32_t)16U) ) & ((0xFFFFFFFFUL << (16)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(19)))) );


    if((((0xFFFFFFFFUL << (2)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3)))) & ((uint32_t)(2) << 2)) == exmc_norsram_init_struct->memory_type){
        snctl |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(6)));
    }


    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0xA0000000U)) + 0x08U * (exmc_norsram_init_struct->norsram_region))) = snctl;
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0xA0000000U)) + 0x04U + 0x08U * (exmc_norsram_init_struct->norsram_region))) = sntcfg;
}
# 149 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_exmc.c"
void exmc_norsram_enable(uint32_t norsram_region)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0xA0000000U)) + 0x08U * (norsram_region))) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(0)));
}
# 161 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_exmc.c"
void exmc_norsram_disable(uint32_t norsram_region)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0xA0000000U)) + 0x08U * (norsram_region))) &= ~(uint32_t)((uint32_t)((uint32_t)0x01U<<(0)));
}
