...
can_deinit:
.LFB2:
	.file 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_can.c"
	.loc 1 47 1
	.cfi_startproc
	addi	sp,sp,-32
...
.LFE2:
	...
	.align	1
	.globl	can_struct_para_init
	.type	can_struct_para_init, @function
...
.L8:
	...
	j	.L12
.L13:
	.loc 1 106 66 discriminator 3
	lbu	a5,-17(s0)
	.loc 1 106 70 discriminator 3
	lw	a4,-40(s0)
	add	a5,a4,a5
	sb	zero,11(a5)
	.loc 1 105 34 discriminator 3
	lbu	a5,-17(s0)
	addi	a5,a5,1
	sb	a5,-17(s0)
.L12:
...
.L9:
	...
	j	.L14
.L15:
	.loc 1 119 65 discriminator 3
	lbu	a5,-17(s0)
	.loc 1 119 69 discriminator 3
	lw	a4,-40(s0)
	add	a5,a4,a5
	sb	zero,11(a5)
	.loc 1 118 34 discriminator 3
	lbu	a5,-17(s0)
	addi	a5,a5,1
	sb	a5,-17(s0)
.L14:
...
.L11:
	...
	.cfi_endproc
.LFE3:
	.size	can_struct_para_init, .-can_struct_para_init
	.align	1
	.globl	can_init
...
.L45:
	...
	.cfi_endproc
.LFE5:
	.size	can_filter_init, .-can_filter_init
	.align	1
	.globl	can1_filter_start_bank
	.type	can1_filter_start_bank, @function
...
.LFB6:
	...
	.cfi_endproc
.LFE6:
	.size	can1_filter_start_bank, .-can1_filter_start_bank
	.align	1
	.globl	can_debug_freeze_enable
	.type	can_debug_freeze_enable, @function
...
.L50:
	...
	.cfi_endproc
.LFE7:
	.size	can_debug_freeze_enable, .-can_debug_freeze_enable
	.align	1
	.globl	can_debug_freeze_disable
	.type	can_debug_freeze_disable, @function
...
.L54:
	...
	.cfi_endproc
.LFE8:
	.size	can_debug_freeze_disable, .-can_debug_freeze_disable
	.align	1
	.globl	can_time_trigger_mode_enable
	.type	can_time_trigger_mode_enable, @function
...
.L57:
	...
	ori	a5,a5,256
	sw	a5,0(a4)
	.loc 1 392 65 discriminator 3
	lbu	a5,-17(s0)
	addi	a5,a5,1
	sb	a5,-17(s0)
.L56:
	.loc 1 392 5 discriminator 1
	lbu	a4,-17(s0)
	li	a5,2
	bleu	a4,a5,.L57
	.loc 1 395 1
	...
	.cfi_endproc
.LFE9:
	.size	can_time_trigger_mode_enable, .-can_time_trigger_mode_enable
	.align	1
	.globl	can_time_trigger_mode_disable
	.type	can_time_trigger_mode_disable, @function
...
.L60:
	...
	andi	a5,a5,-257
	sw	a5,0(a4)
	.loc 1 411 65 discriminator 3
	lbu	a5,-17(s0)
	addi	a5,a5,1
	sb	a5,-17(s0)
.L59:
	.loc 1 411 5 discriminator 1
	lbu	a4,-17(s0)
	li	a5,2
	bleu	a4,a5,.L60
	.loc 1 414 1
	...
	.cfi_endproc
.LFE10:
	.size	can_time_trigger_mode_disable, .-can_time_trigger_mode_disable
	.align	1
	.globl	can_message_transmit
	.type	can_message_transmit, @function
...
.L67:
	...
	.cfi_endproc
.LFE11:
	.size	can_message_transmit, .-can_message_transmit
	.align	1
	.globl	can_transmit_states
	.type	can_transmit_states, @function
can_transmit_states:
.LFB12:
	.loc 1 489 1
	.cfi_startproc
...
.L81:
	...
	.cfi_endproc
.LFE12:
	.size	can_transmit_states, .-can_transmit_states
	.align	1
	.globl	can_transmission_stop
	.type	can_transmission_stop, @function
...
.L85:
	...
	lw	a5,-20(s0)
	addi	a5,a5,8
	.loc 1 551 55 discriminator 1
	lw	a5,0(a5)
	.loc 1 551 111 discriminator 1
	andi	a4,a5,128
	.loc 1 551 14 discriminator 1
	li	a5,128
	beq	a4,a5,.L85
	.loc 1 564 1
	j	.L90
.L84:
	...
	nop
.L88:
	.loc 1 555 78 discriminator 1
	lw	a5,-20(s0)
	addi	a5,a5,8
	.loc 1 555 56 discriminator 1
	lw	a4,0(a5)
	.loc 1 555 112 discriminator 1
	li	a5,32768
	and	a4,a4,a5
	.loc 1 555 14 discriminator 1
	li	a5,32768
	beq	a4,a5,.L88
	.loc 1 564 1
	j	.L90
.L87:
	...
	nop
.L89:
	.loc 1 559 78 discriminator 1
	lw	a5,-20(s0)
	addi	a5,a5,8
	.loc 1 559 56 discriminator 1
	lw	a4,0(a5)
	.loc 1 559 112 discriminator 1
	li	a5,8388608
	and	a4,a4,a5
	.loc 1 559 14 discriminator 1
	li	a5,8388608
	beq	a4,a5,.L89
.L90:
	.loc 1 564 1
	...
	.cfi_endproc
.LFE13:
	.size	can_transmission_stop, .-can_transmission_stop
	.align	1
	.globl	can_message_receive
	.type	can_message_receive, @function
can_message_receive:
.LFB14:
	.loc 1 583 1
	.cfi_startproc
...
.L96:
	...
	.cfi_endproc
.LFE14:
	.size	can_message_receive, .-can_message_receive
	.align	1
	.globl	can_fifo_release
	.type	can_fifo_release, @function
can_fifo_release:
.LFB15:
	.loc 1 630 1
	.cfi_startproc
...
.L97:
	...
	.cfi_endproc
.LFE15:
	.size	can_fifo_release, .-can_fifo_release
	.align	1
	.globl	can_receive_message_length_get
	.type	can_receive_message_length_get, @function
...
.L103:
	...
	.cfi_endproc
.LFE16:
	.size	can_receive_message_length_get, .-can_receive_message_length_get
	.align	1
	.globl	can_working_mode_set
	.type	can_working_mode_set, @function
...
.L112:
	...
	.cfi_endproc
.LFE17:
	.size	can_working_mode_set, .-can_working_mode_set
	.align	1
	.globl	can_wakeup
...
.LFB19:
	...
	.cfi_endproc
.LFE19:
	.size	can_error_get, .-can_error_get
	.align	1
	.globl	can_receive_error_number_get
	.type	can_receive_error_number_get, @function
...
.LFB20:
	...
	.cfi_endproc
.LFE20:
	.size	can_receive_error_number_get, .-can_receive_error_number_get
	.align	1
	.globl	can_transmit_error_number_get
	.type	can_transmit_error_number_get, @function
...
.LFB21:
	...
	.cfi_endproc
.LFE21:
	.size	can_transmit_error_number_get, .-can_transmit_error_number_get
	.align	1
	.globl	can_interrupt_enable
	.type	can_interrupt_enable, @function
...
.LFB22:
	...
	.cfi_endproc
.LFE22:
	.size	can_interrupt_enable, .-can_interrupt_enable
	.align	1
	.globl	can_interrupt_disable
	.type	can_interrupt_disable, @function
...
.LFB23:
	...
	.cfi_endproc
.LFE23:
	.size	can_interrupt_disable, .-can_interrupt_disable
	.align	1
	.globl	can_flag_get
	.type	can_flag_get, @function
can_flag_get:
.LFB24:
	.loc 1 893 1
	.cfi_startproc
...
.L143:
	...
	.cfi_endproc
.LFE24:
	.size	can_flag_get, .-can_flag_get
	.align	1
	.globl	can_flag_clear
	.type	can_flag_clear, @function
can_flag_clear:
.LFB25:
	.loc 1 925 1
	.cfi_startproc
	...
	.cfi_endproc
.LFE25:
	.size	can_flag_clear, .-can_flag_clear
	.align	1
	.globl	can_interrupt_flag_get
	.type	can_interrupt_flag_get, @function
...
.L147:
	...
	.cfi_endproc
.LFE26:
	.size	can_interrupt_flag_get, .-can_interrupt_flag_get
	.align	1
	.globl	can_interrupt_flag_clear
	.type	can_interrupt_flag_clear, @function
...
.LFB27:
	...
	.cfi_endproc
.LFE27:
	.size	can_interrupt_flag_clear, .-can_interrupt_flag_clear
.Letext0:
	...
	.file 5 "libraries/GD32VF103_standard_peripheral/Include/gd32vf103_dbg.h"
	.file 6 "libraries/GD32VF103_standard_peripheral/Include/gd32vf103_rcu.h"
	.file 7 "libraries/GD32VF103_standard_peripheral/Include/gd32vf103_can.h"
...
.Ldebug_macro0:
	...
	.byte	0x4
	.file 26 "libraries/GD32VF103_standard_peripheral/Include/gd32vf103_pmu.h"
	.byte	0x3
	.byte	0x34
	.byte	0x1a
	.byte	0x7
	...
	.byte	0x4
	.file 27 "libraries/GD32VF103_standard_peripheral/Include/gd32vf103_rtc.h"
	.byte	0x3
	.byte	0x36
	.byte	0x1b
	.byte	0x7
	...
	.byte	0x4
	.file 28 "libraries/GD32VF103_standard_peripheral/Include/gd32vf103_spi.h"
	.byte	0x3
	.byte	0x37
	.byte	0x1c
	.byte	0x7
	...
	.byte	0x4
	.file 29 "libraries/GD32VF103_standard_peripheral/Include/gd32vf103_timer.h"
	.byte	0x3
	.byte	0x38
	.byte	0x1d
	.byte	0x7
...
.Ldebug_macro33:
	...
	.4byte	.LASF2771
	.byte	0
	.section	.debug_macro,"G",@progbits,wm4.gd32vf103_can.h.41.f0bb016919383061d461d9286afa9188,comdat
.Ldebug_macro34:
	.2byte	0x4
	.byte	0
	.byte	0x5
...
.LASF3141:
	.string	"DBG_I2C1_HOLD"
.LASF177:
	.string	"__LDBL_MIN_EXP__ (-16381)"
.LASF3109:
	.string	"CAN_ERROR_HANDLE(s) do{}while(1)"
.LASF1033:
...
.LASF3288:
	.string	"can_time_trigger_mode_disable"
.LASF2136:
...
.LASF3202:
	.string	"can_interrupt_flag_enum"
.LASF2267:
...
.LASF3277:
	.string	"can_receive_message_length_get"
.LASF2909:
...
.LASF3239:
	.string	"can_filter_parameter_struct"
.LASF2091:
...
.LASF3245:
	.string	"CAN_ERROR_BITDOMINANTER"
.LASF1189:
...
.LASF3272:
	.string	"can_error_get"
.LASF2915:
	.string	"CAN_RFIFO0_RFF0 BIT(3)"
.LASF3233:
	.string	"filter_mask_low"
.LASF1687:
...
.LASF3253:
	.string	"can_transmit_state_enum"
.LASF1398:
...
.LASF3291:
	.string	"can_debug_freeze_enable"
.LASF36:
...
.LASF3271:
	.string	"can_receive_error_number_get"
.LASF3175:
...
.LASF3209:
	.string	"auto_wake_up"
.LASF3185:
	.string	"CAN_FLAG_RFF0"
.LASF3187:
	.string	"CAN_FLAG_RFF1"
.LASF2789:
...
.LASF3178:
	.string	"CAN_FLAG_MTE2"
.LASF3283:
	.string	"mailbox_number"
.LASF2592:
...
.LASF3184:
	.string	"CAN_FLAG_RFO0"
.LASF3186:
	.string	"CAN_FLAG_RFO1"
.LASF1596:
...
.LASF3183:
	.string	"CAN_FLAG_MTF0"
.LASF3182:
	.string	"CAN_FLAG_MTF1"
.LASF2347:
...
.LASF3197:
	.string	"CAN_INT_FLAG_MTF0"
.LASF3196:
	.string	"CAN_INT_FLAG_MTF1"
.LASF3195:
	.string	"CAN_INT_FLAG_MTF2"
.LASF3126:
	.string	"ENABLE"
.LASF3214:
	.string	"can_parameter_struct"
.LASF2256:
...
.LASF3270:
	.string	"can_transmit_error_number_get"
.LASF2570:
...
.LASF3145:
	.string	"DBG_CAN1_HOLD"
.LASF3156:
	.string	"RCU_USART1RST"
.LASF3144:
	.string	"DBG_TIMER6_HOLD"
.LASF373:
	.string	"unsigned"
.LASF3208:
	.string	"auto_bus_off_recovery"
.LASF471:
...
.LASF3290:
	.string	"can_debug_freeze_disable"
.LASF711:
...
.LASF3221:
	.string	"can_trasnmit_message_struct"
.LASF701:
...
.LASF3295:
	.string	"can_filter_parameter_init"
.LASF2935:
...
.LASF3229:
	.string	"can_receive_message_struct"
.LASF2813:
...
.LASF3302:
	.string	"libraries/GD32VF103_standard_peripheral/Source/gd32vf103_can.c"
.LASF1712:
...
.LASF3289:
	.string	"can_time_trigger_mode_enable"
.LASF1381:
...
.LASF3263:
	.string	"can_interrupt_flag_clear"
.LASF2475:
