# 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_spi.c"
...
# 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_spi.c"
# 35 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_spi.c"
...
# 39 "libraries/GD32VF103_standard_peripheral/Include/gd32vf103_spi.h" 2
...
# 36 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_spi.c" 2
...
void spi_struct_para_init(spi_parameter_struct* spi_struct)
{
    ...
    spi_struct->frame_size = ((uint32_t)0x00000000U);
...
# 115 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_spi.c"
void spi_init(uint32_t spi_periph, spi_parameter_struct* spi_struct)
{
    uint32_t reg = 0U;
    reg = (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00U));
    reg &= ((uint32_t)0x00003040U);
    ...
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00U)) = (uint32_t)reg;
...
# 187 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_spi.c"
void i2s_init(uint32_t spi_periph, uint32_t mode, uint32_t standard, uint32_t ckpl)
{
    uint32_t reg = 0U;
...
# 233 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_spi.c"
void i2s_psc_config(uint32_t spi_periph, uint32_t audiosample, uint32_t frameformat, uint32_t mckout)
{
    ...
    if((((uint32_t)0x40000000U) + 0x00003800U) == ((uint32_t)spi_periph)){

        clks = ((uint32_t)0x00020000U);
    }else{

        clks = ((uint32_t)0x00040000U);
    }

    if(0U != ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x00009000U) + 0x2CU)) & clks)){

        clks = (uint32_t)(((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x00009000U) + 0x2CU)) & ((uint32_t)0x0000F000U)) >> 12U);
        ...
        i2sclock = (uint32_t)((((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x00009000U) + 0x2CU)) & ((uint32_t)0x000000F0U)) >> 4U) + 1U);
...
# 381 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_spi.c"
void spi_dma_enable(uint32_t spi_periph, uint8_t dma)
{
...
# 400 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_spi.c"
void spi_dma_disable(uint32_t spi_periph, uint8_t dma)
{
    if(((uint8_t)0x00U) == dma){
        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x04U)) &= (uint32_t)(~((uint32_t)((uint32_t)0x01U<<(1))));
...
# 419 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_spi.c"
void spi_i2s_data_frame_format_config(uint32_t spi_periph, uint16_t frame_format)
{

    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00U)) &= (uint32_t)(~((uint32_t)((uint32_t)0x01U<<(11))));

    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00U)) |= (uint32_t)frame_format;
}
# 434 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_spi.c"
void spi_i2s_data_transmit(uint32_t spi_periph, uint16_t data)
{
...
# 460 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_spi.c"
void spi_bidirectional_transfer_config(uint32_t spi_periph, uint32_t transfer_direction)
{
...
# 478 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_spi.c"
void spi_crc_polynomial_set(uint32_t spi_periph,uint16_t crc_poly)
{
...
# 541 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_spi.c"
uint16_t spi_crc_get(uint32_t spi_periph,uint8_t crc)
{
...
# 607 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_spi.c"
void spi_i2s_interrupt_enable(uint32_t spi_periph, uint8_t interrupt)
{
    switch(interrupt){
...
# 639 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_spi.c"
void spi_i2s_interrupt_disable(uint32_t spi_periph, uint8_t interrupt)
{
    switch(interrupt){
...
# 674 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_spi.c"
FlagStatus spi_i2s_interrupt_flag_get(uint32_t spi_periph, uint8_t interrupt)
{
...
# 748 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_spi.c"
FlagStatus spi_i2s_flag_get(uint32_t spi_periph, uint32_t flag)
{
