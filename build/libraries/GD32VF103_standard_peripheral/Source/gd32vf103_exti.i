# 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_exti.c"
...
# 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_exti.c"
# 35 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_exti.c"
...
# 39 "libraries/GD32VF103_standard_peripheral/Include/gd32vf103_exti.h" 2
...
# 36 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_exti.c" 2
...
void exti_deinit(void)
{
    ...
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000400U) + 0x00U)) = ((uint32_t)0x00000000U);
...
# 72 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_exti.c"
void exti_init(exti_line_enum linex, exti_mode_enum mode, exti_trig_type_enum trig_type)
{
...
# 119 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_exti.c"
void exti_interrupt_enable(exti_line_enum linex)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000400U) + 0x00U)) |= (uint32_t) linex;
}
# 132 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_exti.c"
void exti_event_enable(exti_line_enum linex)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000400U) + 0x04U)) |= (uint32_t) linex;
}
# 145 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_exti.c"
void exti_interrupt_disable(exti_line_enum linex)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000400U) + 0x00U)) &= ~(uint32_t) linex;
}
# 158 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_exti.c"
void exti_event_disable(exti_line_enum linex)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000400U) + 0x04U)) &= ~(uint32_t) linex;
}
# 171 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_exti.c"
FlagStatus exti_flag_get(exti_line_enum linex)
{
...
# 188 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_exti.c"
void exti_flag_clear(exti_line_enum linex)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000400U) + 0x14U)) = (uint32_t) linex;
}
# 201 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_exti.c"
FlagStatus exti_interrupt_flag_get(exti_line_enum linex)
{
...
# 223 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_exti.c"
void exti_interrupt_flag_clear(exti_line_enum linex)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000400U) + 0x14U)) = (uint32_t) linex;
}
# 236 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_exti.c"
void exti_software_interrupt_enable(exti_line_enum linex)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000400U) + 0x10U)) |= (uint32_t) linex;
}
# 249 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_exti.c"
void exti_software_interrupt_disable(exti_line_enum linex)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000400U) + 0x10U)) &= ~(uint32_t) linex;
}
