# 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_adc.c"
...
# 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_adc.c"
# 35 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_adc.c"
...
# 1 "libraries/GD32VF103_standard_peripheral/gd32vf103.h" 1
# 39 "libraries/GD32VF103_standard_peripheral/Include/gd32vf103_bkp.h" 2
...
# 36 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_adc.c" 2
...
{
    switch(adc_periph){
    case (((uint32_t)0x40010000U) + 0x00002400U):

        rcu_periph_reset_enable(RCU_ADC0RST);
        rcu_periph_reset_disable(RCU_ADC0RST);
        break;
    case ((((uint32_t)0x40010000U) + 0x00002400U) + 0x400U):
...
# 100 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_adc.c"
void adc_mode_config(uint32_t mode)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40010000U) + 0x00002400U)) + 0x04U)) &= ~(((0xFFFFFFFFUL << (16)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(19)))));
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40010000U) + 0x00002400U)) + 0x04U)) |= mode;
}
# 118 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_adc.c"
void adc_special_function_config(uint32_t adc_periph, uint32_t function, ControlStatus newvalue)
{
    if(newvalue){
        if(0U != (function & ((uint32_t)((uint32_t)0x01U<<(8))))){

            (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x04U)) |= ((uint32_t)((uint32_t)0x01U<<(8)));
        }
        if(0U != (function & ((uint32_t)((uint32_t)0x01U<<(10))))){

            (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x04U)) |= ((uint32_t)((uint32_t)0x01U<<(10)));
        }
        if(0U != (function & ((uint32_t)((uint32_t)0x01U<<(1))))){

            (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x08U)) |= ((uint32_t)((uint32_t)0x01U<<(1)));
        }
    }else{
        if(0U != (function & ((uint32_t)((uint32_t)0x01U<<(8))))){
...
# 159 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_adc.c"
void adc_data_alignment_config(uint32_t adc_periph, uint32_t data_alignment)
{
    if(((uint32_t)0x00000000U) != data_alignment){

        (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x08U)) |= ((uint32_t)((uint32_t)0x01U<<(11)));
    }else{

        (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x08U)) &= ~((uint32_t)((uint32_t)((uint32_t)0x01U<<(11))));
    }
}
...
void adc_enable(uint32_t adc_periph)
{
    if(RESET == ((*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x08U)) & ((uint32_t)((uint32_t)0x01U<<(0))))){

        (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x08U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(0)));
    }
}
...
void adc_calibration_enable(uint32_t adc_periph)
{
    ...
    (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x08U)) |= (uint32_t) ((uint32_t)((uint32_t)0x01U<<(3)));

    while(RESET != ((*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x08U)) & ((uint32_t)((uint32_t)0x01U<<(3))))){
    }

    (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x08U)) |= ((uint32_t)((uint32_t)0x01U<<(2)));

    while(RESET != ((*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x08U)) & ((uint32_t)((uint32_t)0x01U<<(2))))){
    }
}
...
void adc_dma_mode_enable(uint32_t adc_periph)
{
    ...
    (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x08U)) |= (uint32_t)(((uint32_t)((uint32_t)0x01U<<(8))));
}
...
# 277 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_adc.c"
void adc_discontinuous_mode_config(uint32_t adc_periph, uint8_t adc_channel_group, uint8_t length)
{

    (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x04U)) &= ~((uint32_t)(((uint32_t)((uint32_t)0x01U<<(11))) | ((uint32_t)((uint32_t)0x01U<<(12)))));
    switch(adc_channel_group){
    case ((uint8_t)0x01U):

        (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x04U)) &= ~((uint32_t)((0xFFFFFFFFUL << (13)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(15)))));
        (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x04U)) |= (((0xFFFFFFFFUL << (13)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(15)))) & ((uint32_t)(((uint32_t)length - ((uint8_t)1U))) << 13));

        (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x04U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(11)));
        break;
    case ((uint8_t)0x02U):

        (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x04U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(12)));
        break;
    case ((uint8_t)0x04U):
...
# 313 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_adc.c"
void adc_channel_length_config(uint32_t adc_periph, uint8_t adc_channel_group, uint32_t length)
{
    switch(adc_channel_group){
    case ((uint8_t)0x01U):

        (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x2CU)) &= ~((uint32_t)((0xFFFFFFFFUL << (20)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(23)))));
        (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x2CU)) |= (((0xFFFFFFFFUL << (20)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(23)))) & ((uint32_t)((uint32_t)(length-((uint8_t)1U))) << 20));
        break;
    case ((uint8_t)0x02U):

        (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x38U)) &= ~((uint32_t)((0xFFFFFFFFUL << (20)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(21)))));
        (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x38U)) |= (((0xFFFFFFFFUL << (20)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(21)))) & ((uint32_t)((uint32_t)(length-((uint8_t)1U))) << 20));
        break;
    default:
        break;
    }
}
# 351 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_adc.c"
void adc_regular_channel_config(uint32_t adc_periph, uint8_t rank, uint8_t adc_channel, uint32_t sample_time)
{
    uint32_t rsq,sampt;
    ...
    if(rank < ((uint8_t)6U)){
        ...
        rsq = (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x34U));
        rsq &= ~((uint32_t)(((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(4)))) << (((uint8_t)5U)*rank)));

        rsq |= ((uint32_t)adc_channel << (((uint8_t)5U)*rank));
        (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x34U)) = rsq;
    }else if(rank < ((uint8_t)12U)){

        rsq = (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x30U));
        rsq &= ~((uint32_t)(((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(4)))) << (((uint8_t)5U)*(rank-((uint8_t)6U)))));

        rsq |= ((uint32_t)adc_channel << (((uint8_t)5U)*(rank-((uint8_t)6U))));
        (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x30U)) = rsq;
    }else if(rank < ((uint8_t)16U)){

        rsq = (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x2CU));
        rsq &= ~((uint32_t)(((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(4)))) << (((uint8_t)5U)*(rank-((uint8_t)12U)))));

        rsq |= ((uint32_t)adc_channel << (((uint8_t)5U)*(rank-((uint8_t)12U))));
        (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x2CU)) = rsq;
    }else{
    }


    if(adc_channel < ((uint8_t)10U)){

        sampt = (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x10U));
        sampt &= ~((uint32_t)(((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(2)))) << (((uint8_t)3U)*adc_channel)));

        sampt |= (uint32_t)(sample_time << (((uint8_t)3U)*adc_channel));
        (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x10U)) = sampt;
    }else if(adc_channel < ((uint8_t)18U)){

        sampt = (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x0CU));
        sampt &= ~((uint32_t)(((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(2)))) << (((uint8_t)3U)*(adc_channel-((uint8_t)10U)))));

        sampt |= (uint32_t)(sample_time << (((uint8_t)3U)*(adc_channel-((uint8_t)10U))));
        (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x0CU)) = sampt;
    }else{
    }
}
# 419 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_adc.c"
void adc_inserted_channel_config(uint32_t adc_periph, uint8_t rank, uint8_t adc_channel, uint32_t sample_time)
{
    uint8_t inserted_length;
    uint32_t isq,sampt;

    inserted_length = (uint8_t)((((*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x38U))) & ((0xFFFFFFFFUL << ((20U))) & (0xFFFFFFFFUL >> (31U - (uint32_t)((21U)))))) >> (20U));

    isq = (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x38U));
    isq &= ~((uint32_t)(((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(4)))) << (((uint8_t)15U)-(inserted_length-rank)*((uint8_t)5U))));
    isq |= ((uint32_t)adc_channel << (((uint8_t)15U)-(inserted_length-rank)*((uint8_t)5U)));
    (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x38U)) = isq;
...
# 463 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_adc.c"
void adc_inserted_channel_offset_config(uint32_t adc_periph, uint8_t inserted_channel, uint16_t offset)
{
    uint8_t inserted_length;
    uint32_t num = 0U;
    ...
    inserted_length = (uint8_t)((((*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x38U))) & ((0xFFFFFFFFUL << ((20U))) & (0xFFFFFFFFUL >> (31U - (uint32_t)((21U)))))) >> (20U));
    num = ((uint32_t)((uint8_t)3U) - ((uint32_t)inserted_length - (uint32_t)inserted_channel));

    if(num <= ((uint8_t)3U)){

        num = num * ((uint8_t)4U);

        (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x14U + num)) = (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(11)))) & ((uint32_t)((uint32_t)offset) << 0));
    }
}
# 509 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_adc.c"
void adc_external_trigger_source_config(uint32_t adc_periph, uint8_t adc_channel_group, uint32_t external_trigger_source)
{
    switch(adc_channel_group){
    case ((uint8_t)0x01U):

        (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x08U)) &= ~((uint32_t)((0xFFFFFFFFUL << (17)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(19)))));
        (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x08U)) |= (uint32_t)external_trigger_source;
        break;
    case ((uint8_t)0x02U):

        (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x08U)) &= ~((uint32_t)((0xFFFFFFFFUL << (12)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(14)))));
        (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x08U)) |= (uint32_t)external_trigger_source;
        break;
    default:
        break;
...
# 538 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_adc.c"
void adc_external_trigger_config(uint32_t adc_periph, uint8_t adc_channel_group, ControlStatus newvalue)
{
    if(newvalue){
        if(0U != (adc_channel_group & ((uint8_t)0x01U))){

            (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x08U)) |= ((uint32_t)((uint32_t)0x01U<<(20)));
        }
        if(0U != (adc_channel_group & ((uint8_t)0x02U))){

            (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x08U)) |= ((uint32_t)((uint32_t)0x01U<<(15)));
        }
    }else{
        if(0U != (adc_channel_group & ((uint8_t)0x01U))){
...
# 571 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_adc.c"
void adc_software_trigger_enable(uint32_t adc_periph, uint8_t adc_channel_group)
{
    if(0U != (adc_channel_group & ((uint8_t)0x01U))){

        (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x08U)) |= ((uint32_t)((uint32_t)0x01U<<(22)));
    }
    if(0U != (adc_channel_group & ((uint8_t)0x02U))){

        (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x08U)) |= ((uint32_t)((uint32_t)0x01U<<(21)));
    }
}
# 590 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_adc.c"
uint16_t adc_regular_data_read(uint32_t adc_periph)
{
    return (uint16_t)((*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x4CU)));
}
# 607 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_adc.c"
uint16_t adc_inserted_data_read(uint32_t adc_periph, uint8_t inserted_channel)
{
    uint32_t idata;
    ...
    case ((uint8_t)0x00U):
        ...
        idata = (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x3CU));
        break;
    case ((uint8_t)0x01U):

        idata = (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x40U));
        break;
    case ((uint8_t)0x02U):

        idata = (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x44U));
        break;
    case ((uint8_t)0x03U):

        idata = (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x48U));
        break;
    default:
        idata = 0U;
        break;
...
uint32_t adc_sync_mode_convert_value_read(void)
{
    ...
    return (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40010000U) + 0x00002400U)) + 0x4CU));
}
# 657 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_adc.c"
void adc_watchdog_single_channel_enable(uint32_t adc_periph, uint8_t adc_channel)
{
    (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x04U)) &= (uint32_t)~(((uint32_t)((uint32_t)0x01U<<(23))) | ((uint32_t)((uint32_t)0x01U<<(22))) | ((uint32_t)((uint32_t)0x01U<<(9))) | ((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(4)))));

    (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x04U)) |= (uint32_t)adc_channel;
    (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x04U)) |= (uint32_t)(((uint32_t)((uint32_t)0x01U<<(23))) | ((uint32_t)((uint32_t)0x01U<<(22))) | ((uint32_t)((uint32_t)0x01U<<(9))));
}
# 676 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_adc.c"
void adc_watchdog_group_channel_enable(uint32_t adc_periph, uint8_t adc_channel_group)
{
    (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x04U)) &= (uint32_t)~(((uint32_t)((uint32_t)0x01U<<(23))) | ((uint32_t)((uint32_t)0x01U<<(22))) | ((uint32_t)((uint32_t)0x01U<<(9))));
    ...
    case ((uint8_t)0x01U):
        ...
        (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x04U)) |= (uint32_t) ((uint32_t)((uint32_t)0x01U<<(23)));
        break;
    case ((uint8_t)0x02U):

        (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x04U)) |= (uint32_t) ((uint32_t)((uint32_t)0x01U<<(22)));
        break;
    case ((uint8_t)0x03U):

        (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x04U)) |= (uint32_t)(((uint32_t)((uint32_t)0x01U<<(23))) | ((uint32_t)((uint32_t)0x01U<<(22))));
        break;
    default:
        break;
    }
...
# 717 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_adc.c"
void adc_watchdog_threshold_config(uint32_t adc_periph, uint16_t low_threshold, uint16_t high_threshold)
{
    (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x28U)) = (uint32_t)(((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(11)))) & ((uint32_t)(low_threshold) << 0));
    (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x24U)) = (uint32_t)(((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(11)))) & ((uint32_t)(high_threshold) << 0));
}
# 736 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_adc.c"
FlagStatus adc_flag_get(uint32_t adc_periph, uint32_t adc_flag)
{
    FlagStatus reval = RESET;
    if((*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x00U)) & adc_flag){
        reval = SET;
    }
    return reval;
}
# 758 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_adc.c"
void adc_flag_clear(uint32_t adc_periph, uint32_t adc_flag)
{
    (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x00U)) &= ~((uint32_t)adc_flag);
}
# 770 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_adc.c"
FlagStatus adc_regular_software_startconv_flag_get(uint32_t adc_periph)
{
    FlagStatus reval = RESET;
    if((uint32_t)RESET != ((*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x08U)) & ((uint32_t)((uint32_t)0x01U<<(22))))){
        reval = SET;
    }
    return reval;
}
# 786 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_adc.c"
FlagStatus adc_inserted_software_startconv_flag_get(uint32_t adc_periph)
{
    FlagStatus reval = RESET;
    if((uint32_t)RESET != ((*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x08U)) & ((uint32_t)((uint32_t)0x01U<<(21))))){
        reval = SET;
    }
    return reval;
}
# 806 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_adc.c"
FlagStatus adc_interrupt_flag_get(uint32_t adc_periph, uint32_t adc_interrupt)
{
    ...
    case ((uint32_t)((uint32_t)0x01U<<(0))):
        ...
        state = (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x00U)) & ((uint32_t)((uint32_t)0x01U<<(0)));
        if(((*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x04U)) & ((uint32_t)((uint32_t)0x01U<<(6)))) && state){
          interrupt_flag = SET;
        }
        break;
    case ((uint32_t)((uint32_t)0x01U<<(1))):

        state = (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x00U)) & ((uint32_t)((uint32_t)0x01U<<(1)));
          if(((*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x04U)) & ((uint32_t)((uint32_t)0x01U<<(5)))) && state){
            interrupt_flag = SET;
          }
        break;
    case ((uint32_t)((uint32_t)0x01U<<(2))):

        state = (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x00U)) & ((uint32_t)((uint32_t)0x01U<<(2)));
        if(((*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x04U)) & ((uint32_t)((uint32_t)0x01U<<(7)))) && state){
            interrupt_flag = SET;
        }
        break;
    default:
...
# 850 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_adc.c"
void adc_interrupt_flag_clear(uint32_t adc_periph, uint32_t adc_interrupt)
{
    (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x00U)) &= ~((uint32_t)adc_interrupt);
}
# 866 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_adc.c"
void adc_interrupt_enable(uint32_t adc_periph, uint32_t adc_interrupt)
{

    if(0U != (adc_interrupt & ((uint32_t)((uint32_t)0x01U<<(0))))){
        (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x04U)) |= (uint32_t) ((uint32_t)((uint32_t)0x01U<<(6)));
    }

    if(0U != (adc_interrupt & ((uint32_t)((uint32_t)0x01U<<(1))))){
        (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x04U)) |= (uint32_t) ((uint32_t)((uint32_t)0x01U<<(5)));
    }

    if(0U != (adc_interrupt & ((uint32_t)((uint32_t)0x01U<<(2))))){
        (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x04U)) |= (uint32_t) ((uint32_t)((uint32_t)0x01U<<(7)));
    }
}
# 893 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_adc.c"
void adc_interrupt_disable(uint32_t adc_periph, uint32_t adc_interrupt)
{
...
# 921 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_adc.c"
void adc_resolution_config(uint32_t adc_periph, uint32_t resolution)
{
    (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x80U)) &= ~((uint32_t)((0xFFFFFFFFUL << (12)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(13)))));
    (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x80U)) |= (uint32_t)resolution;
}
# 960 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_adc.c"
void adc_oversample_mode_config(uint32_t adc_periph, uint8_t mode, uint16_t shift,uint8_t ratio)
{
    if(mode){
        (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x80U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(9)));
    }else{
        (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x80U)) &= ~((uint32_t)((uint32_t)((uint32_t)0x01U<<(9))));
    }

    (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x80U)) &= ~((uint32_t)(((0xFFFFFFFFUL << (2)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(4)))) | ((0xFFFFFFFFUL << (5)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(8))))));
    (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x80U)) |= ((uint32_t)shift | (uint32_t)ratio);
}
...
void adc_oversample_mode_enable(uint32_t adc_periph)
{
    (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x80U)) |= ((uint32_t)((uint32_t)0x01U<<(0)));
}
...
void adc_oversample_mode_disable(uint32_t adc_periph)
{
    (*(volatile uint32_t *)(uint32_t)((adc_periph) + 0x80U)) &= ~((uint32_t)((uint32_t)((uint32_t)0x01U<<(0))));
}
