# 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_i2c.c"
...
# 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_i2c.c"
# 35 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_i2c.c"
...
# 39 "libraries/GD32VF103_standard_peripheral/Include/gd32vf103_i2c.h" 2
...
# 36 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_i2c.c" 2


#define I2CCLK_MAX ((uint32_t)0x00000048U)
...
# 82 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_i2c.c"
void i2c_clock_config(uint32_t i2c_periph, uint32_t clkspeed, uint32_t dutycyc)
{
    ...
    if (freq >= ((uint32_t)0x00000048U)) {
        freq = ((uint32_t)0x00000048U);
    }
    temp = (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x04U));
    temp &= ~((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(5))));
    temp |= freq;
    ...
    if (100000U >= clkspeed) {
        ...
        if (risetime >= ((uint32_t)0x00000048U)) {
            (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x20U)) = ((uint32_t)0x00000048U);
        ...
        (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x20U)) = (uint32_t) (((freq * (uint32_t) 300U)
...
# 154 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_i2c.c"
void i2c_mode_addr_config(uint32_t i2c_periph, uint32_t mode,uint32_t addformat, uint32_t addr)
{
...
# 178 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_i2c.c"
void i2c_smbus_type_config(uint32_t i2c_periph, uint32_t type)
{
...
# 197 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_i2c.c"
void i2c_ack_config(uint32_t i2c_periph, uint32_t ack)
{
...
# 216 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_i2c.c"
void i2c_ackpos_config(uint32_t i2c_periph, uint32_t pos)
{
...
# 237 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_i2c.c"
void i2c_master_addressing(uint32_t i2c_periph, uint32_t addr,uint32_t trandirection)
{
...
# 256 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_i2c.c"
void i2c_saddr1_config(uint32_t i2c_periph,uint32_t addr)
{

    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x0CU)) = (0xFE & addr);
}
# 269 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_i2c.c"
...
# 338 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_i2c.c"
void i2c_data_transmit(uint32_t i2c_periph, uint8_t data)
{
...
# 364 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_i2c.c"
void i2c_dma_enable(uint32_t i2c_periph, uint32_t dmastate)
{
...
# 385 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_i2c.c"
void i2c_dma_last_transfer_config(uint32_t i2c_periph, uint32_t dmalast)
{
...
# 406 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_i2c.c"
void i2c_stretch_scl_low_config(uint32_t i2c_periph, uint32_t stretchpara)
{
...
# 427 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_i2c.c"
void i2c_slave_response_to_gcall_config(uint32_t i2c_periph, uint32_t gcallpara)
{
...
# 448 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_i2c.c"
void i2c_software_reset_config(uint32_t i2c_periph, uint32_t sreset)
{
...
# 469 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_i2c.c"
void i2c_pec_enable(uint32_t i2c_periph, uint32_t pecstate)
{
...
# 490 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_i2c.c"
void i2c_pec_transfer_enable(uint32_t i2c_periph, uint32_t pecpara)
{
...
# 522 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_i2c.c"
void i2c_smbus_issue_alert(uint32_t i2c_periph, uint32_t smbuspara)
{
...
# 543 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_i2c.c"
void i2c_smbus_arp_enable(uint32_t i2c_periph, uint32_t arpstate)
{
...
# 583 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_i2c.c"
FlagStatus i2c_flag_get(uint32_t i2c_periph, i2c_flag_enum flag)
{
...
# 608 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_i2c.c"
void i2c_flag_clear(uint32_t i2c_periph, i2c_flag_enum flag)
{
    uint32_t temp;
    if (I2C_FLAG_ADDSEND == flag) {

        temp = (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x14U));
        temp = (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x18U));
    } else {
        ((*(volatile uint32_t *)(uint32_t)((i2c_periph) + (((uint32_t)(flag) & 0xFFFFU) >> 6)))) &= ~((uint32_t)((uint32_t)0x01U<<(((uint32_t)(flag) & 0x1FU))));
    }
}
# 631 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_i2c.c"
void i2c_interrupt_enable(uint32_t i2c_periph, i2c_interrupt_enum interrupt)
{
    ((*(volatile uint32_t *)(uint32_t)((i2c_periph) + (((uint32_t)(interrupt) & 0xFFFFU) >> 6)))) |= ((uint32_t)((uint32_t)0x01U<<(((uint32_t)(interrupt) & 0x1FU))));
}
# 647 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_i2c.c"
void i2c_interrupt_disable(uint32_t i2c_periph, i2c_interrupt_enum interrupt)
{
    ((*(volatile uint32_t *)(uint32_t)((i2c_periph) + (((uint32_t)(interrupt) & 0xFFFFU) >> 6)))) &= ~((uint32_t)((uint32_t)0x01U<<(((uint32_t)(interrupt) & 0x1FU))));
}
# 674 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_i2c.c"
FlagStatus i2c_interrupt_flag_get(uint32_t i2c_periph,i2c_interrupt_flag_enum int_flag)
{
...
# 716 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_i2c.c"
void i2c_interrupt_flag_clear(uint32_t i2c_periph,i2c_interrupt_flag_enum int_flag)
{
    uint32_t temp;
