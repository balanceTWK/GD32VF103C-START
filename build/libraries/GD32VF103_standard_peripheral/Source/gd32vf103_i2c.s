...
i2c_deinit:
.LFB2:
	.file 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_i2c.c"
	.loc 1 54 1
	.cfi_startproc
	addi	sp,sp,-32
...
.LFE3:
	...
	.align	1
	.globl	i2c_mode_addr_config
	.type	i2c_mode_addr_config, @function
...
.LFB4:
	...
	.cfi_endproc
.LFE4:
	.size	i2c_mode_addr_config, .-i2c_mode_addr_config
	.align	1
	.globl	i2c_smbus_type_config
	.type	i2c_smbus_type_config, @function
...
.L22:
	...
	.cfi_endproc
.LFE5:
	.size	i2c_smbus_type_config, .-i2c_smbus_type_config
	.align	1
	.globl	i2c_ack_config
...
.LFE6:
	...
	.align	1
	.globl	i2c_ackpos_config
	.type	i2c_ackpos_config, @function
i2c_ackpos_config:
.LFB7:
	.loc 1 217 1
	.cfi_startproc
...
.L30:
	...
	.cfi_endproc
.LFE7:
	.size	i2c_ackpos_config, .-i2c_ackpos_config
	.align	1
...
.L33:
	...
	.cfi_endproc
.LFE8:
	.size	i2c_master_addressing, .-i2c_master_addressing
	.align	1
	.globl	i2c_saddr1_config
	.type	i2c_saddr1_config, @function
i2c_saddr1_config:
.LFB9:
	.loc 1 257 1
	.cfi_startproc
	...
	.cfi_endproc
.LFE9:
	.size	i2c_saddr1_config, .-i2c_saddr1_config
	.align	1
	.globl	i2c_dualaddr_enable
	.type	i2c_dualaddr_enable, @function
i2c_dualaddr_enable:
.LFB10:
	.loc 1 270 1
	.cfi_startproc
	...
	.cfi_endproc
.LFE10:
	.size	i2c_dualaddr_enable, .-i2c_dualaddr_enable
	.align	1
	.globl	i2c_dualaddr_disable
	.type	i2c_dualaddr_disable, @function
...
.LFB11:
	...
	.cfi_endproc
.LFE11:
	.size	i2c_dualaddr_disable, .-i2c_dualaddr_disable
	.align	1
	.globl	i2c_enable
...
.LFB14:
	...
	.cfi_endproc
.LFE14:
	.size	i2c_start_on_bus, .-i2c_start_on_bus
	.align	1
...
.LFB15:
	...
	.cfi_endproc
.LFE15:
	.size	i2c_stop_on_bus, .-i2c_stop_on_bus
	.align	1
...
.LFB16:
	...
	.cfi_endproc
.LFE16:
	.size	i2c_data_transmit, .-i2c_data_transmit
	.align	1
...
.LFB17:
	...
	.cfi_endproc
.LFE17:
	.size	i2c_data_receive, .-i2c_data_receive
	.align	1
...
.LFB18:
	...
	.cfi_endproc
.LFE18:
	.size	i2c_dma_enable, .-i2c_dma_enable
	.align	1
	.globl	i2c_dma_last_transfer_config
	.type	i2c_dma_last_transfer_config, @function
...
.LFB19:
	...
	.cfi_endproc
.LFE19:
	.size	i2c_dma_last_transfer_config, .-i2c_dma_last_transfer_config
	.align	1
	.globl	i2c_stretch_scl_low_config
	.type	i2c_stretch_scl_low_config, @function
...
.LFB20:
	...
	.cfi_endproc
.LFE20:
	.size	i2c_stretch_scl_low_config, .-i2c_stretch_scl_low_config
	.align	1
	.globl	i2c_slave_response_to_gcall_config
	.type	i2c_slave_response_to_gcall_config, @function
...
.LFB21:
	...
	.cfi_endproc
.LFE21:
	.size	i2c_slave_response_to_gcall_config, .-i2c_slave_response_to_gcall_config
	.align	1
	.globl	i2c_software_reset_config
	.type	i2c_software_reset_config, @function
...
.LFB22:
	...
	.cfi_endproc
.LFE22:
	.size	i2c_software_reset_config, .-i2c_software_reset_config
	.align	1
...
.LFB23:
	...
	.cfi_endproc
.LFE23:
	.size	i2c_pec_enable, .-i2c_pec_enable
	.align	1
	.globl	i2c_pec_transfer_enable
	.type	i2c_pec_transfer_enable, @function
...
.LFB24:
	...
	.cfi_endproc
.LFE24:
	.size	i2c_pec_transfer_enable, .-i2c_pec_transfer_enable
	.align	1
...
.LFB25:
	...
	.cfi_endproc
.LFE25:
	.size	i2c_pec_value_get, .-i2c_pec_value_get
	.align	1
	.globl	i2c_smbus_issue_alert
	.type	i2c_smbus_issue_alert, @function
...
.LFB26:
	...
	.cfi_endproc
.LFE26:
	.size	i2c_smbus_issue_alert, .-i2c_smbus_issue_alert
	.align	1
	.globl	i2c_smbus_arp_enable
	.type	i2c_smbus_arp_enable, @function
...
.LFB27:
	...
	.cfi_endproc
.LFE27:
	.size	i2c_smbus_arp_enable, .-i2c_smbus_arp_enable
	.align	1
	.globl	i2c_flag_get
...
.L57:
	...
	.cfi_endproc
.LFE28:
	.size	i2c_flag_get, .-i2c_flag_get
	.align	1
...
.L61:
	...
	.cfi_endproc
.LFE29:
	.size	i2c_flag_clear, .-i2c_flag_clear
	.align	1
...
.LFB30:
	...
	.cfi_endproc
.LFE30:
	.size	i2c_interrupt_enable, .-i2c_interrupt_enable
	.align	1
...
.LFB31:
	...
	.cfi_endproc
.LFE31:
	.size	i2c_interrupt_disable, .-i2c_interrupt_disable
	.align	1
...
.L69:
	...
	.cfi_endproc
.LFE32:
	.size	i2c_interrupt_flag_get, .-i2c_interrupt_flag_get
	.align	1
...
.L73:
	...
	.cfi_endproc
.LFE33:
	.size	i2c_interrupt_flag_clear, .-i2c_interrupt_flag_clear
.Letext0:
	...
	.file 6 "libraries/GD32VF103_standard_peripheral/Include/gd32vf103_i2c.h"
...
.Ldebug_macro33:
	...
	.4byte	.LASF2999
	.byte	0
	.section	.debug_macro,"G",@progbits,wm4.gd32vf103_i2c.h.41.90fdf7edc14ad13d486d3b6bd0972edd,comdat
.Ldebug_macro34:
	.2byte	0x4
	.byte	0
	.byte	0x5
...
.LASF3114:
	.string	"STAT1_PECV_OFFSET ((uint32_t)8U)"
.LASF2432:
...
.LASF3247:
	.string	"i2c_dualaddr_disable"
.LASF353:
	.string	"__MISC_VISIBLE 1"
.LASF543:
	.string	"ADC_IDATA3(adcx) REG32((adcx) + 0x48U)"
.LASF3110:
	.string	"I2CCLK_MIN ((uint32_t)0x00000002U)"
.LASF899:
...
.LASF3230:
	.string	"i2c_software_reset_config"
.LASF2007:
...
.LASF3190:
	.string	"I2C_INT_FLAG_BTC"
.LASF3236:
	.string	"i2c_dma_last_transfer_config"
.LASF1261:
...
.LASF3109:
	.string	"I2CCLK_MAX ((uint32_t)0x00000048U)"
.LASF1512:
...
.LASF3232:
	.string	"i2c_slave_response_to_gcall_config"
.LASF1754:
...
.LASF3111:
	.string	"I2C_FLAG_MASK ((uint32_t)0x0000FFFFU)"
.LASF1731:
...
.LASF3202:
	.string	"i2c_interrupt_flag_enum"
.LASF978:
...
.LASF3113:
	.string	"I2C_ADDRESS2_MASK ((uint32_t)0x000000FEU)"
.LASF2422:
...
.LASF3226:
	.string	"i2c_pec_transfer_enable"
.LASF1804:
...
.LASF3213:
	.string	"i2c_interrupt_flag_clear"
.LASF3105:
...
.LASF3112:
	.string	"I2C_ADDRESS_MASK ((uint32_t)0x000003FFU)"
.LASF220:
...
.LASF3234:
	.string	"i2c_stretch_scl_low_config"
.LASF399:
...
.LASF3268:
	.string	"libraries/GD32VF103_standard_peripheral/Source/gd32vf103_i2c.c"
.LASF1977:
