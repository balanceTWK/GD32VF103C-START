...
fmc_wscnt_set:
.LFB2:
	.file 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_fmc.c"
	.loc 1 47 1
	.cfi_startproc
	addi	sp,sp,-48
	...
	.cfi_endproc
.LFE2:
	.size	fmc_wscnt_set, .-fmc_wscnt_set
	.align	1
	.globl	fmc_unlock
...
.L7:
	...
	.cfi_endproc
.LFE5:
	.size	fmc_page_erase, .-fmc_page_erase
	.align	1
...
.L10:
	...
	.cfi_endproc
.LFE6:
	.size	fmc_mass_erase, .-fmc_mass_erase
	.align	1
	.globl	fmc_word_program
	.type	fmc_word_program, @function
fmc_word_program:
.LFB7:
	.loc 1 140 1
	.cfi_startproc
...
.L13:
	...
	.cfi_endproc
.LFE7:
	.size	fmc_word_program, .-fmc_word_program
	.align	1
	.globl	fmc_halfword_program
	.type	fmc_halfword_program, @function
...
.L16:
	...
	.cfi_endproc
.LFE8:
	.size	fmc_halfword_program, .-fmc_halfword_program
	.align	1
	.globl	ob_unlock
...
.L21:
	...
	nop
.L20:
	.loc 1 196 23 discriminator 1
	li	a5,1073881088
	addi	a5,a5,16
	lw	a5,0(a5)
	.loc 1 196 108 discriminator 1
	andi	a5,a5,512
...
.L30:
	...
	.cfi_endproc
.LFE12:
	.size	ob_write_protection_enable, .-ob_write_protection_enable
	.align	1
...
.L37:
	...
	.cfi_endproc
.LFE13:
	.size	ob_security_protection_config, .-ob_security_protection_config
	.align	1
	.globl	ob_user_write
...
.L42:
	...
	.cfi_endproc
.LFE14:
	.size	ob_user_write, .-ob_user_write
	.align	1
...
.L45:
	...
	.cfi_endproc
.LFE15:
	.size	ob_data_program, .-ob_data_program
	.align	1
	.globl	ob_user_get
...
.LFB18:
	...
	.cfi_endproc
.LFE18:
	.size	ob_write_protection_get, .-ob_write_protection_get
	.align	1
	.globl	ob_spc_get
	.type	ob_spc_get, @function
ob_spc_get:
.LFB19:
	.loc 1 483 1
	.cfi_startproc
...
.L55:
	...
	.cfi_endproc
.LFE19:
	.size	ob_spc_get, .-ob_spc_get
	.align	1
	.globl	fmc_interrupt_enable
	.type	fmc_interrupt_enable, @function
...
.LFB20:
	...
	.cfi_endproc
.LFE20:
	.size	fmc_interrupt_enable, .-fmc_interrupt_enable
	.align	1
	.globl	fmc_interrupt_disable
	.type	fmc_interrupt_disable, @function
...
.LFB21:
	...
	.cfi_endproc
.LFE21:
	.size	fmc_interrupt_disable, .-fmc_interrupt_disable
	.align	1
	.globl	fmc_flag_get
	.type	fmc_flag_get, @function
fmc_flag_get:
.LFB22:
	.loc 1 535 1
	.cfi_startproc
...
.L61:
	...
	.cfi_endproc
.LFE22:
	.size	fmc_flag_get, .-fmc_flag_get
	.align	1
	.globl	fmc_flag_clear
	.type	fmc_flag_clear, @function
fmc_flag_clear:
.LFB23:
	.loc 1 554 1
	.cfi_startproc
	...
	.cfi_endproc
.LFE23:
	.size	fmc_flag_clear, .-fmc_flag_clear
	.align	1
	.globl	fmc_interrupt_flag_get
	.type	fmc_interrupt_flag_get, @function
...
.L66:
	...
	.cfi_endproc
.LFE24:
	.size	fmc_interrupt_flag_get, .-fmc_interrupt_flag_get
	.align	1
	.globl	fmc_interrupt_flag_clear
	.type	fmc_interrupt_flag_clear, @function
...
.LFB25:
	...
	.cfi_endproc
.LFE25:
	.size	fmc_interrupt_flag_clear, .-fmc_interrupt_flag_clear
	.align	1
	.globl	fmc_state_get
	.type	fmc_state_get, @function
fmc_state_get:
.LFB26:
	.loc 1 609 1
	.cfi_startproc
...
.L70:
	...
	.cfi_endproc
.LFE26:
	.size	fmc_state_get, .-fmc_state_get
	.align	1
	.globl	fmc_ready_wait
	.type	fmc_ready_wait, @function
fmc_ready_wait:
.LFB27:
	.loc 1 634 1
	.cfi_startproc
	...
	sw	a5,-20(s0)
.L75:
	.loc 1 640 21 discriminator 2
	call	fmc_state_get
	sw	a0,-20(s0)
	.loc 1 641 16 discriminator 2
	lw	a5,-36(s0)
	addi	a5,a5,-1
	sw	a5,-36(s0)
...
.L76:
	...
	.cfi_endproc
.LFE27:
	.size	fmc_ready_wait, .-fmc_ready_wait
.Letext0:
	...
	.file 5 "libraries/GD32VF103_standard_peripheral/Include/gd32vf103_fmc.h"
...
.Ldebug_macro33:
	...
	.4byte	.LASF2995
	.byte	0
	.section	.debug_macro,"G",@progbits,wm4.gd32vf103_fmc.h.41.6abb9f48a0222b94c47b6866a81e1f8d,comdat
.Ldebug_macro34:
	.2byte	0x4
	.byte	0
	.byte	0x5
...
.LASF3164:
	.string	"ob_security_protection_config"
.LASF2294:
...
.LASF3166:
	.string	"ob_write_protection_enable"
.LASF479:
...
.LASF3135:
	.string	"fmc_interrupt_flag_enum"
.LASF797:
...
.LASF3152:
	.string	"ob_write_protection_get"
.LASF1183:
...
.LASF3144:
	.string	"fmc_interrupt_flag_clear"
.LASF2973:
...
.LASF3185:
	.string	"libraries/GD32VF103_standard_peripheral/Source/gd32vf103_fmc.c"
.LASF1790:
