# 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_rtc.c"
...
# 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_rtc.c"
# 35 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_rtc.c"
...
# 39 "libraries/GD32VF103_standard_peripheral/Include/gd32vf103_rtc.h" 2
...
# 36 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_rtc.c" 2
...
void rtc_configuration_mode_enter(void)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00002800U) + 0x04U)) |= ((uint32_t)((uint32_t)0x01U<<(4)));
}
...
void rtc_counter_set(uint32_t cnt)
{
    ...
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00002800U) + 0x18U)) = (cnt >> ((uint32_t)16U));

    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00002800U) + 0x1CU)) = (cnt & ((uint32_t)0x0000FFFFU));
...
void rtc_prescaler_set(uint32_t psc)
{
    ...
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00002800U) + 0x08U)) = ((psc & ((uint32_t)0x000F0000U)) >> ((uint32_t)16U));

    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00002800U) + 0x0CU)) = (psc & ((uint32_t)0x0000FFFFU));
    rtc_configuration_mode_exit();
}
...
void rtc_lwoff_wait(void)
{
    ...
    while(RESET == ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00002800U) + 0x04U)) & ((uint32_t)((uint32_t)0x01U<<(5))))){
    }
}
...
void rtc_register_sync_wait(void)
{
    ...
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00002800U) + 0x04U)) &= ~((uint32_t)((uint32_t)0x01U<<(3)));

    while(RESET == ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00002800U) + 0x04U)) & ((uint32_t)((uint32_t)0x01U<<(3))))){
    }
}
...
void rtc_alarm_config(uint32_t alarm)
{
    ...
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00002800U) + 0x20U)) = (alarm >> ((uint32_t)16U));

    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00002800U) + 0x24U)) = (alarm & ((uint32_t)0x0000FFFFU));
    rtc_configuration_mode_exit();
}
...
uint32_t rtc_counter_get(void)
{
    ...
    temp = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00002800U) + 0x1CU));
    temp |= ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00002800U) + 0x18U)) << ((uint32_t)16U));
    return temp;
}
...
uint32_t rtc_divider_get(void)
{
    ...
    temp = (((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00002800U) + 0x10U)) & ((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3))))) << ((uint32_t)16U));
    temp |= (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00002800U) + 0x14U));
    return temp;
}
# 184 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_rtc.c"
FlagStatus rtc_flag_get(uint32_t flag)
{
    if(RESET != ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00002800U) + 0x04U)) & flag)){
        return SET;
    }else{
        return RESET;
    }
}
# 204 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_rtc.c"
void rtc_flag_clear(uint32_t flag)
{

    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00002800U) + 0x04U)) &= ~flag;
}
# 220 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_rtc.c"
FlagStatus rtc_interrupt_flag_get(uint32_t flag)
{
    if(RESET != ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00002800U) + 0x04U)) & flag)){
        return SET;
...
# 239 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_rtc.c"
void rtc_interrupt_flag_clear(uint32_t flag)
{

    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00002800U) + 0x04U)) &= ~flag;
}
# 255 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_rtc.c"
void rtc_interrupt_enable(uint32_t interrupt)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00002800U) + 0x00U)) |= interrupt;
}
# 270 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_rtc.c"
void rtc_interrupt_disable(uint32_t interrupt)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40000000U) + 0x00002800U) + 0x00U)) &= ~interrupt;
}
