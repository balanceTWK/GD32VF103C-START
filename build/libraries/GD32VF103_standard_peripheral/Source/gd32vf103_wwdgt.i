# 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_wwdgt.c"
...
# 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_wwdgt.c"
# 35 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_wwdgt.c"
...
# 39 "libraries/GD32VF103_standard_peripheral/Include/gd32vf103_wwdgt.h" 2
...
# 36 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_wwdgt.c" 2
...
void wwdgt_counter_update(uint16_t counter_value)
{
    ...
    reg = ((*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00002C00U)) + 0x00000000U)) & (~((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(6))))));
    reg |= (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(6)))) & ((uint32_t)(counter_value) << 0));

    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00002C00U)) + 0x00000000U)) = reg;
}
# 94 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_wwdgt.c"
void wwdgt_config(uint16_t counter, uint16_t window, uint32_t prescaler)
{
    uint32_t reg_cfg = 0U, reg_ctl = 0U;


    reg_cfg = ((*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00002C00U)) + 0x00000004U)) &(~(((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(6))))|((0xFFFFFFFFUL << (7)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(8)))))));
    reg_ctl = ((*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00002C00U)) + 0x00000000U)) &(~((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(6))))));


    reg_cfg |= (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(6)))) & ((uint32_t)(window) << 0));
    reg_cfg |= prescaler;
    reg_ctl |= (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(6)))) & ((uint32_t)(counter) << 0));

    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00002C00U)) + 0x00000000U)) = reg_ctl;
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00002C00U)) + 0x00000004U)) = reg_cfg;
}
...
FlagStatus wwdgt_flag_get(void)
{
    if((*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00002C00U)) + 0x00000008U)) & ((uint32_t)((uint32_t)0x01U<<(0)))){
        return SET;
    }
...
void wwdgt_flag_clear(void)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00002C00U)) + 0x00000008U)) &= (~((uint32_t)((uint32_t)0x01U<<(0))));
}
