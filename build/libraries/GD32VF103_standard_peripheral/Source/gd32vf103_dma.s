...
dma_deinit:
.LFB2:
	.file 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_dma.c"
	.loc 1 53 1
	.cfi_startproc
	addi	sp,sp,-32
	...
	lw	a1,-24(s0)
	lw	a0,-20(s0)
	call	dma_periph_and_channel_check
	mv	a5,a0
	.loc 1 54 4
	bnez	a5,.L2
.L3:
...
.LFB3:
	...
	.cfi_endproc
.LFE3:
	.size	dma_struct_para_init, .-dma_struct_para_init
	.align	1
	.globl	dma_init
...
.L16:
	...
	.cfi_endproc
.LFE5:
	.size	dma_circulation_enable, .-dma_circulation_enable
	.align	1
...
.L19:
	...
	.cfi_endproc
.LFE6:
	.size	dma_circulation_disable, .-dma_circulation_disable
	.align	1
...
.L25:
	...
	.cfi_endproc
.LFE8:
	.size	dma_memory_to_memory_disable, .-dma_memory_to_memory_disable
	.align	1
...
.L34:
	...
	.cfi_endproc
.LFE11:
	.size	dma_periph_address_config, .-dma_periph_address_config
	.align	1
...
.L37:
	...
	.cfi_endproc
.LFE12:
	.size	dma_memory_address_config, .-dma_memory_address_config
	.align	1
...
.L43:
	...
	.cfi_endproc
.LFE14:
	.size	dma_transfer_number_get, .-dma_transfer_number_get
	.align	1
...
.L47:
	...
	.cfi_endproc
.LFE15:
	.size	dma_priority_config, .-dma_priority_config
	.align	1
...
.L50:
	...
	.cfi_endproc
.LFE16:
	.size	dma_memory_width_config, .-dma_memory_width_config
	.align	1
...
.L53:
	...
	.cfi_endproc
.LFE17:
	.size	dma_periph_width_config, .-dma_periph_width_config
	.align	1
...
.L56:
	...
	.cfi_endproc
.LFE18:
	.size	dma_memory_increase_enable, .-dma_memory_increase_enable
	.align	1
...
.L59:
	...
	.cfi_endproc
.LFE19:
	.size	dma_memory_increase_disable, .-dma_memory_increase_disable
	.align	1
...
.L62:
	...
	.cfi_endproc
.LFE20:
	.size	dma_periph_increase_enable, .-dma_periph_increase_enable
	.align	1
...
.L65:
	...
	.cfi_endproc
.LFE21:
	.size	dma_periph_increase_disable, .-dma_periph_increase_disable
	.align	1
...
.L75:
	...
	.cfi_endproc
.LFE23:
	.size	dma_flag_get, .-dma_flag_get
	.align	1
...
.LFB24:
	...
	.cfi_endproc
.LFE24:
	.size	dma_flag_clear, .-dma_flag_clear
	.align	1
...
.L84:
	...
	.cfi_endproc
.LFE25:
	.size	dma_interrupt_flag_get, .-dma_interrupt_flag_get
	.align	1
...
.LFB26:
	...
	.cfi_endproc
.LFE26:
	.size	dma_interrupt_flag_clear, .-dma_interrupt_flag_clear
	.align	1
...
.L87:
	...
	.cfi_endproc
.LFE27:
	.size	dma_interrupt_enable, .-dma_interrupt_enable
	.align	1
...
.L90:
	...
	.cfi_endproc
.LFE28:
	.size	dma_interrupt_disable, .-dma_interrupt_disable
	.align	1
	.type	dma_periph_and_channel_check, @function
...
.L93:
	...
	.cfi_endproc
.LFE29:
	.size	dma_periph_and_channel_check, .-dma_periph_and_channel_check
.Letext0:
	...
	.file 5 "libraries/GD32VF103_standard_peripheral/Include/gd32vf103_dma.h"
...
.Ldebug_macro33:
	...
	.4byte	.LASF3010
	.byte	0
	.section	.debug_macro,"G",@progbits,wm4.gd32vf103_dma.h.41.517b76c266348049e48fc15907b4181f,comdat
.Ldebug_macro34:
	.2byte	0x4
	.byte	0
	.byte	0x5
...
.LASF3171:
	.string	"dma_memory_address_config"
.LASF44:
...
.LASF3151:
	.string	"dma_interrupt_flag_clear"
.LASF2617:
...
.LASF3176:
	.string	"dma_memory_to_memory_disable"
.LASF1772:
...
.LASF3161:
	.string	"dma_periph_increase_enable"
.LASF176:
...
.LASF3187:
	.string	"dma_periph_and_channel_check"
.LASF3063:
...
.LASF3160:
	.string	"dma_periph_increase_disable"
.LASF1655:
...
.LASF3163:
	.string	"dma_memory_increase_enable"
.LASF2402:
...
.LASF3164:
	.string	"dma_periph_width_config"
.LASF342:
...
.LASF3184:
	.string	"libraries/GD32VF103_standard_peripheral/Source/gd32vf103_dma.c"
.LASF2211:
...
.LASF3162:
	.string	"dma_memory_increase_disable"
.LASF1095:
...
.LASF3178:
	.string	"dma_circulation_disable"
.LASF2233:
...
.LASF3166:
	.string	"dma_memory_width_config"
.LASF705:
...
.LASF3169:
	.string	"dma_transfer_number_get"
.LASF1824:
...
.LASF3173:
	.string	"dma_periph_address_config"
.LASF314:
	.string	"USE_M_TIME 1"
.LASF1215:
...
.LASF3135:
	.string	"dma_channel_enum"
.LASF3109:
	.string	"DMA_WRONG_HANDLE while(1){}"
.LASF887:
