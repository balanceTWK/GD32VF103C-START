# 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_dma.c"
...
# 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_dma.c"
# 35 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_dma.c"
...
# 39 "libraries/GD32VF103_standard_peripheral/Include/gd32vf103_dma.h" 2
...
# 36 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_dma.c" 2
...
# 52 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_dma.c"
void dma_deinit(uint32_t dma_periph, dma_channel_enum channelx)
{
...
void dma_struct_para_init(dma_parameter_struct* init_struct)
{
    ...
    init_struct->priority = (((0xFFFFFFFFUL << (12)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(13)))) & ((uint32_t)(0U) << 12));
}
# 108 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_dma.c"
void dma_init(uint32_t dma_periph, dma_channel_enum channelx, dma_parameter_struct* init_struct)
{
    uint32_t ctl;
...
# 163 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_dma.c"
void dma_circulation_enable(uint32_t dma_periph, dma_channel_enum channelx)
{
    if(ERROR == dma_periph_and_channel_check(dma_periph, channelx)){
        while(1){}
...
# 182 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_dma.c"
void dma_circulation_disable(uint32_t dma_periph, dma_channel_enum channelx)
{
    if(ERROR == dma_periph_and_channel_check(dma_periph, channelx)){
        while(1){}
...
# 201 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_dma.c"
void dma_memory_to_memory_enable(uint32_t dma_periph, dma_channel_enum channelx)
{
    if(ERROR == dma_periph_and_channel_check(dma_periph, channelx)){
        while(1){}
...
# 220 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_dma.c"
void dma_memory_to_memory_disable(uint32_t dma_periph, dma_channel_enum channelx)
{
    if(ERROR == dma_periph_and_channel_check(dma_periph, channelx)){
        while(1){}
...
# 239 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_dma.c"
void dma_channel_enable(uint32_t dma_periph, dma_channel_enum channelx)
{
    if(ERROR == dma_periph_and_channel_check(dma_periph, channelx)){
        while(1){}
...
# 258 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_dma.c"
void dma_channel_disable(uint32_t dma_periph, dma_channel_enum channelx)
{
    if(ERROR == dma_periph_and_channel_check(dma_periph, channelx)){
        while(1){}
...
# 278 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_dma.c"
void dma_periph_address_config(uint32_t dma_periph, dma_channel_enum channelx, uint32_t address)
{
    if(ERROR == dma_periph_and_channel_check(dma_periph, channelx)){
        while(1){}
...
# 298 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_dma.c"
void dma_memory_address_config(uint32_t dma_periph, dma_channel_enum channelx, uint32_t address)
{
    if(ERROR == dma_periph_and_channel_check(dma_periph, channelx)){
        while(1){}
...
# 318 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_dma.c"
void dma_transfer_number_config(uint32_t dma_periph, dma_channel_enum channelx, uint32_t number)
{
    if(ERROR == dma_periph_and_channel_check(dma_periph, channelx)){
        while(1){}
...
# 337 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_dma.c"
uint32_t dma_transfer_number_get(uint32_t dma_periph, dma_channel_enum channelx)
{
    if(ERROR == dma_periph_and_channel_check(dma_periph, channelx)){
        while(1){}
...
# 362 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_dma.c"
void dma_priority_config(uint32_t dma_periph, dma_channel_enum channelx, uint32_t priority)
{
    uint32_t ctl;
...
# 393 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_dma.c"
void dma_memory_width_config(uint32_t dma_periph, dma_channel_enum channelx, uint32_t mwidth)
{
    uint32_t ctl;
...
# 424 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_dma.c"
void dma_periph_width_config (uint32_t dma_periph, dma_channel_enum channelx, uint32_t pwidth)
{
    uint32_t ctl;
...
# 450 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_dma.c"
void dma_memory_increase_enable(uint32_t dma_periph, dma_channel_enum channelx)
{
    if(ERROR == dma_periph_and_channel_check(dma_periph, channelx)){
        while(1){}
...
# 469 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_dma.c"
void dma_memory_increase_disable(uint32_t dma_periph, dma_channel_enum channelx)
{
    if(ERROR == dma_periph_and_channel_check(dma_periph, channelx)){
        while(1){}
...
# 488 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_dma.c"
void dma_periph_increase_enable(uint32_t dma_periph, dma_channel_enum channelx)
{
    if(ERROR == dma_periph_and_channel_check(dma_periph, channelx)){
        while(1){}
...
# 507 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_dma.c"
void dma_periph_increase_disable(uint32_t dma_periph, dma_channel_enum channelx)
{
    if(ERROR == dma_periph_and_channel_check(dma_periph, channelx)){
        while(1){}
...
# 530 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_dma.c"
void dma_transfer_direction_config(uint32_t dma_periph, dma_channel_enum channelx, uint32_t direction)
{
    if(ERROR == dma_periph_and_channel_check(dma_periph, channelx)){
        while(1){}
...
# 559 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_dma.c"
FlagStatus dma_flag_get(uint32_t dma_periph, dma_channel_enum channelx, uint32_t flag)
{
    FlagStatus reval;
...
# 588 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_dma.c"
void dma_flag_clear(uint32_t dma_periph, dma_channel_enum channelx, uint32_t flag)
{
    (*(volatile uint32_t *)(uint32_t)((dma_periph) + 0x04U)) |= ((flag) << ((channelx) * 4U));
}
# 608 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_dma.c"
FlagStatus dma_interrupt_flag_get(uint32_t dma_periph, dma_channel_enum channelx, uint32_t flag)
{
...
# 656 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_dma.c"
void dma_interrupt_flag_clear(uint32_t dma_periph, dma_channel_enum channelx, uint32_t flag)
{
    (*(volatile uint32_t *)(uint32_t)((dma_periph) + 0x04U)) |= ((flag) << ((channelx) * 4U));
}
# 676 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_dma.c"
void dma_interrupt_enable(uint32_t dma_periph, dma_channel_enum channelx, uint32_t source)
{
    if(ERROR == dma_periph_and_channel_check(dma_periph, channelx)){
        while(1){}
...
# 700 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_dma.c"
void dma_interrupt_disable(uint32_t dma_periph, dma_channel_enum channelx, uint32_t source)
{
    if(ERROR == dma_periph_and_channel_check(dma_periph, channelx)){
        while(1){}
...
# 719 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_dma.c"
static ErrStatus dma_periph_and_channel_check(uint32_t dma_periph, dma_channel_enum channelx)
{
