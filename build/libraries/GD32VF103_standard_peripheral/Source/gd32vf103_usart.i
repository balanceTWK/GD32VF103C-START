# 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_usart.c"
...
# 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_usart.c"
# 35 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_usart.c"
...
# 39 "libraries/GD32VF103_standard_peripheral/Include/gd32vf103_usart.h" 2
...
# 36 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_usart.c" 2
...
void usart_deinit(uint32_t usart_periph)
{
    ...
    case ((((uint32_t)0x40000000U) + 0x00004400U)+(0x00000400U)):
        ...
        break;
    case ((((uint32_t)0x40000000U) + 0x00004400U)+(0x00000800U)):

        rcu_periph_reset_enable(RCU_UART3RST);
        rcu_periph_reset_disable(RCU_UART3RST);
        break;
    case ((((uint32_t)0x40000000U) + 0x00004400U)+(0x00000C00U)):
...
# 83 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_usart.c"
void usart_baudrate_set(uint32_t usart_periph, uint32_t baudval)
{
    ...
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x00000008U))) = ((((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3)))) | ((0xFFFFFFFFUL << (4)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(15))))) & (intdiv | fradiv));
}
# 129 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_usart.c"
void usart_parity_config(uint32_t usart_periph, uint32_t paritycfg)
{

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x0000000CU))) &= ~(((uint32_t)((uint32_t)0x01U<<(9))) | ((uint32_t)((uint32_t)0x01U<<(10))));

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x0000000CU))) |= paritycfg ;
}
# 147 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_usart.c"
void usart_word_length_set(uint32_t usart_periph, uint32_t wlen)
{

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x0000000CU))) &= ~((uint32_t)((uint32_t)0x01U<<(12)));

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x0000000CU))) |= wlen;
}
# 167 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_usart.c"
void usart_stop_bit_set(uint32_t usart_periph, uint32_t stblen)
{

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x00000010U))) &= ~((0xFFFFFFFFUL << (12)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(13))));

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x00000010U))) |= stblen;
}
...
void usart_enable(uint32_t usart_periph)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x0000000CU))) |= ((uint32_t)((uint32_t)0x01U<<(13)));
}
...
# 207 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_usart.c"
void usart_transmit_config(uint32_t usart_periph, uint32_t txconfig)
{
    uint32_t ctl = 0U;

    ctl = (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x0000000CU)));
    ctl &= ~((uint32_t)((uint32_t)0x01U<<(3)));
    ctl |= txconfig;

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x0000000CU))) = ctl;
}
# 228 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_usart.c"
void usart_receive_config(uint32_t usart_periph, uint32_t rxconfig)
{
    uint32_t ctl = 0U;

    ctl = (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x0000000CU)));
    ctl &= ~((uint32_t)((uint32_t)0x01U<<(2)));
    ctl |= rxconfig;

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x0000000CU))) = ctl;
}
# 246 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_usart.c"
void usart_data_transmit(uint32_t usart_periph, uint32_t data)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x00000004U))) = ((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(8)))) & data;
}
...
uint16_t usart_data_receive(uint32_t usart_periph)
{
    return (uint16_t)(((((*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x00000004U)))) & ((0xFFFFFFFFUL << ((0U))) & (0xFFFFFFFFUL >> (31U - (uint32_t)((8U)))))) >> (0U)));
}
# 269 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_usart.c"
void usart_address_config(uint32_t usart_periph, uint8_t addr)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x00000010U))) &= ~(((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3)))));
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x00000010U))) |= (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3)))) & addr);
}
...
void usart_mute_mode_enable(uint32_t usart_periph)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x0000000CU))) |= ((uint32_t)((uint32_t)0x01U<<(1)));
}
...
# 307 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_usart.c"
void usart_mute_mode_wakeup_config(uint32_t usart_periph, uint32_t wmethod)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x0000000CU))) &= ~(((uint32_t)((uint32_t)0x01U<<(11))));
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x0000000CU))) |= wmethod;
}
...
void usart_lin_mode_enable(uint32_t usart_periph)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x00000010U))) |= ((uint32_t)((uint32_t)0x01U<<(14)));
}
...
# 345 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_usart.c"
void usart_lin_break_detection_length_config(uint32_t usart_periph, uint32_t lblen)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x00000010U))) &= ~(((uint32_t)((uint32_t)0x01U<<(5))));
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x00000010U))) |= (((uint32_t)((uint32_t)0x01U<<(5))) & lblen);
}
...
void usart_send_break(uint32_t usart_periph)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x0000000CU))) |= ((uint32_t)((uint32_t)0x01U<<(0)));
}
...
void usart_halfduplex_enable(uint32_t usart_periph)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x00000014U))) |= ((uint32_t)((uint32_t)0x01U<<(3)));
}
...
void usart_synchronous_clock_enable(uint32_t usart_periph)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x00000010U))) |= ((uint32_t)((uint32_t)0x01U<<(11)));
}
...
# 424 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_usart.c"
void usart_synchronous_clock_config(uint32_t usart_periph, uint32_t clen, uint32_t cph, uint32_t cpl)
{
    uint32_t ctl = 0U;


    ctl = (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x00000010U)));
    ctl &= ~(((uint32_t)((uint32_t)0x01U<<(8))) | ((uint32_t)((uint32_t)0x01U<<(9))) | ((uint32_t)((uint32_t)0x01U<<(10))));

    ctl |= (((uint32_t)((uint32_t)0x01U<<(8))) & clen) | (((uint32_t)((uint32_t)0x01U<<(9))) & cph) | (((uint32_t)((uint32_t)0x01U<<(10))) & cpl);

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x00000010U))) = ctl;
}
# 444 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_usart.c"
void usart_guard_time_config(uint32_t usart_periph,uint32_t gaut)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x00000018U))) &= ~(((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(15)))));
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x00000018U))) |= (((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(15)))) & ((gaut)<<8));
}
...
void usart_smartcard_mode_enable(uint32_t usart_periph)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x00000014U))) |= ((uint32_t)((uint32_t)0x01U<<(5)));
}
...
void usart_smartcard_mode_nack_enable(uint32_t usart_periph)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x00000014U))) |= ((uint32_t)((uint32_t)0x01U<<(4)));
}
...
void usart_irda_mode_enable(uint32_t usart_periph)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x00000014U))) |= ((uint32_t)((uint32_t)0x01U<<(1)));
}
...
# 523 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_usart.c"
void usart_prescaler_config(uint32_t usart_periph, uint8_t psc)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x00000018U))) &= ~(((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))));
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x00000018U))) |= psc;
}
# 539 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_usart.c"
void usart_irda_lowpower_config(uint32_t usart_periph, uint32_t irlp)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x00000014U))) &= ~(((uint32_t)((uint32_t)0x01U<<(2))));
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x00000014U))) |= (((uint32_t)((uint32_t)0x01U<<(2))) & irlp);
}
# 555 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_usart.c"
void usart_hardware_flow_rts_config(uint32_t usart_periph, uint32_t rtsconfig)
{
    uint32_t ctl = 0U;

    ctl = (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x00000014U)));
    ctl &= ~((uint32_t)((uint32_t)0x01U<<(8)));
    ctl |= rtsconfig;

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x00000014U))) = ctl;
}
# 576 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_usart.c"
void usart_hardware_flow_cts_config(uint32_t usart_periph, uint32_t ctsconfig)
{
    uint32_t ctl = 0U;

    ctl = (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x00000014U)));
    ctl &= ~((uint32_t)((uint32_t)0x01U<<(9)));
    ctl |= ctsconfig;

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + (0x00000014U))) = ctl;
}
# 597 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_usart.c"
void usart_dma_receive_config(uint32_t usart_periph, uint32_t dmacmd)
{
    uint32_t ctl = 0U;
...
# 618 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_usart.c"
void usart_dma_transmit_config(uint32_t usart_periph, uint32_t dmacmd)
{
    uint32_t ctl = 0U;
...
# 647 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_usart.c"
FlagStatus usart_flag_get(uint32_t usart_periph, usart_flag_enum flag)
{
...
# 668 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_usart.c"
void usart_flag_clear(uint32_t usart_periph, usart_flag_enum flag)
{
    ((*(volatile uint32_t *)(uint32_t)((usart_periph) + (((uint32_t)(flag) & (0x0000FFFFU)) >> 6)))) &= ~((uint32_t)((uint32_t)0x01U<<(((uint32_t)(flag) & (0x0000001FU)))));
}
# 689 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_usart.c"
void usart_interrupt_enable(uint32_t usart_periph, uint32_t int_flag)
{
    ((*(volatile uint32_t *)(uint32_t)((usart_periph) + (((uint32_t)(int_flag) & (0x0000FFFFU)) >> 6)))) |= ((uint32_t)((uint32_t)0x01U<<(((uint32_t)(int_flag) & (0x0000001FU)))));
}
# 710 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_usart.c"
void usart_interrupt_disable(uint32_t usart_periph, uint32_t int_flag)
{
    ((*(volatile uint32_t *)(uint32_t)((usart_periph) + (((uint32_t)(int_flag) & (0x0000FFFFU)) >> 6)))) &= ~((uint32_t)((uint32_t)0x01U<<(((uint32_t)(int_flag) & (0x0000001FU)))));
}
# 734 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_usart.c"
FlagStatus usart_interrupt_flag_get(uint32_t usart_periph, uint32_t int_flag)
{
...
# 761 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_usart.c"
void usart_interrupt_flag_clear(uint32_t usart_periph, uint32_t flag)
{
    ((*(volatile uint32_t *)(uint32_t)((usart_periph) + ((uint32_t)(flag) >> 22)))) &= ~((uint32_t)((uint32_t)0x01U<<((((uint32_t)(flag) & (0x001F0000U)) >> 16))));
}
