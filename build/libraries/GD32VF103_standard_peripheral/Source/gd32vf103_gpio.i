# 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_gpio.c"
...
# 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_gpio.c"
# 35 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_gpio.c"
...
# 39 "libraries/GD32VF103_standard_peripheral/Include/gd32vf103_gpio.h" 2
...
# 36 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_gpio.c" 2
...
# 123 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_gpio.c"
...
# 198 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_gpio.c"
void gpio_bit_set(uint32_t gpio_periph, uint32_t pin)
{
    (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x10U)) = (uint32_t) pin;
}
# 212 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_gpio.c"
void gpio_bit_reset(uint32_t gpio_periph, uint32_t pin)
{
    (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x14U)) = (uint32_t) pin;
}
# 230 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_gpio.c"
void gpio_bit_write(uint32_t gpio_periph, uint32_t pin, bit_status bit_value)
{
    if (RESET != bit_value) {
        (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x10U)) = (uint32_t) pin;
...
# 246 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_gpio.c"
void gpio_port_write(uint32_t gpio_periph, uint16_t data)
{
    (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x0CU)) = (uint32_t) data;
}
# 260 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_gpio.c"
FlagStatus gpio_input_bit_get(uint32_t gpio_periph, uint32_t pin)
{
...
# 289 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_gpio.c"
FlagStatus gpio_output_bit_get(uint32_t gpio_periph, uint32_t pin)
{
...
# 342 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_gpio.c"
void gpio_pin_remap_config(uint32_t remap, ControlStatus newvalue)
{
    ...
    if ((((uint32_t)0x00200000U) | ((uint32_t)0x00100000U))
            == (remap & (((uint32_t)0x00200000U) | ((uint32_t)0x00100000U)))) {
        temp_reg &= ((uint32_t)0xF0FFFFFFU);
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x04U)) &= ((uint32_t)0xF0FFFFFFU);
...
# 398 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_gpio.c"
void gpio_exti_source_select(uint8_t output_port, uint8_t output_pin)
{
    uint32_t source = 0U;
    source = ((uint32_t) 0x0FU)
            << (((uint8_t)0x04U) * (output_pin & ((uint8_t)0x03U)));


    if (((uint8_t)0x04U) > output_pin) {

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x08U)) &= ~source;
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x08U)) |= (((uint32_t) output_port)
                << (((uint8_t)0x04U)
                        * (output_pin & ((uint8_t)0x03U))));
    } else if (((uint8_t)0x08U) > output_pin) {

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x0CU)) &= ~source;
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x0CU)) |= (((uint32_t) output_port)
                << (((uint8_t)0x04U)
                        * (output_pin & ((uint8_t)0x03U))));
    } else if (((uint8_t)0x0CU) > output_pin) {

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x10U)) &= ~source;
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x10U)) |= (((uint32_t) output_port)
                << (((uint8_t)0x04U)
                        * (output_pin & ((uint8_t)0x03U))));
    } else {

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x14U)) &= ~source;
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x14U)) |= (((uint32_t) output_port)
                << (((uint8_t)0x04U)
                        * (output_pin & ((uint8_t)0x03U))));
    }
}
# 447 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_gpio.c"
void gpio_event_output_config(uint8_t output_port, uint8_t output_pin)
{
    uint32_t reg = 0U;
...
# 492 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_gpio.c"
void gpio_pin_lock(uint32_t gpio_periph, uint32_t pin)
{
