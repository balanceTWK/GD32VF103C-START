...
.Ltext0:
	...
	.align	1
	.globl	exmc_norsram_deinit
	.type	exmc_norsram_deinit, @function
exmc_norsram_deinit:
.LFB2:
	.file 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_exmc.c"
	.loc 1 59 1
	.cfi_startproc
	addi	sp,sp,-32
...
.L2:
	...
	.cfi_endproc
.LFE2:
	.size	exmc_norsram_deinit, .-exmc_norsram_deinit
	.align	1
	.globl	exmc_norsram_struct_para_init
	.type	exmc_norsram_struct_para_init, @function
...
.LFB3:
	...
	.cfi_endproc
.LFE3:
	.size	exmc_norsram_struct_para_init, .-exmc_norsram_struct_para_init
	.align	1
	.globl	exmc_norsram_init
	.type	exmc_norsram_init, @function
exmc_norsram_init:
.LFB4:
	.loc 1 109 1
	.cfi_startproc
...
.L5:
	...
	.cfi_endproc
.LFE4:
	.size	exmc_norsram_init, .-exmc_norsram_init
	.align	1
	.globl	exmc_norsram_enable
	.type	exmc_norsram_enable, @function
exmc_norsram_enable:
.LFB5:
	.loc 1 150 1
	.cfi_startproc
	...
	.cfi_endproc
.LFE5:
	.size	exmc_norsram_enable, .-exmc_norsram_enable
	.align	1
	.globl	exmc_norsram_disable
	.type	exmc_norsram_disable, @function
...
.LFB6:
	...
	.cfi_endproc
.LFE6:
	.size	exmc_norsram_disable, .-exmc_norsram_disable
.Letext0:
	...
	.file 4 "libraries/GD32VF103_standard_peripheral/Include/gd32vf103_exmc.h"
	.file 5 "libraries/GD32VF103_standard_peripheral/system_gd32vf103.h"
	.file 6 "libraries/GD32VF103_standard_peripheral/gd32vf103.h"
...
.Ldebug_macro33:
	...
	.4byte	.LASF3079
	.byte	0
	.section	.debug_macro,"G",@progbits,wm4.gd32vf103_exmc.h.41.f3492a97acff5423e7485ac04b0f780f,comdat
.Ldebug_macro34:
	.2byte	0x4
	.byte	0
	.byte	0x5
...
.LASF3145:
	.string	"exmc_norsram_parameter_struct"
.LASF1741:
...
.LASF3110:
	.string	"BANK0_SNTCFG_RESET ((uint32_t)0x0FFFFFFFU)"
.LASF2957:
...
.LASF3112:
	.string	"SNCTL_WREN_OFFSET ((uint32_t)12U)"
.LASF1048:
...
.LASF3135:
	.string	"exmc_norsram_timing_parameter_struct"
.LASF3005:
...
.LASF3152:
	.string	"exmc_norsram_struct_para_init"
.LASF2938:
...
.LASF3115:
	.string	"SNTCFG_AHLD_OFFSET ((uint32_t)4U)"
.LASF679:
...
.LASF3113:
	.string	"SNCTL_NRWTEN_OFFSET ((uint32_t)13U)"
.LASF2741:
...
.LASF3149:
	.string	"exmc_norsram_init_struct"
.LASF978:
...
.LASF3154:
	.string	"libraries/GD32VF103_standard_peripheral/Source/gd32vf103_exmc.c"
.LASF639:
...
.LASF3116:
	.string	"SNTCFG_DSET_OFFSET ((uint32_t)8U)"
.LASF1770:
...
.LASF3111:
	.string	"SNCTL_NRMUX_OFFSET ((uint32_t)1U)"
.LASF2160:
...
.LASF3117:
	.string	"SNTCFG_BUSLAT_OFFSET ((uint32_t)16U)"
.LASF2084:
...
.LASF3109:
	.string	"BANK0_SNCTL0_REGION_RESET ((uint32_t)0x000030DAU)"
.LASF717:
...
.LASF3114:
	.string	"SNCTL_ASYNCWAIT_OFFSET ((uint32_t)15U)"
.LASF938:
