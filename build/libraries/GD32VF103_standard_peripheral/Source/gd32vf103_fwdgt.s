...
fwdgt_write_enable:
.LFB2:
	.file 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_fwdgt.c"
	.loc 1 49 1
	.cfi_startproc
	addi	sp,sp,-16
	...
	.cfi_endproc
.LFE2:
	.size	fwdgt_write_enable, .-fwdgt_write_enable
	.align	1
...
.LFB3:
	...
	.cfi_endproc
.LFE3:
	.size	fwdgt_write_disable, .-fwdgt_write_disable
	.align	1
	.globl	fwdgt_enable
...
.LFB4:
	...
	.cfi_endproc
.LFE4:
	.size	fwdgt_enable, .-fwdgt_enable
	.align	1
...
.LFB5:
	...
	.cfi_endproc
.LFE5:
	.size	fwdgt_counter_reload, .-fwdgt_counter_reload
	.align	1
	.globl	fwdgt_config
...
.L9:
	...
	.cfi_endproc
.LFE6:
	.size	fwdgt_config, .-fwdgt_config
	.align	1
...
.L15:
	...
	.cfi_endproc
.LFE7:
	.size	fwdgt_flag_get, .-fwdgt_flag_get
.Letext0:
...
.Ldebug_macro0:
	...
	.byte	0x5
	.4byte	.LASF317
	.file 6 "libraries/GD32VF103_standard_peripheral/Include/gd32vf103_fwdgt.h"
	.byte	0x3
	.byte	0x23
	.byte	0x6
	.byte	0x5
...
.Ldebug_macro33:
	...
	.4byte	.LASF3082
	.byte	0
	.section	.debug_macro,"G",@progbits,wm4.gd32vf103_fwdgt.h.41.acab9c3fa03b30271be338266eec3da8,comdat
.Ldebug_macro34:
	.2byte	0x4
	.byte	0
	.byte	0x5
...
.LASF3109:
	.string	"CTL_CMD(regval) (BITS(0,15) & ((uint32_t)(regval) << 0))"
.LASF3000:
...
.LASF3143:
	.string	"libraries/GD32VF103_standard_peripheral/Source/gd32vf103_fwdgt.c"
.LASF2115:
...
.LASF3110:
	.string	"RLD_RLD(regval) (BITS(0,11) & ((uint32_t)(regval) << 0))"
.LASF202:
