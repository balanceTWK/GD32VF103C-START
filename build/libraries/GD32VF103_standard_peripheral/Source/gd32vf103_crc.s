...
crc_deinit:
.LFB2:
	.file 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_crc.c"
	.loc 1 47 1
	.cfi_startproc
	addi	sp,sp,-16
...
.LFB3:
	...
	.cfi_endproc
.LFE3:
	.size	crc_data_register_reset, .-crc_data_register_reset
	.align	1
...
.LFB4:
	...
	.cfi_endproc
.LFE4:
	.size	crc_data_register_read, .-crc_data_register_read
	.align	1
...
.LFB5:
	...
	.cfi_endproc
.LFE5:
	.size	crc_free_data_register_read, .-crc_free_data_register_read
	.align	1
...
.LFB6:
	...
	.cfi_endproc
.LFE6:
	.size	crc_free_data_register_write, .-crc_free_data_register_write
	.align	1
...
.LFB7:
	...
	.cfi_endproc
.LFE7:
	.size	crc_single_data_calculate, .-crc_single_data_calculate
	.align	1
...
.L12:
	...
	.loc 1 124 100 discriminator 3
	lw	a4,0(a4)
	.loc 1 124 93 discriminator 3
	sw	a4,0(a5)
	.loc 1 123 40 discriminator 3
	lw	a5,-20(s0)
	addi	a5,a5,1
	sw	a5,-20(s0)
.L11:
	...
	.cfi_endproc
.LFE8:
	.size	crc_block_data_calculate, .-crc_block_data_calculate
.Letext0:
...
.Ldebug_macro0:
	...
	.byte	0x5
	.4byte	.LASF317
	.file 5 "libraries/GD32VF103_standard_peripheral/Include/gd32vf103_crc.h"
	.byte	0x3
	.byte	0x23
	.byte	0x5
	.byte	0x5
...
.Ldebug_macro33:
	...
	.4byte	.LASF3101
	.byte	0
	.section	.debug_macro,"G",@progbits,wm4.gd32vf103_crc.h.42.3974325b24e70f521678ec5fc44de9a5,comdat
.Ldebug_macro34:
	.2byte	0x4
	.byte	0
	.byte	0x5
...
.LASF3138:
	.string	"libraries/GD32VF103_standard_peripheral/Source/gd32vf103_crc.c"
.LASF2287:
...
.LASF382:
	.string	"__int20 +2"
.LASF3126:
	.string	"crc_block_data_calculate"
.LASF331:
...
.LASF3110:
	.string	"CRC_FDATA_RESET_VALUE ((uint32_t)0x00000000U)"
.LASF1857:
...
.LASF3127:
	.string	"crc_single_data_calculate"
.LASF2019:
...
.LASF3135:
	.string	"crc_data_register_reset"
.LASF610:
...
.LASF3109:
	.string	"CRC_DATA_RESET_VALUE ((uint32_t)0xFFFFFFFFU)"
.LASF2668:
...
.LASF3141:
	.string	"crc_free_data_register_write"
.LASF2144:
...
.LASF0:
	.string	"__STDC__ 1"
.LASF3130:
	.string	"crc_free_data_register_read"
.LASF1213:
