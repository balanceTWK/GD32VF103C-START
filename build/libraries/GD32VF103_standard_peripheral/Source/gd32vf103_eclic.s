...
.LFB2:
	.file 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_eclic.c"
	.loc 1 52 50
	.cfi_startproc
	addi	sp,sp,-32
...
.LFB3:
	...
	mv	a1,a5
	lw	a0,-20(s0)
	call	eclic_set_int_level
	.loc 1 67 5
	lbu	a5,-22(s0)
	mv	a1,a5
	lw	a0,-20(s0)
	call	eclic_set_int_priority
	.loc 1 68 1
	nop
	lw	ra,28(sp)
	.cfi_restore 1
...
.LBB2:
	.loc 1 98 89
 #APP
# 98 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_eclic.c" 1
	csrrs a5, 0x812, 1
# 0 "" 2
 #NO_APP
	sw	a5,-20(s0)
...
.Ldebug_macro0:
	...
	.byte	0x5
	.4byte	.LASF317
	.file 5 "libraries/GD32VF103_standard_peripheral/Include/gd32vf103_eclic.h"
	.byte	0x3
	.byte	0x23
	.byte	0x5
	.byte	0x5
...
.Ldebug_macro33:
	...
	.4byte	.LASF3102
	.byte	0
	.section	.debug_macro,"G",@progbits,wm4.gd32vf103_eclic.h.41.33fa009a537792acd813a7b25aedd637,comdat
.Ldebug_macro34:
	.2byte	0x4
	.byte	0
	.byte	0x5
...
.LASF2394:
	.string	"RTC RTC_BASE"
.LASF3934:
	.string	"REG_DBGMCU2EN ((uint32_t)0xE004200C)"
.LASF946:
...
.LASF3956:
	.string	"libraries/GD32VF103_standard_peripheral/Source/gd32vf103_eclic.c"
.LASF1369:
...
.LASF3933:
	.string	"REG_DBGMCU2 ((uint32_t)0xE0042008)"
.LASF1069:
