...
wwdgt_deinit:
.LFB2:
	.file 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_wwdgt.c"
	.loc 1 49 1
	.cfi_startproc
	addi	sp,sp,-16
	...
	.cfi_endproc
.LFE2:
	.size	wwdgt_deinit, .-wwdgt_deinit
	.align	1
	.globl	wwdgt_enable
...
.LFB3:
	...
	.cfi_endproc
.LFE3:
	.size	wwdgt_enable, .-wwdgt_enable
	.align	1
...
.LFB4:
	...
	.cfi_endproc
.LFE4:
	.size	wwdgt_counter_update, .-wwdgt_counter_update
	.align	1
	.globl	wwdgt_config
...
.LFB5:
	...
	.cfi_endproc
.LFE5:
	.size	wwdgt_config, .-wwdgt_config
	.align	1
...
.LFB6:
	...
	.cfi_endproc
.LFE6:
	.size	wwdgt_interrupt_enable, .-wwdgt_interrupt_enable
	.align	1
...
.L8:
	...
	.cfi_endproc
.LFE7:
	.size	wwdgt_flag_get, .-wwdgt_flag_get
	.align	1
...
.LFB8:
	...
	.cfi_endproc
.LFE8:
	.size	wwdgt_flag_clear, .-wwdgt_flag_clear
.Letext0:
...
.Ldebug_macro0:
	...
	.byte	0x5
	.4byte	.LASF317
	.file 7 "libraries/GD32VF103_standard_peripheral/Include/gd32vf103_wwdgt.h"
	.byte	0x3
	.byte	0x23
	.byte	0x7
	.byte	0x5
...
.Ldebug_macro33:
	...
	.4byte	.LASF3093
	.byte	0
	.section	.debug_macro,"G",@progbits,wm4.gd32vf103_wwdgt.h.41.061d8ac076ec656404bcf4dbd13c98aa,comdat
.Ldebug_macro34:
	.2byte	0x4
	.byte	0
	.byte	0x5
...
.LASF3171:
	.string	"libraries/GD32VF103_standard_peripheral/Source/gd32vf103_wwdgt.c"
.LASF415:
...
.LASF3109:
	.string	"CTL_CNT(regval) (BITS(0,6) & ((uint32_t)(regval) << 0))"
.LASF50:
...
.LASF3110:
	.string	"CFG_WIN(regval) (BITS(0,6) & ((uint32_t)(regval) << 0))"
.LASF354:
