...
spi_i2s_deinit:
.LFB2:
	.file 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_spi.c"
	.loc 1 59 1
	.cfi_startproc
	addi	sp,sp,-32
...
.LFB3:
	...
	.cfi_endproc
.LFE3:
	.size	spi_struct_para_init, .-spi_struct_para_init
	.align	1
	.globl	spi_init
...
.L23:
	...
	.cfi_endproc
.LFE8:
	.size	i2s_psc_config, .-i2s_psc_config
	.align	1
	.globl	i2s_enable
...
.LFB11:
	...
	.cfi_endproc
.LFE11:
	.size	spi_nss_output_enable, .-spi_nss_output_enable
	.align	1
...
.LFB12:
	...
	.cfi_endproc
.LFE12:
	.size	spi_nss_output_disable, .-spi_nss_output_disable
	.align	1
...
.LFB13:
	...
	.cfi_endproc
.LFE13:
	.size	spi_nss_internal_high, .-spi_nss_internal_high
	.align	1
...
.LFB14:
	...
	.cfi_endproc
.LFE14:
	.size	spi_nss_internal_low, .-spi_nss_internal_low
	.align	1
...
.L33:
	...
	.cfi_endproc
.LFE15:
	.size	spi_dma_enable, .-spi_dma_enable
	.align	1
...
.L37:
	...
	.cfi_endproc
.LFE16:
	.size	spi_dma_disable, .-spi_dma_disable
	.align	1
	.globl	spi_i2s_data_frame_format_config
	.type	spi_i2s_data_frame_format_config, @function
...
.LFB17:
	...
	.cfi_endproc
.LFE17:
	.size	spi_i2s_data_frame_format_config, .-spi_i2s_data_frame_format_config
	.align	1
...
.LFB18:
	...
	.cfi_endproc
.LFE18:
	.size	spi_i2s_data_transmit, .-spi_i2s_data_transmit
	.align	1
...
.LFB19:
	...
	.cfi_endproc
.LFE19:
	.size	spi_i2s_data_receive, .-spi_i2s_data_receive
	.align	1
...
.L45:
	...
	.cfi_endproc
.LFE20:
	.size	spi_bidirectional_transfer_config, .-spi_bidirectional_transfer_config
	.align	1
...
.LFB21:
	...
	.cfi_endproc
.LFE21:
	.size	spi_crc_polynomial_set, .-spi_crc_polynomial_set
	.align	1
...
.LFB22:
	...
	.cfi_endproc
.LFE22:
	.size	spi_crc_polynomial_get, .-spi_crc_polynomial_get
	.align	1
	.globl	spi_crc_on
...
.LFB25:
	...
	.cfi_endproc
.LFE25:
	.size	spi_crc_next, .-spi_crc_next
	.align	1
	.globl	spi_crc_get
...
.LFB27:
	...
	.cfi_endproc
.LFE27:
	.size	spi_ti_mode_enable, .-spi_ti_mode_enable
	.align	1
...
.LFB28:
	...
	.cfi_endproc
.LFE28:
	.size	spi_ti_mode_disable, .-spi_ti_mode_disable
	.align	1
...
.LFB29:
	...
	.cfi_endproc
.LFE29:
	.size	spi_nssp_mode_enable, .-spi_nssp_mode_enable
	.align	1
...
.LFB30:
	...
	.cfi_endproc
.LFE30:
	.size	spi_nssp_mode_disable, .-spi_nssp_mode_disable
	.align	1
...
.L63:
	...
	.cfi_endproc
.LFE31:
	.size	spi_i2s_interrupt_enable, .-spi_i2s_interrupt_enable
	.align	1
...
.L69:
	...
	.cfi_endproc
.LFE32:
	.size	spi_i2s_interrupt_disable, .-spi_i2s_interrupt_disable
	.align	1
...
.L83:
	...
	.cfi_endproc
.LFE33:
	.size	spi_i2s_interrupt_flag_get, .-spi_i2s_interrupt_flag_get
	.align	1
...
.L87:
	...
	.cfi_endproc
.LFE34:
	.size	spi_i2s_flag_get, .-spi_i2s_flag_get
	.align	1
...
.LFB35:
	...
	.cfi_endproc
.LFE35:
	.size	spi_crc_error_clear, .-spi_crc_error_clear
.Letext0:
	...
	.file 6 "libraries/GD32VF103_standard_peripheral/Include/gd32vf103_spi.h"
...
.Ldebug_macro33:
	...
	.4byte	.LASF2966
	.byte	0
	.section	.debug_macro,"G",@progbits,wm4.gd32vf103_spi.h.41.7f1b1bee7a8c0d987c80823382b7d1df,comdat
.Ldebug_macro34:
	.2byte	0x4
	.byte	0
	.byte	0x5
...
.LASF3186:
	.string	"spi_i2s_interrupt_disable"
.LASF2755:
...
.LASF3181:
	.string	"spi_i2s_interrupt_flag_get"
.LASF906:
...
.LASF3116:
	.string	"RCU_CFG1_PREDV1_OFFSET 4U"
.LASF1802:
...
.LASF3111:
	.string	"I2S1_CLOCK_SEL ((uint32_t)0x00020000U)"
.LASF775:
...
.LASF2013:
	.string	"DBG DBG_BASE"
.LASF3199:
	.string	"spi_bidirectional_transfer_config"
.LASF1600:
...
.LASF3113:
	.string	"I2S_CLOCK_MUL_MASK ((uint32_t)0x0000F000U)"
.LASF364:
...
.LASF3110:
	.string	"I2S_INIT_MASK ((uint32_t)0x0000F047U)"
.LASF3169:
	.string	"CK_APB1"
.LASF3170:
	.string	"CK_APB2"
...
.LASF3204:
	.string	"spi_i2s_data_frame_format_config"
.LASF103:
...
.LASF3114:
	.string	"I2S_CLOCK_DIV_MASK ((uint32_t)0x000000F0U)"
.LASF1866:
...
.LASF3109:
	.string	"SPI_INIT_MASK ((uint32_t)0x00003040U)"
.LASF832:
...
.LASF3115:
	.string	"SPI_I2SPSC_DEFAULT_VALUE ((uint32_t)0x00000002U)"
.LASF1101:
...
.LASF3187:
	.string	"spi_i2s_interrupt_enable"
.LASF1000:
...
.LASF3232:
	.string	"libraries/GD32VF103_standard_peripheral/Source/gd32vf103_spi.c"
.LASF2584:
...
.LASF3112:
	.string	"I2S2_CLOCK_SEL ((uint32_t)0x00040000U)"
.LASF2550:
...
.LASF3117:
	.string	"RCU_CFG1_PLL2MF_OFFSET 12U"
.LASF706:
	.string	"BKP BKP_BASE"
.LASF1226:
