# 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_can.c"
...
# 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_can.c"
# 35 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_can.c"
...
# 39 "libraries/GD32VF103_standard_peripheral/Include/gd32vf103_can.h" 2
...
# 36 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_can.c" 2

#define CAN_ERROR_HANDLE(s) do{}while(1)
# 46 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_can.c"
void can_deinit(uint32_t can_periph)
{
    if((((uint32_t)0x40000000U) + 0x00006400U) == can_periph){
...
# 69 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_can.c"
void can_struct_para_init(can_struct_type_enum type, void* p_struct)
{
    uint8_t i;
    ...
    switch(type){
        ...
        case CAN_INIT_STRUCT:
            ...
            ((can_parameter_struct*)p_struct)->resync_jump_width = ((uint8_t)0x00U);
            ((can_parameter_struct*)p_struct)->time_segment_1 = ((uint8_t)0x02U);
            ((can_parameter_struct*)p_struct)->time_segment_2 = ((uint8_t)0x00U);
            ((can_parameter_struct*)p_struct)->time_triggered = DISABLE;
            ((can_parameter_struct*)p_struct)->trans_fifo_order = DISABLE;
            ((can_parameter_struct*)p_struct)->working_mode = ((uint8_t)0x00U);

            break;

        case CAN_FILTER_STRUCT:
            ((can_filter_parameter_struct*)p_struct)->filter_bits = ((uint8_t)0x01U);
            ((can_filter_parameter_struct*)p_struct)->filter_enable = DISABLE;
            ((can_filter_parameter_struct*)p_struct)->filter_fifo_number = ((uint8_t)0x00U);
            ...
            ((can_filter_parameter_struct*)p_struct)->filter_mode = ((uint8_t)0x00U);
        ...
        case CAN_TX_MESSAGE_STRUCT:
            ...
            ((can_trasnmit_message_struct*)p_struct)->tx_ff = (uint8_t)((uint32_t)0x00000000U);
            ((can_trasnmit_message_struct*)p_struct)->tx_ft = (uint8_t)((uint32_t)0x00000000U);
        ...
        case CAN_RX_MESSAGE_STRUCT:
            ...
            ((can_receive_message_struct*)p_struct)->rx_ff = (uint8_t)((uint32_t)0x00000000U);
            ((can_receive_message_struct*)p_struct)->rx_fi = 0U;
            ((can_receive_message_struct*)p_struct)->rx_ft = (uint8_t)((uint32_t)0x00000000U);
...
# 155 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_can.c"
ErrStatus can_init(uint32_t can_periph, can_parameter_struct* can_parameter_init)
{
    uint32_t timeout = ((uint32_t)0x0000FFFFU);
    ErrStatus flag = ERROR;


    (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x00U)) &= ~((uint32_t)((uint32_t)0x01U<<(1)));

    (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x00U)) |= ((uint32_t)((uint32_t)0x01U<<(0)));

    while((((uint32_t)((uint32_t)0x01U<<(0))) != ((*(volatile uint32_t *)(uint32_t)((can_periph) + 0x04U)) & ((uint32_t)((uint32_t)0x01U<<(0))))) && (0U != timeout)){
        timeout--;
    }

    if(((uint32_t)((uint32_t)0x01U<<(0))) != ((*(volatile uint32_t *)(uint32_t)((can_periph) + 0x04U)) & ((uint32_t)((uint32_t)0x01U<<(0))))){
        flag = ERROR;
    }else{

        (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x1CU)) = ((((0xFFFFFFFFUL << (30)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(31)))) & ((uint32_t)((uint32_t)can_parameter_init->working_mode) << 30)) |
                              (((0xFFFFFFFFUL << (24)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(25)))) & ((uint32_t)((uint32_t)can_parameter_init->resync_jump_width) << 24)) |
                              (((0xFFFFFFFFUL << (16)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(19)))) & ((uint32_t)((uint32_t)can_parameter_init->time_segment_1) << 16)) |
                              (((0xFFFFFFFFUL << (20)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(22)))) & ((uint32_t)((uint32_t)can_parameter_init->time_segment_2) << 20)) |
                              (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(9)))) & ((uint32_t)(((uint32_t)(can_parameter_init->prescaler) - 1U)) << 0)));


        if(ENABLE == can_parameter_init->time_triggered){
            (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x00U)) |= ((uint32_t)((uint32_t)0x01U<<(7)));
        }else{
            (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x00U)) &= ~((uint32_t)((uint32_t)0x01U<<(7)));
        }

        if(ENABLE == can_parameter_init->auto_bus_off_recovery){
            (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x00U)) |= ((uint32_t)((uint32_t)0x01U<<(6)));
        }else{
            (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x00U)) &= ~((uint32_t)((uint32_t)0x01U<<(6)));
        }

        if(ENABLE == can_parameter_init->auto_wake_up){
            (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x00U)) |= ((uint32_t)((uint32_t)0x01U<<(5)));
        }else{
            (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x00U)) &= ~((uint32_t)((uint32_t)0x01U<<(5)));
        }

        if(ENABLE == can_parameter_init->auto_retrans){
            (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x00U)) |= ((uint32_t)((uint32_t)0x01U<<(4)));
        }else{
            (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x00U)) &= ~((uint32_t)((uint32_t)0x01U<<(4)));
        }

        if(ENABLE == can_parameter_init->rec_fifo_overwrite){
            (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x00U)) |= ((uint32_t)((uint32_t)0x01U<<(3)));
        }else{
            (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x00U)) &= ~((uint32_t)((uint32_t)0x01U<<(3)));
        }

        if(ENABLE == can_parameter_init->trans_fifo_order){
            (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x00U)) |= ((uint32_t)((uint32_t)0x01U<<(2)));
        }else{
            (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x00U)) &= ~((uint32_t)((uint32_t)0x01U<<(2)));
        }

        (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x00U)) &= ~((uint32_t)((uint32_t)0x01U<<(0)));
        timeout = ((uint32_t)0x0000FFFFU);
    ...
    (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x180U)) = 0x0;
    (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x190U)) = 0x0;
    (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x1A0U)) = 0x0;
    (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x184U)) = 0x0;
    (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x194U)) = 0x0;
    (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x1A4U)) = 0x0;
    (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x188U)) = 0x0;
    (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x198U)) = 0x0;
    (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x1A8U)) = 0x0;
    (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x18CU)) = 0x0;
    (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x19CU)) = 0x0;
    (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x1ACU)) = 0x0;

    return flag;
}
# 258 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_can.c"
void can_filter_init(can_filter_parameter_struct* can_filter_parameter_init)
{
    uint32_t val = 0U;
    ...
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00006400U)) + 0x200U)) |= ((uint32_t)((uint32_t)0x01U<<(0)));

    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00006400U)) + 0x21CU)) &= ~(uint32_t)val;


    if(((uint8_t)0x00U) == can_filter_parameter_init->filter_bits){

        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00006400U)) + 0x20CU)) &= ~(uint32_t)val;

        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00006400U)) + 0x240U + ((can_filter_parameter_init->filter_number) * 0x8U) + 0x0U)) =
                                (((0xFFFFFFFFUL << (16)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(31)))) & ((uint32_t)((can_filter_parameter_init->filter_mask_low) & ((uint32_t)0x0000FFFFU)) << 16)) |
                                (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(15)))) & ((uint32_t)((can_filter_parameter_init->filter_list_low) & ((uint32_t)0x0000FFFFU)) << 0));

        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00006400U)) + 0x240U + ((can_filter_parameter_init->filter_number) * 0x8U) + 0x4U)) =
                                (((0xFFFFFFFFUL << (16)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(31)))) & ((uint32_t)((can_filter_parameter_init->filter_mask_high) & ((uint32_t)0x0000FFFFU)) << 16)) |
                                (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(15)))) & ((uint32_t)((can_filter_parameter_init->filter_list_high) & ((uint32_t)0x0000FFFFU)) << 0));
    }

    if(((uint8_t)0x01U) == can_filter_parameter_init->filter_bits){

        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00006400U)) + 0x20CU)) |= (uint32_t)val;

        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00006400U)) + 0x240U + ((can_filter_parameter_init->filter_number) * 0x8U) + 0x0U)) =
                                (((0xFFFFFFFFUL << (16)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(31)))) & ((uint32_t)((can_filter_parameter_init->filter_list_high) & ((uint32_t)0x0000FFFFU)) << 16)) |
                                (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(15)))) & ((uint32_t)((can_filter_parameter_init->filter_list_low) & ((uint32_t)0x0000FFFFU)) << 0));

        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00006400U)) + 0x240U + ((can_filter_parameter_init->filter_number) * 0x8U) + 0x4U)) =
                                (((0xFFFFFFFFUL << (16)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(31)))) & ((uint32_t)((can_filter_parameter_init->filter_mask_high) & ((uint32_t)0x0000FFFFU)) << 16)) |
                                (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(15)))) & ((uint32_t)((can_filter_parameter_init->filter_mask_low) & ((uint32_t)0x0000FFFFU)) << 0));
    }


    if(((uint8_t)0x00U) == can_filter_parameter_init->filter_mode){

        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00006400U)) + 0x204U)) &= ~(uint32_t)val;
    }else{
    ...
    if(((uint8_t)0x00U) == (can_filter_parameter_init->filter_fifo_number)){

        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00006400U)) + 0x214U)) &= ~(uint32_t)val;
    }else{
...
# 331 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_can.c"
void can1_filter_start_bank(uint8_t start_bank)
{

    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00006400U)) + 0x200U)) |= ((uint32_t)((uint32_t)0x01U<<(0)));

    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00006400U)) + 0x200U)) &= ~(uint32_t)((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(13))));
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00006400U)) + 0x200U)) |= (((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(13)))) & ((uint32_t)(start_bank) << 8));

    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00006400U)) + 0x200U)) &= ~((uint32_t)((uint32_t)0x01U<<(0)));
}
# 349 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_can.c"
void can_debug_freeze_enable(uint32_t can_periph)
{

    (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x00U)) |= ((uint32_t)((uint32_t)0x01U<<(16)));
    if((((uint32_t)0x40000000U) + 0x00006400U) == can_periph){
...
# 367 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_can.c"
void can_debug_freeze_disable(uint32_t can_periph)
{
...
# 385 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_can.c"
void can_time_trigger_mode_enable(uint32_t can_periph)
{
    uint8_t mailbox_number;
    ...
    for(mailbox_number = 0U; mailbox_number < 3U; mailbox_number++){
        (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x184U + ((mailbox_number) * 0x10U))) |= ((uint32_t)((uint32_t)0x01U<<(8)));
    }
}
# 404 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_can.c"
void can_time_trigger_mode_disable(uint32_t can_periph)
{
    uint8_t mailbox_number;
...
# 430 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_can.c"
uint8_t can_message_transmit(uint32_t can_periph, can_trasnmit_message_struct* transmit_message)
{
    uint8_t mailbox_number = ((uint8_t)0x00U);


    if(((uint32_t)((uint32_t)0x01U<<(26))) == ((*(volatile uint32_t *)(uint32_t)((can_periph) + 0x08U))&((uint32_t)((uint32_t)0x01U<<(26))))){
        mailbox_number = ((uint8_t)0x00U);
    }else if(((uint32_t)((uint32_t)0x01U<<(27))) == ((*(volatile uint32_t *)(uint32_t)((can_periph) + 0x08U))&((uint32_t)((uint32_t)0x01U<<(27))))){
        mailbox_number = ((uint8_t)0x01U);
    }else if(((uint32_t)((uint32_t)0x01U<<(28))) == ((*(volatile uint32_t *)(uint32_t)((can_periph) + 0x08U))&((uint32_t)((uint32_t)0x01U<<(28))))){
        mailbox_number = ((uint8_t)0x02U);
    }else{
        mailbox_number = ((uint8_t)0x03U);
    }

    if(((uint8_t)0x03U) == mailbox_number){
        return ((uint8_t)0x03U);
    }

    (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x180U + ((mailbox_number) * 0x10U))) &= ((uint32_t)((uint32_t)0x01U<<(0)));
    if(((uint32_t)0x00000000U) == transmit_message->tx_ff){

        (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x180U + ((mailbox_number) * 0x10U))) |= (uint32_t)((((0xFFFFFFFFUL << (21)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(31)))) & ((uint32_t)(transmit_message->tx_sfid) << 21)) |
                                                transmit_message->tx_ft);
    }else{

        (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x180U + ((mailbox_number) * 0x10U))) |= (uint32_t)((((0xFFFFFFFFUL << (3)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(31)))) & ((uint32_t)(transmit_message->tx_efid) << 3)) |
                                                transmit_message->tx_ff |
                                                transmit_message->tx_ft);
    }

    (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x184U + ((mailbox_number) * 0x10U))) &= ~((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3))));
    (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x184U + ((mailbox_number) * 0x10U))) |= transmit_message->tx_dlen;

    (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x188U + ((mailbox_number) * 0x10U))) = (((0xFFFFFFFFUL << (24)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(31)))) & ((uint32_t)(transmit_message->tx_data[3]) << 24)) |
                                              (((0xFFFFFFFFUL << (16)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(23)))) & ((uint32_t)(transmit_message->tx_data[2]) << 16)) |
                                              (((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(15)))) & ((uint32_t)(transmit_message->tx_data[1]) << 8)) |
                                              (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(transmit_message->tx_data[0]) << 0));
    (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x18CU + ((mailbox_number) * 0x10U))) = (((0xFFFFFFFFUL << (24)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(31)))) & ((uint32_t)(transmit_message->tx_data[7]) << 24)) |
                                              (((0xFFFFFFFFUL << (16)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(23)))) & ((uint32_t)(transmit_message->tx_data[6]) << 16)) |
                                              (((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(15)))) & ((uint32_t)(transmit_message->tx_data[5]) << 8)) |
                                              (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(transmit_message->tx_data[4]) << 0));

    (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x180U + ((mailbox_number) * 0x10U))) |= ((uint32_t)((uint32_t)0x01U<<(0)));

    return mailbox_number;
}
# 488 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_can.c"
can_transmit_state_enum can_transmit_states(uint32_t can_periph, uint8_t mailbox_number)
{
    ...
    case ((uint8_t)0x00U):
        val = (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x08U)) & (((uint32_t)((uint32_t)0x01U<<(0))) | ((uint32_t)((uint32_t)0x01U<<(1))) | ((uint32_t)((uint32_t)0x01U<<(26))));
        break;

    case ((uint8_t)0x01U):
        val = (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x08U)) & (((uint32_t)((uint32_t)0x01U<<(8))) | ((uint32_t)((uint32_t)0x01U<<(9))) | ((uint32_t)((uint32_t)0x01U<<(27))));
        break;

    case ((uint8_t)0x02U):
        val = (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x08U)) & (((uint32_t)((uint32_t)0x01U<<(16))) | ((uint32_t)((uint32_t)0x01U<<(17))) | ((uint32_t)((uint32_t)0x01U<<(28))));
        break;
    default:
    ...
    case (((uint32_t)((uint32_t)0x01U<<(0))) | ((uint32_t)((uint32_t)0x01U<<(1))) | ((uint32_t)((uint32_t)0x01U<<(26)))):
        state = CAN_TRANSMIT_OK;
        break;

    case (((uint32_t)((uint32_t)0x01U<<(8))) | ((uint32_t)((uint32_t)0x01U<<(9))) | ((uint32_t)((uint32_t)0x01U<<(27)))):
        state = CAN_TRANSMIT_OK;
        break;

    case (((uint32_t)((uint32_t)0x01U<<(16))) | ((uint32_t)((uint32_t)0x01U<<(17))) | ((uint32_t)((uint32_t)0x01U<<(28)))):
        state = CAN_TRANSMIT_OK;
        break;
...
# 547 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_can.c"
void can_transmission_stop(uint32_t can_periph, uint8_t mailbox_number)
{
    if(((uint8_t)0x00U) == mailbox_number){
        (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x08U)) |= ((uint32_t)((uint32_t)0x01U<<(7)));
        while(((uint32_t)((uint32_t)0x01U<<(7))) == ((*(volatile uint32_t *)(uint32_t)((can_periph) + 0x08U)) & ((uint32_t)((uint32_t)0x01U<<(7))))){
        }
    }else if(((uint8_t)0x01U) == mailbox_number){
        (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x08U)) |= ((uint32_t)((uint32_t)0x01U<<(15)));
        while(((uint32_t)((uint32_t)0x01U<<(15))) == ((*(volatile uint32_t *)(uint32_t)((can_periph) + 0x08U)) & ((uint32_t)((uint32_t)0x01U<<(15))))){
        }
    }else if(((uint8_t)0x02U) == mailbox_number){
        (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x08U)) |= ((uint32_t)((uint32_t)0x01U<<(23)));
        while(((uint32_t)((uint32_t)0x01U<<(23))) == ((*(volatile uint32_t *)(uint32_t)((can_periph) + 0x08U)) & ((uint32_t)((uint32_t)0x01U<<(23))))){
        }
    }else{

    }
}
# 582 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_can.c"
void can_message_receive(uint32_t can_periph, uint8_t fifo_number, can_receive_message_struct* receive_message)
{

    receive_message->rx_ff = (uint8_t)(((uint32_t)((uint32_t)0x01U<<(2))) & (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x1B0U + ((fifo_number) * 0x10U))));
    if(((uint32_t)0x00000000U) == receive_message->rx_ff){

        receive_message->rx_sfid = (uint32_t)(((((uint32_t)((*(volatile uint32_t *)(uint32_t)((can_periph) + 0x1B0U + ((fifo_number) * 0x10U))))) & ((0xFFFFFFFFUL << ((21))) & (0xFFFFFFFFUL >> (31U - (uint32_t)((31)))))) >> (21)));
    }else{

        receive_message->rx_efid = (uint32_t)(((((uint32_t)((*(volatile uint32_t *)(uint32_t)((can_periph) + 0x1B0U + ((fifo_number) * 0x10U))))) & ((0xFFFFFFFFUL << ((3))) & (0xFFFFFFFFUL >> (31U - (uint32_t)((31)))))) >> (3)));
    }


    receive_message->rx_ft = (uint8_t)(((uint32_t)((uint32_t)0x01U<<(1))) & (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x1B0U + ((fifo_number) * 0x10U))));

    receive_message->rx_fi = (uint8_t)(((((uint32_t)((*(volatile uint32_t *)(uint32_t)((can_periph) + 0x1B4U + ((fifo_number) * 0x10U))))) & ((0xFFFFFFFFUL << ((8))) & (0xFFFFFFFFUL >> (31U - (uint32_t)((15)))))) >> (8)));

    receive_message->rx_dlen = (uint8_t)(((((uint32_t)((*(volatile uint32_t *)(uint32_t)((can_periph) + 0x1B4U + ((fifo_number) * 0x10U))))) & ((0xFFFFFFFFUL << ((0))) & (0xFFFFFFFFUL >> (31U - (uint32_t)((3)))))) >> (0)));


    receive_message -> rx_data[0] = (uint8_t)(((((uint32_t)((*(volatile uint32_t *)(uint32_t)((can_periph) + 0x1B8U + ((fifo_number) * 0x10U))))) & ((0xFFFFFFFFUL << ((0))) & (0xFFFFFFFFUL >> (31U - (uint32_t)((7)))))) >> (0)));
    receive_message -> rx_data[1] = (uint8_t)(((((uint32_t)((*(volatile uint32_t *)(uint32_t)((can_periph) + 0x1B8U + ((fifo_number) * 0x10U))))) & ((0xFFFFFFFFUL << ((8))) & (0xFFFFFFFFUL >> (31U - (uint32_t)((15)))))) >> (8)));
    receive_message -> rx_data[2] = (uint8_t)(((((uint32_t)((*(volatile uint32_t *)(uint32_t)((can_periph) + 0x1B8U + ((fifo_number) * 0x10U))))) & ((0xFFFFFFFFUL << ((16))) & (0xFFFFFFFFUL >> (31U - (uint32_t)((23)))))) >> (16)));
    receive_message -> rx_data[3] = (uint8_t)(((((uint32_t)((*(volatile uint32_t *)(uint32_t)((can_periph) + 0x1B8U + ((fifo_number) * 0x10U))))) & ((0xFFFFFFFFUL << ((24))) & (0xFFFFFFFFUL >> (31U - (uint32_t)((31)))))) >> (24)));
    receive_message -> rx_data[4] = (uint8_t)(((((uint32_t)((*(volatile uint32_t *)(uint32_t)((can_periph) + 0x1BCU + ((fifo_number) * 0x10U))))) & ((0xFFFFFFFFUL << ((0))) & (0xFFFFFFFFUL >> (31U - (uint32_t)((7)))))) >> (0)));
    receive_message -> rx_data[5] = (uint8_t)(((((uint32_t)((*(volatile uint32_t *)(uint32_t)((can_periph) + 0x1BCU + ((fifo_number) * 0x10U))))) & ((0xFFFFFFFFUL << ((8))) & (0xFFFFFFFFUL >> (31U - (uint32_t)((15)))))) >> (8)));
    receive_message -> rx_data[6] = (uint8_t)(((((uint32_t)((*(volatile uint32_t *)(uint32_t)((can_periph) + 0x1BCU + ((fifo_number) * 0x10U))))) & ((0xFFFFFFFFUL << ((16))) & (0xFFFFFFFFUL >> (31U - (uint32_t)((23)))))) >> (16)));
    receive_message -> rx_data[7] = (uint8_t)(((((uint32_t)((*(volatile uint32_t *)(uint32_t)((can_periph) + 0x1BCU + ((fifo_number) * 0x10U))))) & ((0xFFFFFFFFUL << ((24))) & (0xFFFFFFFFUL >> (31U - (uint32_t)((31)))))) >> (24)));


    if(((uint8_t)0x00U) == fifo_number){
        (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x0CU)) |= ((uint32_t)((uint32_t)0x01U<<(5)));
    }else{
        (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x10U)) |= ((uint32_t)((uint32_t)0x01U<<(5)));
    }
}
# 629 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_can.c"
void can_fifo_release(uint32_t can_periph, uint8_t fifo_number)
{
    if(((uint8_t)0x00U) == fifo_number){
        (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x0CU)) |= ((uint32_t)((uint32_t)0x01U<<(5)));
    }else if(((uint8_t)0x01U) == fifo_number){
        (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x10U)) |= ((uint32_t)((uint32_t)0x01U<<(5)));
    }else{
...
# 651 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_can.c"
uint8_t can_receive_message_length_get(uint32_t can_periph, uint8_t fifo_number)
{
    uint8_t val = 0U;
    ...
    if(((uint8_t)0x00U) == fifo_number){
        ...
        val = (uint8_t)((*(volatile uint32_t *)(uint32_t)((can_periph) + 0x0CU)) & ((uint32_t)0x00000003U));
    }else if(((uint8_t)0x01U) == fifo_number){

        val = (uint8_t)((*(volatile uint32_t *)(uint32_t)((can_periph) + 0x10U)) & ((uint32_t)0x00000003U));
    }else{

    }
    return val;
}
# 679 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_can.c"
ErrStatus can_working_mode_set(uint32_t can_periph, uint8_t working_mode)
{
    ErrStatus flag = ERROR;
    ...
    if(((uint8_t)0x01U) == working_mode){

        (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x00U)) &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(1))));

        (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x00U)) |= (uint8_t)((uint32_t)((uint32_t)0x01U<<(0)));
    ...
    }else if(((uint8_t)0x02U) == working_mode){

        (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x00U)) &= ~(uint32_t)(((uint32_t)((uint32_t)0x01U<<(1))) | ((uint32_t)((uint32_t)0x01U<<(0))));

        while((0U != ((*(volatile uint32_t *)(uint32_t)((can_periph) + 0x04U)) & (((uint32_t)((uint32_t)0x01U<<(0))) | ((uint32_t)((uint32_t)0x01U<<(1)))))) && (0U != timeout)){
            timeout--;
        }
        if(0U != ((*(volatile uint32_t *)(uint32_t)((can_periph) + 0x04U)) & (((uint32_t)((uint32_t)0x01U<<(0))) | ((uint32_t)((uint32_t)0x01U<<(1)))))){
            flag = ERROR;
        }else{
            flag = SUCCESS;
        }
    }else if(((uint8_t)0x04U) == working_mode){

        (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x00U)) &= (~(uint32_t)((uint32_t)((uint32_t)0x01U<<(0))));

        (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x00U)) |= (uint8_t)((uint32_t)((uint32_t)0x01U<<(1)));

        while((((uint32_t)((uint32_t)0x01U<<(1))) != ((*(volatile uint32_t *)(uint32_t)((can_periph) + 0x04U)) & ((uint32_t)((uint32_t)0x01U<<(1))))) && (0U != timeout)){
            timeout--;
        }
        if(((uint32_t)((uint32_t)0x01U<<(1))) != ((*(volatile uint32_t *)(uint32_t)((can_periph) + 0x04U)) & ((uint32_t)((uint32_t)0x01U<<(1))))){
            flag = ERROR;
        }else{
            flag = SUCCESS;
        }
...
# 738 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_can.c"
ErrStatus can_wakeup(uint32_t can_periph)
{
    ErrStatus flag = ERROR;
    uint32_t timeout = ((uint32_t)0x0000FFFFU);
    ...
    while((0U != ((*(volatile uint32_t *)(uint32_t)((can_periph) + 0x04U)) & ((uint32_t)((uint32_t)0x01U<<(1))))) && (0x00U != timeout)){
        timeout--;
    }

    if(0U != ((*(volatile uint32_t *)(uint32_t)((can_periph) + 0x04U)) & ((uint32_t)((uint32_t)0x01U<<(1))))){
        flag = ERROR;
    }else{
        flag = SUCCESS;
    }
...
# 773 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_can.c"
can_error_enum can_error_get(uint32_t can_periph)
{
    ...
    error = (can_error_enum)(((((uint32_t)((*(volatile uint32_t *)(uint32_t)((can_periph) + 0x18U)))) & ((0xFFFFFFFFUL << ((4))) & (0xFFFFFFFFUL >> (31U - (uint32_t)((6)))))) >> (4)));
    return error;
}
# 790 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_can.c"
uint8_t can_receive_error_number_get(uint32_t can_periph)
{
    uint8_t val;


    val = (uint8_t)(((((uint32_t)((*(volatile uint32_t *)(uint32_t)((can_periph) + 0x18U)))) & ((0xFFFFFFFFUL << ((24))) & (0xFFFFFFFFUL >> (31U - (uint32_t)((31)))))) >> (24)));
    return val;
}
# 806 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_can.c"
uint8_t can_transmit_error_number_get(uint32_t can_periph)
{
    uint8_t val;

    val = (uint8_t)(((((uint32_t)((*(volatile uint32_t *)(uint32_t)((can_periph) + 0x18U)))) & ((0xFFFFFFFFUL << ((16))) & (0xFFFFFFFFUL >> (31U - (uint32_t)((23)))))) >> (16)));
    return val;
}
# 837 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_can.c"
void can_interrupt_enable(uint32_t can_periph, uint32_t interrupt)
{
    (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x14U)) |= interrupt;
}
# 865 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_can.c"
void can_interrupt_disable(uint32_t can_periph, uint32_t interrupt)
{
    (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x14U)) &= ~interrupt;
}
# 892 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_can.c"
FlagStatus can_flag_get(uint32_t can_periph, can_flag_enum flag)
{

    if(RESET != (((*(volatile uint32_t *)(uint32_t)((can_periph) + ((uint32_t)(flag) >> 6)))) & ((uint32_t)((uint32_t)0x01U<<(((uint32_t)(flag) & 0x1FU)))))){
        return SET;
    }else{
        return RESET;
    }
}
# 924 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_can.c"
void can_flag_clear(uint32_t can_periph, can_flag_enum flag)
{
    ((*(volatile uint32_t *)(uint32_t)((can_periph) + ((uint32_t)(flag) >> 6)))) = ((uint32_t)((uint32_t)0x01U<<(((uint32_t)(flag) & 0x1FU))));
}
# 948 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_can.c"
FlagStatus can_interrupt_flag_get(uint32_t can_periph, can_interrupt_flag_enum flag)
{
 ...
 uint32_t ret2 = RESET;
    ...
    ret1 = ((*(volatile uint32_t *)(uint32_t)((can_periph) + ((uint32_t)(flag) >> 12)))) & ((uint32_t)((uint32_t)0x01U<<((((uint32_t)(flag) >> 6) & 0x1FU))));

    ret2 = (*(volatile uint32_t *)(uint32_t)((can_periph) + 0x14U)) & ((uint32_t)((uint32_t)0x01U<<(((uint32_t)(flag) & 0x1FU))));
    if(ret1 && ret2){
        return SET;
    }else{
        return RESET;
...
# 986 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_can.c"
void can_interrupt_flag_clear(uint32_t can_periph, can_interrupt_flag_enum flag)
{
    ((*(volatile uint32_t *)(uint32_t)((can_periph) + ((uint32_t)(flag) >> 12)))) = ((uint32_t)((uint32_t)0x01U<<((((uint32_t)(flag) >> 6) & 0x1FU))));
}
