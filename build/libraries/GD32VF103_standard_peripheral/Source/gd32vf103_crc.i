# 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_crc.c"
...
# 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_crc.c"
# 35 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_crc.c"
...
# 40 "libraries/GD32VF103_standard_peripheral/Include/gd32vf103_crc.h" 2
...
# 36 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_crc.c" 2
...
void crc_deinit(void)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x0000B000U) + 0x00U)) = ((uint32_t)0xFFFFFFFFU);
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x0000B000U) + 0x04U)) = ((uint32_t)0x00000000U);
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x0000B000U) + 0x08U)) = (uint32_t)((uint32_t)((uint32_t)0x01U<<(0)));
}
...
{
    uint32_t data;
    data = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x0000B000U) + 0x00U));
    return (data);
}
...
{
    uint8_t fdata;
    fdata = (uint8_t)(*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x0000B000U) + 0x04U));
    return (fdata);
}
...
void crc_free_data_register_write(uint8_t free_data)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x0000B000U) + 0x04U)) = (uint32_t)free_data;
}
...
uint32_t crc_single_data_calculate(uint32_t sdata)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x0000B000U) + 0x00U)) = sdata;
    return ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x0000B000U) + 0x00U)));
}
# 120 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_crc.c"
uint32_t crc_block_data_calculate(uint32_t array[], uint32_t size)
{
    uint32_t index;
    for(index = 0U; index < size; index++){
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x0000B000U) + 0x00U)) = array[index];
    }
    return ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x0000B000U) + 0x00U)));
}
