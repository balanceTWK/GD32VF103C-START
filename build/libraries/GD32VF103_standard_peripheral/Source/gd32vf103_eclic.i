# 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_eclic.c"
...
# 1 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_eclic.c"
# 35 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_eclic.c"
...
# 39 "libraries/GD32VF103_standard_peripheral/Include/gd32vf103_eclic.h" 2
...
# 36 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_eclic.c" 2
...
# 37 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_eclic.c" 2

#define REG_DBGMCU2 ((uint32_t)0xE0042008)
#define REG_DBGMCU2EN ((uint32_t)0xE004200C)
# 52 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_eclic.c"
void eclic_priority_group_set(uint32_t prigroup) {
    eclic_set_nlbits(prigroup);
}
# 64 "libraries/GD32VF103_standard_peripheral/Source/gd32vf103_eclic.c"
void eclic_irq_enable(uint32_t source, uint8_t level, uint8_t priority) {
...
void eclic_system_reset(void) {
    (*(volatile uint32_t *)(uint32_t)(((uint32_t)0xE004200C))) = 0x4b5a6978;
    (*(volatile uint32_t *)(uint32_t)(((uint32_t)0xE0042008))) = 0x1;
}
...
void eclic_send_event(void) {
    ({ unsigned long __tmp; if (__builtin_constant_p(0x1) && (unsigned long)(0x1) < 32) asm volatile ("csrrs %0, " "0x812" ", %1" : "=r"(__tmp) : "i"(0x1)); else asm volatile ("csrrs %0, " "0x812" ", %1" : "=r"(__tmp) : "r"(0x1)); __tmp; });
}
