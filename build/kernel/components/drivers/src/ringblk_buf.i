...
# 1 "rt-thread/components/drivers/src/ringblk_buf.c"
# 11 "rt-thread/components/drivers/src/ringblk_buf.c"
...
# 12 "rt-thread/components/drivers/src/ringblk_buf.c" 2
...
# 14 "rt-thread/components/drivers/src/ringblk_buf.c" 2
# 26 "rt-thread/components/drivers/src/ringblk_buf.c"
void rt_rbb_init(rt_rbb_t rbb, rt_uint8_t *buf, rt_size_t buf_size, rt_rbb_blk_t block_set, rt_size_t blk_max_num)
{
    rt_size_t i;
...
;
# 56 "rt-thread/components/drivers/src/ringblk_buf.c"
rt_rbb_t rt_rbb_create(rt_size_t buf_size, rt_size_t blk_max_num)
{
    rt_rbb_t rbb = 
# 58 "rt-thread/components/drivers/src/ringblk_buf.c" 3 4
                  ((void *)0)
# 58 "rt-thread/components/drivers/src/ringblk_buf.c"
                      ;
    rt_uint8_t *buf;
    rt_rbb_blk_t blk_set;
    ...
    {
        return 
# 65 "rt-thread/components/drivers/src/ringblk_buf.c" 3 4
              ((void *)0)
# 65 "rt-thread/components/drivers/src/ringblk_buf.c"
                  ;
    }
    ...
    if (!buf)
    {
        rt_free(rbb);
        return 
# 72 "rt-thread/components/drivers/src/ringblk_buf.c" 3 4
              ((void *)0)
# 72 "rt-thread/components/drivers/src/ringblk_buf.c"
    ...
    if (!blk_set)
    {
        ...
        rt_free(rbb);
        return 
# 80 "rt-thread/components/drivers/src/ringblk_buf.c" 3 4
              ((void *)0)
...
static rt_rbb_blk_t find_empty_blk_in_set(rt_rbb_t rbb)
{
    ...
    return 
# 119 "rt-thread/components/drivers/src/ringblk_buf.c" 3 4
          ((void *)0)
# 119 "rt-thread/components/drivers/src/ringblk_buf.c"
              ;
}
# 133 "rt-thread/components/drivers/src/ringblk_buf.c"
rt_rbb_blk_t rt_rbb_blk_alloc(rt_rbb_t rbb, rt_size_t blk_size)
{
    rt_base_t level;
    rt_size_t empty1 = 0, empty2 = 0;
    rt_rbb_blk_t head, tail, new_rbb = 
# 137 "rt-thread/components/drivers/src/ringblk_buf.c" 3 4
                                      ((void *)0)
# 137 "rt-thread/components/drivers/src/ringblk_buf.c"
                                          ;
        ...
        if (rt_slist_len(&rbb->blk_list) > 0)
        {
            ...
            if (head->buf <= tail->buf)
            {
                ...
                else
                {
                    ...
                    new_rbb = 
# 181 "rt-thread/components/drivers/src/ringblk_buf.c" 3 4
                             ((void *)0)
# 181 "rt-thread/components/drivers/src/ringblk_buf.c"
            ...
            else
            {
                ...
                else
                {
                    ...
                    new_rbb = 
# 205 "rt-thread/components/drivers/src/ringblk_buf.c" 3 4
                             ((void *)0)
# 205 "rt-thread/components/drivers/src/ringblk_buf.c"
    ...
    {
        new_rbb = 
# 220 "rt-thread/components/drivers/src/ringblk_buf.c" 3 4
                 ((void *)0)
...
;
# 251 "rt-thread/components/drivers/src/ringblk_buf.c"
rt_rbb_blk_t rt_rbb_blk_get(rt_rbb_t rbb)
{
    rt_base_t level;
    rt_rbb_blk_t block = 
# 254 "rt-thread/components/drivers/src/ringblk_buf.c" 3 4
                        ((void *)0)
# 254 "rt-thread/components/drivers/src/ringblk_buf.c"
                            ;
    rt_slist_t *node;
    ...
    block = 
# 274 "rt-thread/components/drivers/src/ringblk_buf.c" 3 4
           ((void *)0)
# 274 "rt-thread/components/drivers/src/ringblk_buf.c"
               ;
...
;
# 291 "rt-thread/components/drivers/src/ringblk_buf.c"
rt_size_t rt_rbb_blk_size(rt_rbb_blk_t block)
{
...
;
# 306 "rt-thread/components/drivers/src/ringblk_buf.c"
rt_uint8_t *rt_rbb_blk_buf(rt_rbb_blk_t block)
{
...
;
# 362 "rt-thread/components/drivers/src/ringblk_buf.c"
rt_size_t rt_rbb_blk_queue_get(rt_rbb_t rbb, rt_size_t queue_data_len, rt_rbb_blk_queue_t blk_queue)
{
    rt_base_t level;
...
# 367 "rt-thread/components/drivers/src/ringblk_buf.c" 3 4
                             ((void *)0)
    ...
    for (node = rt_slist_first(&rbb->blk_list); node; node = rt_slist_next(node))
    {
        if (!last_block)
        {
            ...
            else
            {
                ...
                last_block = 
# 391 "rt-thread/components/drivers/src/ringblk_buf.c" 3 4
                            ((void *)0)
# 391 "rt-thread/components/drivers/src/ringblk_buf.c"
                                ;
                continue;
            }
        }
...
;
# 433 "rt-thread/components/drivers/src/ringblk_buf.c"
rt_size_t rt_rbb_blk_queue_len(rt_rbb_blk_queue_t blk_queue)
{
...
;
# 455 "rt-thread/components/drivers/src/ringblk_buf.c"
rt_uint8_t *rt_rbb_blk_queue_buf(rt_rbb_blk_queue_t blk_queue)
{
...
;
# 491 "rt-thread/components/drivers/src/ringblk_buf.c"
rt_size_t rt_rbb_next_blk_queue_len(rt_rbb_t rbb)
{
    rt_base_t level;
    ...
    rt_slist_t *node;
    rt_rbb_blk_t last_block = 
# 496 "rt-thread/components/drivers/src/ringblk_buf.c" 3 4
                             ((void *)0)
    ...
    for (node = rt_slist_first(&rbb->blk_list); node; node = rt_slist_next(node))
    {
        if (!last_block)
        {
            ...
            if (last_block->status != RT_RBB_BLK_PUT)
            {
                ...
                last_block = 
# 513 "rt-thread/components/drivers/src/ringblk_buf.c" 3 4
                            ((void *)0)
# 513 "rt-thread/components/drivers/src/ringblk_buf.c"
                                ;
                continue;
            }
        }
...
;
# 548 "rt-thread/components/drivers/src/ringblk_buf.c"
rt_size_t rt_rbb_get_buf_size(rt_rbb_t rbb)
{
