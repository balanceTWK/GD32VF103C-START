...
# 1 "rt-thread/components/drivers/src/pipe.c"
# 11 "rt-thread/components/drivers/src/pipe.c"
...
# 12 "rt-thread/components/drivers/src/pipe.c" 2
...
# 13 "rt-thread/components/drivers/src/pipe.c" 2
...
# 14 "rt-thread/components/drivers/src/pipe.c" 2
# 315 "rt-thread/components/drivers/src/pipe.c"
...
rt_size_t rt_pipe_read (rt_device_t device, rt_off_t pos, void *buffer, rt_size_t count)
{
    ...
    {
        rt_set_errno(-
# 358 "rt-thread/components/drivers/src/pipe.c" 3
                     22
# 358 "rt-thread/components/drivers/src/pipe.c"
                           );
        return 0;
    }
    if (count == 0) return 0;
...
rt_size_t rt_pipe_write (rt_device_t device, rt_off_t pos, const void *buffer, rt_size_t count)
{
    ...
    {
        rt_set_errno(-
# 386 "rt-thread/components/drivers/src/pipe.c" 3
                     22
# 386 "rt-thread/components/drivers/src/pipe.c"
                           );
        return 0;
    }
    if (count == 0) return 0;
...
# 423 "rt-thread/components/drivers/src/pipe.c"
rt_pipe_t *rt_pipe_create(const char *name, int bufsz)
{
    rt_pipe_t *pipe;
    rt_device_t dev;
    ...
    if (!(bufsz < 0xFFFF)) { rt_assert_handler("bufsz < 0xFFFF", __FUNCTION__, 437); };
    pipe->bufsz = bufsz;
...
int rt_pipe_delete(const char *name)
{
    ...
    if (device)
    {
        ...
        {
            result = -
# 500 "rt-thread/components/drivers/src/pipe.c" 3
                     19
# 500 "rt-thread/components/drivers/src/pipe.c"
    ...
    {
        result = -
# 505 "rt-thread/components/drivers/src/pipe.c" 3
                 19
