...
rt_data_queue_init:
.LFB19:
	.file 2 "rt-thread/components/drivers/src/dataqueue.c"
	.loc 2 27 1
	.cfi_startproc
	addi	sp,sp,-32
	.cfi_def_cfa_offset 32
...
.LFB20:
	...
	lw	a5,-36(s0)
	bnez	a5,.L10
	.loc 2 60 28 discriminator 1
	li	a2,60
	lla	a1,__FUNCTION__.3419
	lla	a0,.LC0
	call	rt_assert_handler
.L10:
	.loc 2 62 12
...
.LBB2:
	...
	.loc 2 77 69
	beqz	a5,.L14
	.loc 2 77 102 discriminator 1
	lla	a1,__FUNCTION__.3419
	lla	a0,.LC1
	call	rt_kprintf
	.loc 2 77 183 discriminator 1
	li	a2,77
	lla	a1,__FUNCTION__.3419
	lla	a0,.LC2
	call	rt_assert_handler
.L14:
	.loc 2 77 229 discriminator 5
	lw	a0,-32(s0)
	call	rt_hw_interrupt_enable
.LBE2:
	.loc 2 80 23 discriminator 5
	lw	a5,-28(s0)
	sw	zero,48(a5)
	.loc 2 83 9 discriminator 5
	lw	a0,-28(s0)
	call	rt_thread_suspend
	.loc 2 84 9 discriminator 5
	lw	a5,-36(s0)
	addi	a4,a5,16
	lw	a5,-28(s0)
	addi	a5,a5,20
	...
	.loc 2 86 21 discriminator 5
	lw	a5,-48(s0)
	.loc 2 86 12 discriminator 5
	blez	a5,.L15
	.loc 2 89 13
	lw	a5,-28(s0)
	addi	a5,a5,76
...
.LFB21:
	...
	lw	a5,-36(s0)
	bnez	a5,.L22
	.loc 2 149 28 discriminator 1
	li	a2,149
	lla	a1,__FUNCTION__.3434
	lla	a0,.LC0
	call	rt_assert_handler
.L22:
	.loc 2 150 8
...
.LBB3:
	...
	.loc 2 167 69
	beqz	a5,.L28
	.loc 2 167 102 discriminator 1
	lla	a1,__FUNCTION__.3434
	lla	a0,.LC1
	call	rt_kprintf
	.loc 2 167 183 discriminator 1
	li	a2,167
	lla	a1,__FUNCTION__.3434
	lla	a0,.LC2
	call	rt_assert_handler
.L28:
	.loc 2 167 230 discriminator 5
	lw	a0,-32(s0)
	call	rt_hw_interrupt_enable
.LBE3:
	.loc 2 170 23 discriminator 5
	lw	a5,-28(s0)
	sw	zero,48(a5)
	.loc 2 173 9 discriminator 5
	lw	a0,-28(s0)
	call	rt_thread_suspend
	.loc 2 174 9 discriminator 5
	lw	a5,-36(s0)
	addi	a4,a5,24
	lw	a5,-28(s0)
	addi	a5,a5,20
	...
	mv	a0,a4
	call	rt_list_insert_before
	.loc 2 176 21 discriminator 5
	lw	a5,-48(s0)
	.loc 2 176 12 discriminator 5
	blez	a5,.L29
	.loc 2 179 13
	lw	a5,-28(s0)
	addi	a5,a5,76
...
.L27:
	...
	lw	a5,-24(s0)
	bnez	a5,.L35
	.loc 2 233 32 discriminator 1
	lw	a5,-36(s0)
	lw	a5,32(a5)
	.loc 2 233 23 discriminator 1
	beqz	a5,.L35
	.loc 2 235 14
	lw	a5,-36(s0)
	lw	a5,32(a5)
...
.LFB22:
	...
	lw	a5,-36(s0)
	bnez	a5,.L39
	.loc 2 248 28 discriminator 1
	li	a2,248
	lla	a1,__FUNCTION__.3446
	lla	a0,.LC0
	call	rt_assert_handler
.L39:
	.loc 2 250 13
...
.LFE23:
	...
	.size	__FUNCTION__.3409, 19
__FUNCTION__.3409:
	.string	"rt_data_queue_init"
	.align	2
	.type	__FUNCTION__.3419, @object
	.size	__FUNCTION__.3419, 19
__FUNCTION__.3419:
	.string	"rt_data_queue_push"
	.align	2
	.type	__FUNCTION__.3434, @object
	.size	__FUNCTION__.3434, 18
__FUNCTION__.3434:
	.string	"rt_data_queue_pop"
	.align	2
	.type	__FUNCTION__.3446, @object
	.size	__FUNCTION__.3446, 19
__FUNCTION__.3446:
...
.Letext0:
	...
	.file 12 "rt-thread/components/drivers/include/ipc/dataqueue.h"
...
.Ldebug_macro0:
	...
	.byte	0xd
	.4byte	.LASF1501
	.file 57 "rt-thread/components/drivers/include/ipc/ringbuffer.h"
	.byte	0x3
	.byte	0x11
	.byte	0x39
	.byte	0x7
	...
	.byte	0x4
	.file 58 "rt-thread/components/drivers/include/ipc/completion.h"
	.byte	0x3
	.byte	0x12
	.byte	0x3a
	.byte	0x5
	...
	.byte	0x4
	.byte	0x4
	.file 65 "rt-thread/include/rthw.h"
	.byte	0x3
	.byte	0xe
	.byte	0x41
	.byte	0x7
...
.LASF1777:
	.string	"rt-thread/components/drivers/src/dataqueue.c"
.LASF1127:
