...
# 1 "rt-thread/components/finsh/cmd.c"
# 34 "rt-thread/components/finsh/cmd.c"
...
# 35 "rt-thread/components/finsh/cmd.c" 2
...
# 40 "rt-thread/components/finsh/cmd.c" 2
        ...
        next = list_get_next(next, &find_arg);
        {
            ...
            for (i = 0; i < find_arg.nr_out; i++)
            {
                ...
                thread = (struct rt_thread*)obj;
                {
                    rt_uint8_t stat;
                    rt_uint8_t *ptr;
# 210 "rt-thread/components/finsh/cmd.c"
...
# 230 "rt-thread/components/finsh/cmd.c"
...
# 653 "rt-thread/components/finsh/cmd.c"
