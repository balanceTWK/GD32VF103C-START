...
# 17 "rt-thread/components/finsh/msh.c" 2
...
# 18 "rt-thread/components/finsh/msh.c" 2
...
# 19 "rt-thread/components/finsh/msh.c" 2
...
# 68 "rt-thread/components/finsh/msh.c"
...
static int _msh_exec_cmd(char *cmd, rt_size_t length, int *retp)
{
    ...
    if (!(cmd)) { rt_assert_handler("cmd", __FUNCTION__, 279); };
    if (!(retp)) { rt_assert_handler("retp", __FUNCTION__, 280); };
...
# 341 "rt-thread/components/finsh/msh.c"
int msh_exec(char *cmd, rt_size_t length)
{
    int cmd_ret;
...
# 387 "rt-thread/components/finsh/msh.c"
    {
        char *tcmd;
        tcmd = cmd;
        while (*tcmd != ' ' && *tcmd != '\0')
...
# 580 "rt-thread/components/finsh/msh.c"
    ...
    if (name_ptr != 
# 607 "rt-thread/components/finsh/msh.c" 3 4
                   ((void *)0)
