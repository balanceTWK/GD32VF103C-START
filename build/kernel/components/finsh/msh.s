...
.L12:
	...
	lw	a5,-20(s0)
	lbu	a4,0(a5)
	.loc 1 105 29 discriminator 2
	li	a5,9
	bne	a4,a5,.L14
.L13:
	.loc 1 105 46 discriminator 3
	lw	a4,-24(s0)
	lw	a5,-40(s0)
	bltu	a4,a5,.L15
.L14:
	...
	j	.L17
.L18:
	.loc 1 116 39 discriminator 3
	lw	a5,-32(s0)
	slli	a5,a5,2
	lw	a4,-44(s0)
	add	a5,a4,a5
	.loc 1 116 17 discriminator 3
	lw	a5,0(a5)
	mv	a1,a5
	lla	a0,.LC5
	call	rt_kprintf
	.loc 1 114 35 discriminator 3
	lw	a5,-32(s0)
	addi	a5,a5,1
	sw	a5,-32(s0)
.L17:
...
.L27:
	...
	li	a5,32
	beq	a4,a5,.L28
	.loc 1 151 36 discriminator 1
	lw	a5,-20(s0)
	lbu	a4,0(a5)
	.loc 1 151 33 discriminator 1
	li	a5,9
	beq	a4,a5,.L28
	.loc 1 151 50 discriminator 2
	lw	a4,-24(s0)
	lw	a5,-40(s0)
	bltu	a4,a5,.L29
.L28:
...
.LFB23:
	...
	lw	a5,-84(s0)
	bnez	a5,.L44
	.loc 1 279 19 discriminator 1
	li	a2,279
	lla	a1,__FUNCTION__.4649
	lla	a0,.LC6
...
.L65:
	...
	lw	a5,-20(s0)
	lbu	a4,0(a5)
	.loc 1 404 52 discriminator 2
	lw	a5,-40(s0)
	lbu	a5,0(a5)
	.loc 1 404 40 discriminator 2
	beq	a4,a5,.L67
.L66:
	.loc 1 410 17
	lw	a4,-20(s0)
...
.L74:
	...
	sw	a5,-28(s0)
.L72:
	.loc 1 581 50 discriminator 1
	lla	a5,_syscall_table_end
	lw	a5,0(a5)
	.loc 1 581 9 discriminator 1
	lw	a4,-28(s0)
	bltu	a4,a5,.L77
	.loc 1 607 8
	lw	a5,-24(s0)
...
.Ldebug_macro0:
	...
	.byte	0x4
	.byte	0x4
	.file 58 "rt-thread/components/finsh/msh.h"
	.byte	0x3
	.byte	0x10
	.byte	0x3a
	.byte	0x5
	...
	.byte	0x4
	.file 68 "rt-thread/components/finsh/shell.h"
	.byte	0x3
	.byte	0x12
	.byte	0x44
	.byte	0x5
