...
# 11 "rt-thread/components/finsh/finsh.h"
#define __FINSH_H__ 


# 1 "rt-thread/components/finsh/finsh_api.h" 1
# 15 "rt-thread/components/finsh/finsh.h" 2
...
# 52 "rt-thread/components/finsh/finsh.h"
...
# 63 "/home/tang/toolchains/riscv-none-gcc/8.2.0-2.2-20190521-0004/riscv-none-embed/include/stdio.h" 3




# 66 "/home/tang/toolchains/riscv-none-gcc/8.2.0-2.2-20190521-0004/riscv-none-embed/include/stdio.h" 3
typedef __FILE FILE;
...
# 53 "rt-thread/components/finsh/finsh.h" 2
# 1 "/home/tang/toolchains/riscv-none-gcc/8.2.0-2.2-20190521-0004/riscv-none-embed/include/ctype.h" 1 3

#define _CTYPE_H_ 
# 11 "/home/tang/toolchains/riscv-none-gcc/8.2.0-2.2-20190521-0004/riscv-none-embed/include/ctype.h" 3
...
# 82 "/home/tang/toolchains/riscv-none-gcc/8.2.0-2.2-20190521-0004/riscv-none-embed/include/ctype.h" 3
...
# 165 "/home/tang/toolchains/riscv-none-gcc/8.2.0-2.2-20190521-0004/riscv-none-embed/include/ctype.h" 3
extern const char _ctype_[];


# 54 "rt-thread/components/finsh/finsh.h" 2
...
# 55 "rt-thread/components/finsh/finsh.h" 2
...
# 56 "rt-thread/components/finsh/finsh.h" 2
...
# 57 "rt-thread/components/finsh/finsh.h" 2
...
# 83 "rt-thread/components/finsh/finsh.h"
...
# 237 "rt-thread/components/finsh/finsh.h"
void finsh_syscall_append(const char* name, syscall_func func);
# 247 "rt-thread/components/finsh/finsh.h"
void finsh_sysvar_append(const char* name, uint8_t type, void* addr);
# 26 "rt-thread/components/finsh/shell.c" 2
...
# 27 "rt-thread/components/finsh/shell.c" 2
...
# 30 "rt-thread/components/finsh/shell.c" 2
# 44 "rt-thread/components/finsh/shell.c"
struct finsh_shell *shell;
static char *finsh_prompt_custom = (0);
# 70 "rt-thread/components/finsh/shell.c"
int finsh_set_prompt(const char * prompt)
{
...
rt_uint32_t finsh_get_prompt_mode(void)
{
    if (!(shell != (0))) { rt_assert_handler("shell != RT_NULL", __FUNCTION__, 140); };
    return shell->prompt_mode;
}
# 153 "rt-thread/components/finsh/shell.c"
void finsh_set_prompt_mode(rt_uint32_t prompt_mode)
{
    if (!(shell != (0))) { rt_assert_handler("shell != RT_NULL", __FUNCTION__, 155); };
...
static int finsh_getchar(void)
{
    ...
    if (!(shell != (0))) { rt_assert_handler("shell != RT_NULL", __FUNCTION__, 166); };
...
{
    if (!(shell != (0))) { rt_assert_handler("shell != RT_NULL", __FUNCTION__, 177); };
...
# 192 "rt-thread/components/finsh/shell.c"
void finsh_set_device(const char *device_name)
{
    rt_device_t dev = (0);

    if (!(shell != (0))) { rt_assert_handler("shell != RT_NULL", __FUNCTION__, 196); };
...
{
    if (!(shell != (0))) { rt_assert_handler("shell != RT_NULL", __FUNCTION__, 235); };
    return shell->device->parent.name;
}
# 249 "rt-thread/components/finsh/shell.c"
void finsh_set_echo(rt_uint32_t echo)
{
    if (!(shell != (0))) { rt_assert_handler("shell != RT_NULL", __FUNCTION__, 251); };
    shell->echo_mode = (rt_uint8_t)echo;
}
# 262 "rt-thread/components/finsh/shell.c"
...
# 360 "rt-thread/components/finsh/shell.c"
...
# 428 "rt-thread/components/finsh/shell.c"
...
void finsh_thread_entry(void *parameter)
{
    ...
    shell->echo_mode = 1;
# 504 "rt-thread/components/finsh/shell.c"
    if (shell->device == (0))
    {
...
# 527 "rt-thread/components/finsh/shell.c"
...
# 544 "rt-thread/components/finsh/shell.c"
        if (ch == 0x1b)
        {
...
# 801 "rt-thread/components/finsh/shell.c"
int finsh_system_init(void)
{
    rt_err_t result = 0;
    rt_thread_t tid;
# 823 "rt-thread/components/finsh/shell.c"
...
# 855 "rt-thread/components/finsh/shell.c"
    ...
    tid = rt_thread_create("tshell",
                           ...
                           4096, 20, 10);
# 874 "rt-thread/components/finsh/shell.c"
    rt_sem_init(&(shell->rx_sem), "shrx", 0, 0);
    finsh_set_prompt_mode(1);

    if (tid != 
# 877 "rt-thread/components/finsh/shell.c" 3 4
              ((void *)0) 
# 877 "rt-thread/components/finsh/shell.c"
                   && result == 0)
