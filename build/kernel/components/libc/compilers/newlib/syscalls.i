...
# 1 "rt-thread/components/libc/compilers/newlib/syscalls.c"
# 9 "rt-thread/components/libc/compilers/newlib/syscalls.c"
# 1 "/home/tang/toolchains/riscv-none-gcc/8.2.0-2.2-20190521-0004/riscv-none-embed/include/reent.h" 1 3
# 91 "/home/tang/toolchains/riscv-none-gcc/8.2.0-2.2-20190521-0004/riscv-none-embed/include/reent.h" 3
#define _REENT_H_ 
...
# 149 "/home/tang/toolchains/riscv-none-gcc/8.2.0-2.2-20190521-0004/lib/gcc/riscv-none-embed/8.2.0/include/stddef.h" 3 4
...
#undef __EXP
# 8 "/home/tang/toolchains/riscv-none-gcc/8.2.0-2.2-20190521-0004/riscv-none-embed/include/machine/_types.h" 2 3
...
# 94 "/home/tang/toolchains/riscv-none-gcc/8.2.0-2.2-20190521-0004/riscv-none-embed/include/reent.h" 2 3
...
#define offsetof(TYPE,MEMBER) __builtin_offsetof (TYPE, MEMBER)
# 99 "/home/tang/toolchains/riscv-none-gcc/8.2.0-2.2-20190521-0004/riscv-none-embed/include/reent.h" 2 3
...
struct timeval;
struct timezone;
# 139 "/home/tang/toolchains/riscv-none-gcc/8.2.0-2.2-20190521-0004/riscv-none-embed/include/reent.h" 3
...
# 10 "rt-thread/components/libc/compilers/newlib/syscalls.c" 2
...
# 11 "rt-thread/components/libc/compilers/newlib/syscalls.c" 2
...
# 42 "/home/tang/toolchains/riscv-none-gcc/8.2.0-2.2-20190521-0004/riscv-none-embed/include/sys/time.h" 2 3
...
# 43 "/home/tang/toolchains/riscv-none-gcc/8.2.0-2.2-20190521-0004/riscv-none-embed/include/sys/time.h" 2 3
...
# 44 "/home/tang/toolchains/riscv-none-gcc/8.2.0-2.2-20190521-0004/riscv-none-embed/include/sys/time.h" 2 3
...
# 269 "/home/tang/toolchains/riscv-none-gcc/8.2.0-2.2-20190521-0004/riscv-none-embed/include/sys/time.h" 2 3
...
# 12 "rt-thread/components/libc/compilers/newlib/syscalls.c" 2
...
# 13 "rt-thread/components/libc/compilers/newlib/syscalls.c" 2
...
# 31 "rt-thread/components/libc/compilers/newlib/syscalls.c"
int *
__errno ()
{
  return _rt_errno();
...
_execve_r(struct _reent *ptr, const char * name, char *const *argv, char *const *env)
{
    ...
    ptr->_errno = 
# 52 "rt-thread/components/libc/compilers/newlib/syscalls.c" 3
                 134
# 52 "rt-thread/components/libc/compilers/newlib/syscalls.c"
                        ;
    return -1;
}
...
_fcntl_r(struct _reent *ptr, int fd, int cmd, int arg)
{
    ...
    ptr->_errno = 
# 60 "rt-thread/components/libc/compilers/newlib/syscalls.c" 3
                 134
# 60 "rt-thread/components/libc/compilers/newlib/syscalls.c"
                        ;
    return -1;
}
...
_fstat_r(struct _reent *ptr, int fd, struct stat *pstat)
{
    ...
    ptr->_errno = 
# 76 "rt-thread/components/libc/compilers/newlib/syscalls.c" 3
                 134
# 76 "rt-thread/components/libc/compilers/newlib/syscalls.c"
                        ;
    return -1;
}
...
_isatty_r(struct _reent *ptr, int fd)
{
    ...
    ptr->_errno = 
# 92 "rt-thread/components/libc/compilers/newlib/syscalls.c" 3
                 134
# 92 "rt-thread/components/libc/compilers/newlib/syscalls.c"
                        ;
    return -1;
}
...
_kill_r(struct _reent *ptr, int pid, int sig)
{
    ...
    ptr->_errno = 
# 100 "rt-thread/components/libc/compilers/newlib/syscalls.c" 3
                 134
# 100 "rt-thread/components/libc/compilers/newlib/syscalls.c"
                        ;
    return -1;
}
...
_link_r(struct _reent *ptr, const char *old, const char *new)
{
    ...
    ptr->_errno = 
# 108 "rt-thread/components/libc/compilers/newlib/syscalls.c" 3
                 134
# 108 "rt-thread/components/libc/compilers/newlib/syscalls.c"
                        ;
    return -1;
}
...
# 197 "rt-thread/components/libc/compilers/newlib/syscalls.c" 3
unsigned long

# 198 "rt-thread/components/libc/compilers/newlib/syscalls.c"
_times_r(struct _reent *ptr, struct tms *ptms)
{

    ptr->_errno = 
# 201 "rt-thread/components/libc/compilers/newlib/syscalls.c" 3
                 134
# 201 "rt-thread/components/libc/compilers/newlib/syscalls.c"
                        ;
    return -1;
}
...
_wait_r(struct _reent *ptr, int *status)
{
    ...
    ptr->_errno = 
# 222 "rt-thread/components/libc/compilers/newlib/syscalls.c" 3
                 134
# 222 "rt-thread/components/libc/compilers/newlib/syscalls.c"
                        ;
    return -1;
}
...
_write_r(struct _reent *ptr, int fd, const void *buf, size_t nbytes)
{
    ...
    if (fileno(
# 231 "rt-thread/components/libc/compilers/newlib/syscalls.c" 3
              (_impure_ptr->_stdout)
# 231 "rt-thread/components/libc/compilers/newlib/syscalls.c"
                    ) == fd)
    {
        rt_device_t console;
...
# 278 "rt-thread/components/libc/compilers/newlib/syscalls.c"
...
static void libc_system_time_init(void)
{
    ...
    _timevalue.tv_usec = 1000000UL - (tick%100) * (1000000UL / 100);
    _timevalue.tv_sec = time - tick/100 - 1;
}
...
int libc_get_time(struct timespec *time)
{
    ...
    if (!(time != (0))) { rt_assert_handler("time != RT_NULL", __FUNCTION__, 315); };
    ...
    time->tv_sec = _timevalue.tv_sec + tick / 100;
    time->tv_nsec = (_timevalue.tv_usec + (tick % 100) * (1000000UL / 100)) * 1000;
...
_gettimeofday_r(struct _reent *ptr, struct timeval *__tp, void *__tzp)
{
    ...
    ptr->_errno = 
# 350 "rt-thread/components/libc/compilers/newlib/syscalls.c" 3
                 134
# 350 "rt-thread/components/libc/compilers/newlib/syscalls.c"
                        ;
    return -1;
}
...
_malloc_r (struct _reent *ptr, size_t size)
{
    ...
    {
        ptr->_errno = 
# 364 "rt-thread/components/libc/compilers/newlib/syscalls.c" 3
                     12
# 364 "rt-thread/components/libc/compilers/newlib/syscalls.c"
                           ;
    }
...
_realloc_r (struct _reent *ptr, void *old, size_t newlen)
{
    ...
    {
        ptr->_errno = 
# 378 "rt-thread/components/libc/compilers/newlib/syscalls.c" 3
                     12
# 378 "rt-thread/components/libc/compilers/newlib/syscalls.c"
                           ;
    }
...
void *_calloc_r (struct _reent *ptr, size_t size, size_t len)
{
    ...
    {
        ptr->_errno = 
# 391 "rt-thread/components/libc/compilers/newlib/syscalls.c" 3
                     12
# 391 "rt-thread/components/libc/compilers/newlib/syscalls.c"
                           ;
    }
...
exit (int status)
{
    ...
    if (!(0)) { rt_assert_handler("0", __FUNCTION__, 414); };
