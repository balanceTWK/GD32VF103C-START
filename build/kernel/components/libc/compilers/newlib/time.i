# 1 "rt-thread/components/libc/compilers/newlib/time.c"
...
# 1 "rt-thread/components/libc/compilers/newlib/time.c"
# 9 "rt-thread/components/libc/compilers/newlib/time.c"
...
# 41 "/home/tang/toolchains/riscv-none-gcc/8.2.0-2.2-20190521-0004/riscv-none-embed/include/sys/time.h" 2 3
...
# 33 "/home/tang/toolchains/riscv-none-gcc/8.2.0-2.2-20190521-0004/riscv-none-embed/include/sys/_timeval.h" 2 3
...
# 10 "rt-thread/components/libc/compilers/newlib/time.c" 2
...
# 11 "rt-thread/components/libc/compilers/newlib/time.c" 2
...
int gettimeofday(struct timeval *tp, void *ignore)
{
    ...
    if (!(device != (0))) { rt_assert_handler("device != RT_NULL", __FUNCTION__, 19); };
...
# 45 "rt-thread/components/libc/compilers/newlib/time.c"
time_t time(time_t *t)

{
    time_t time_now = 0;
# 71 "rt-thread/components/libc/compilers/newlib/time.c"
    if (t != (0))
    {
        *t = time_now;
    }
