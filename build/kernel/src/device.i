...
# 18 "rt-thread/src/device.c" 2
# 32 "rt-thread/src/device.c"
...
;
# 100 "rt-thread/src/device.c"
rt_err_t rt_device_init_all(void)
{
    return 0;
}
# 112 "rt-thread/src/device.c"
rt_device_t rt_device_find(const char *name)
{
