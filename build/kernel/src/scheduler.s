...
.LFB15:
	.file 2 "rt-thread/src/scheduler.c"
	.loc 2 73 1
	.cfi_startproc
	addi	sp,sp,-32
	.cfi_def_cfa_offset 32
...
.L8:
	...
	mv	a4,a5
	.loc 2 90 53 discriminator 1
	lw	a5,-36(s0)
	lw	a5,40(a5)
	.loc 2 88 52 discriminator 1
	bleu	a4,a5,.L9
	.loc 2 91 27
	lw	a5,-36(s0)
	lw	a5,28(a5)
...
.LFB18:
	...
	j	.L18
.L19:
	.loc 2 207 9 discriminator 3
	slli	a4,s1,3
	lla	a5,rt_thread_priority_table
	add	a5,a4,a5
	mv	a0,a5
	call	rt_list_init
	.loc 2 205 42 discriminator 3
	addi	s1,s1,1
.L18:
...
.LFB21:
	...
	lw	a5,-20(s0)
	bnez	a5,.L33
	.loc 2 692 29 discriminator 1
	li	a2,692
	lla	a1,__FUNCTION__.3133
	lla	a0,.LC0
	call	rt_assert_handler
.L33:
	.loc 2 695 12
...
.LFB22:
	...
	lw	a5,-20(s0)
	bnez	a5,.L37
	.loc 2 789 29 discriminator 1
	li	a2,789
	lla	a1,__FUNCTION__.3139
	lla	a0,.LC0
	call	rt_assert_handler
.L37:
	.loc 2 792 13
...
.LFE25:
	...
	.size	__FUNCTION__.3092, 26
__FUNCTION__.3092:
	.string	"_rt_scheduler_stack_check"
	.align	2
	.type	__FUNCTION__.3133, @object
	.size	__FUNCTION__.3133, 26
__FUNCTION__.3133:
	.string	"rt_schedule_insert_thread"
	.align	2
	.type	__FUNCTION__.3139, @object
	.size	__FUNCTION__.3139, 26
__FUNCTION__.3139:
...
.LASF1721:
	.string	"rt-thread/src/scheduler.c"
.LASF1499:
