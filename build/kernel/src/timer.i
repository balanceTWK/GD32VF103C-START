...
# 23 "rt-thread/src/timer.c" 2


static rt_list_t rt_timer_list[1];
# 37 "rt-thread/src/timer.c"
                   ...
                   rt_uint8_t flag)
{
    ...
    if (!(timer != (0))) { rt_assert_handler("timer != RT_NULL", __FUNCTION__, 186); };
...
;
# 202 "rt-thread/src/timer.c"
rt_err_t rt_timer_detach(rt_timer_t timer)
{
    register rt_base_t level;


    if (!(timer != (0))) { rt_assert_handler("timer != RT_NULL", __FUNCTION__, 207); };
    if (!(rt_object_get_type(&timer->parent) == RT_Object_Class_Timer)) { rt_assert_handler("rt_object_get_type(&timer->parent) == RT_Object_Class_Timer", __FUNCTION__, 208); };
    if (!(rt_object_is_systemobject(&timer->parent))) { rt_assert_handler("rt_object_is_systemobject(&timer->parent)", __FUNCTION__, 209); };
...
rt_err_t rt_timer_delete(rt_timer_t timer)
{
    ...
    if (!(rt_object_get_type(&timer->parent) == RT_Object_Class_Timer)) { rt_assert_handler("rt_object_get_type(&timer->parent) == RT_Object_Class_Timer", __FUNCTION__, 271); };
    if (!(rt_object_is_systemobject(&timer->parent) == 0)) { rt_assert_handler("rt_object_is_systemobject(&timer->parent) == RT_FALSE", __FUNCTION__, 272); };
...
rt_err_t rt_timer_start(rt_timer_t timer)
{
    ...
    if (!(timer != (0))) { rt_assert_handler("timer != RT_NULL", __FUNCTION__, 306); };
    if (!(rt_object_get_type(&timer->parent) == RT_Object_Class_Timer)) { rt_assert_handler("rt_object_get_type(&timer->parent) == RT_Object_Class_Timer", __FUNCTION__, 307); };
    ...
    if (!(timer->init_tick < 0xffffffff / 2)) { rt_assert_handler("timer->init_tick < RT_TICK_MAX / 2", __FUNCTION__, 323); };
    ...
    if (timer->parent.flag & 0x4)
    {
        ...
        if ((timer_thread.stat & 0x0f) == 0x02)
        {
...
;
# 422 "rt-thread/src/timer.c"
rt_err_t rt_timer_stop(rt_timer_t timer)
{
    register rt_base_t level;


    if (!(timer != (0))) { rt_assert_handler("timer != RT_NULL", __FUNCTION__, 427); };
    if (!(rt_object_get_type(&timer->parent) == RT_Object_Class_Timer)) { rt_assert_handler("rt_object_get_type(&timer->parent) == RT_Object_Class_Timer", __FUNCTION__, 428); };
...
;
# 459 "rt-thread/src/timer.c"
rt_err_t rt_timer_control(rt_timer_t timer, int cmd, void *arg)
{

    if (!(timer != (0))) { rt_assert_handler("timer != RT_NULL", __FUNCTION__, 462); };
    if (!(rt_object_get_type(&timer->parent) == RT_Object_Class_Timer)) { rt_assert_handler("rt_object_get_type(&timer->parent) == RT_Object_Class_Timer", __FUNCTION__, 463); };
