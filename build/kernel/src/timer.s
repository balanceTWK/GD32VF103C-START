...
.LFE4:
	...
	.local	rt_soft_timer_list
	.comm	rt_soft_timer_list,8,4
	.local	timer_thread
	.comm	timer_thread,128,4
	.local	timer_thread_stack
	.comm	timer_thread_stack,512,4
...
.L16:
	...
	mv	a0,a5
	call	rt_list_remove
	.loc 2 125 25 discriminator 3
	lw	a5,-20(s0)
	addi	a5,a5,1
	sw	a5,-20(s0)
.L15:
	.loc 2 125 5 discriminator 1
	lw	a5,-20(s0)
	blez	a5,.L16
	.loc 2 129 1
	nop
...
.LFB23:
	...
	lw	a5,-20(s0)
	bnez	a5,.L28
	.loc 2 270 28 discriminator 1
	li	a2,270
	lla	a1,__FUNCTION__.3145
	lla	a0,.LC0
	call	rt_assert_handler
.L28:
	.loc 2 271 11
...
.LBE3:
	...
	sw	a4,-24(a5)
.L45:
	.loc 2 343 43 discriminator 2
	lw	a5,-20(s0)
	addi	a5,a5,1
	sw	a5,-20(s0)
.L39:
	.loc 2 343 5 discriminator 1
	lw	a5,-20(s0)
	beqz	a5,.L40
	.loc 2 376 14
	lla	a5,random_nr.3154
	lw	a5,0(a5)
	addi	a4,a5,1
	lla	a5,random_nr.3154
	sw	a4,0(a5)
...
.L82:
	...
	.loc 2 532 16
	beqz	a5,.L78
	.loc 2 533 27 discriminator 1
	lw	a5,-24(s0)
	lbu	a5,9(a5)
	.loc 2 533 33 discriminator 1
	andi	a5,a5,1
	.loc 2 532 40 discriminator 1
	beqz	a5,.L78
	.loc 2 536 32
	lw	a5,-24(s0)
	lbu	a5,9(a5)
...
.L95:
	...
	.loc 2 616 16
	beqz	a5,.L91
	.loc 2 617 27 discriminator 1
	lw	a5,-28(s0)
	lbu	a5,9(a5)
	.loc 2 617 33 discriminator 1
	andi	a5,a5,1
	.loc 2 616 40 discriminator 1
	beqz	a5,.L91
	.loc 2 620 32
	lw	a5,-28(s0)
	lbu	a5,9(a5)
...
.LFE29:
	...
	.align	1
	.type	rt_thread_timer_entry, @function
...
.LBE4:
	...
	.cfi_endproc
.LFE30:
	.size	rt_thread_timer_entry, .-rt_thread_timer_entry
	.align	1
...
.LFB31:
	...
	j	.L102
.L103:
	.loc 2 685 36 discriminator 3
	lw	a5,-20(s0)
	slli	a4,a5,3
	.loc 2 685 9 discriminator 3
	lla	a5,rt_timer_list
	add	a5,a4,a5
	mv	a0,a5
	call	rt_list_init
	.loc 2 683 72 discriminator 3
	lw	a5,-20(s0)
	addi	a5,a5,1
	sw	a5,-20(s0)
.L102:
	.loc 2 683 5 discriminator 1
	lw	a5,-20(s0)
	beqz	a5,.L103
	.loc 2 687 1
	nop
...
.L105:
	...
	li	a6,4
	li	a5,512
	lla	a4,timer_thread_stack
	li	a3,0
	lla	a2,rt_thread_timer_entry
	lla	a1,.LC5
	lla	a0,timer_thread
	call	rt_thread_init
	.loc 2 717 5
...
__FUNCTION__.3126:
	...
	.size	__FUNCTION__.3131, 16
__FUNCTION__.3131:
	.string	"rt_timer_detach"
	.align	2
	.type	__FUNCTION__.3145, @object
	.size	__FUNCTION__.3145, 16
__FUNCTION__.3145:
	.string	"rt_timer_delete"
	.align	2
	.type	__FUNCTION__.3155, @object
	.size	__FUNCTION__.3155, 15
__FUNCTION__.3155:
	.string	"rt_timer_start"
	.local	random_nr.3154
	.comm	random_nr.3154,4,4
	.align	2
	.type	__FUNCTION__.3172, @object
	.size	__FUNCTION__.3172, 14
__FUNCTION__.3172:
	.string	"rt_timer_stop"
	.align	2
	.type	__FUNCTION__.3178, @object
	.size	__FUNCTION__.3178, 17
__FUNCTION__.3178:
