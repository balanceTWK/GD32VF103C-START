...
rt_mp_alloc_sethook:
.LFB15:
	.file 2 "rt-thread/src/mempool.c"
	.loc 2 41 1
	.cfi_startproc
	addi	sp,sp,-32
	.cfi_def_cfa_offset 32
...
.L12:
	...
	j	.L13
.L14:
	.loc 2 116 48 discriminator 3
	addi	a4,s1,1
	.loc 2 116 67 discriminator 3
	lw	a5,-52(s0)
	addi	a5,a5,4
	.loc 2 116 53 discriminator 3
	mul	a4,a4,a5
	.loc 2 115 59 discriminator 3
	lw	a5,-52(s0)
	addi	a5,a5,4
	.loc 2 115 45 discriminator 3
	mul	a5,s1,a5
	.loc 2 115 36 discriminator 3
	lw	a3,-20(s0)
	add	a5,a3,a5
	.loc 2 116 13 discriminator 3
	lw	a3,-20(s0)
	add	a4,a3,a4
	.loc 2 115 84 discriminator 3
	sw	a4,0(a5)
	.loc 2 113 61 discriminator 3
	addi	s1,s1,1
.L13:
	.loc 2 113 33 discriminator 1
	lw	a5,-36(s0)
	lw	a5,36(a5)
...
.LBB2:
	...
	.loc 2 196 65
	beqz	a5,.L24
	.loc 2 196 98 discriminator 1
	lla	a1,__FUNCTION__.3121
	lla	a0,.LC6
	call	rt_kprintf
	.loc 2 196 179 discriminator 1
	li	a2,196
	lla	a1,__FUNCTION__.3121
	lla	a0,.LC7
	call	rt_assert_handler
.L24:
	.loc 2 196 226 discriminator 5
	lw	a0,-20(s0)
	call	rt_hw_interrupt_enable
.LBE2:
	.loc 2 199 8 discriminator 5
	lw	a5,-36(s0)
	bnez	a5,.L25
	.loc 2 199 27 discriminator 1
	li	a2,199
	lla	a1,__FUNCTION__.3121
	lla	a0,.LC1
	call	rt_assert_handler
.L25:
	...
	lw	a5,-40(s0)
	beqz	a5,.L26
	.loc 2 200 9 discriminator 2
	lw	a5,-44(s0)
	bnez	a5,.L27
.L26:
	.loc 2 200 49 discriminator 3
	li	a2,200
	lla	a1,__FUNCTION__.3121
	lla	a0,.LC8
	call	rt_assert_handler
...
.L30:
	...
	j	.L31
.L32:
	.loc 2 236 35 discriminator 3
	addi	a4,s1,1
	.loc 2 236 54 discriminator 3
	lw	a5,-44(s0)
	addi	a5,a5,4
	.loc 2 236 40 discriminator 3
	mul	a4,a4,a5
	.loc 2 235 59 discriminator 3
	lw	a5,-44(s0)
	addi	a5,a5,4
	.loc 2 235 45 discriminator 3
	mul	a5,s1,a5
	.loc 2 235 36 discriminator 3
	lw	a3,-28(s0)
	add	a5,a3,a5
	.loc 2 236 25 discriminator 3
	lw	a3,-28(s0)
	add	a4,a3,a4
	.loc 2 236 13 discriminator 3
	sw	a4,0(a5)
	.loc 2 233 61 discriminator 3
	addi	s1,s1,1
.L31:
	.loc 2 233 33 discriminator 1
	lw	a5,-24(s0)
	lw	a5,36(a5)
	.loc 2 233 5 discriminator 1
	bltu	s1,a5,.L32
	.loc 2 239 42
	addi	a4,s1,-1
	.loc 2 239 61
...
.LBB3:
	...
	.loc 2 260 65
	beqz	a5,.L34
	.loc 2 260 98 discriminator 1
	lla	a1,__FUNCTION__.3131
	lla	a0,.LC6
	call	rt_kprintf
	.loc 2 260 179 discriminator 1
	li	a2,260
	lla	a1,__FUNCTION__.3131
	lla	a0,.LC7
	call	rt_assert_handler
.L34:
	.loc 2 260 226 discriminator 5
	lw	a0,-20(s0)
	call	rt_hw_interrupt_enable
.LBE3:
	.loc 2 263 8 discriminator 5
	lw	a5,-36(s0)
	bnez	a5,.L35
...
.L36:
	...
	.loc 2 265 8
	beqz	a5,.L38
	.loc 2 265 59 discriminator 1
	li	a2,265
	lla	a1,__FUNCTION__.3131
	lla	a0,.LC9
	call	rt_assert_handler
	.loc 2 268 11 discriminator 1
	j	.L38
.L39:
	.loc 2 271 16
	call	rt_hw_interrupt_disable
...
.LBB4:
	...
	.loc 2 340 69
	beqz	a5,.L46
	.loc 2 340 102 discriminator 1
	lla	a1,__FUNCTION__.3143
	lla	a0,.LC6
	call	rt_kprintf
	.loc 2 340 183 discriminator 1
	li	a2,340
	lla	a1,__FUNCTION__.3143
	lla	a0,.LC7
	call	rt_assert_handler
.L46:
	.loc 2 340 230 discriminator 5
	lw	a0,-28(s0)
	call	rt_hw_interrupt_enable
.LBE4:
	.loc 2 342 23 discriminator 5
	lw	a5,-24(s0)
	sw	zero,48(a5)
	.loc 2 345 9 discriminator 5
	lw	a0,-24(s0)
	call	rt_thread_suspend
	.loc 2 346 9 discriminator 5
	lw	a5,-36(s0)
	addi	a4,a5,44
	lw	a5,-24(s0)
	addi	a5,a5,20
	...
	.loc 2 347 11 discriminator 5
	lw	a5,-36(s0)
	lw	a5,52(a5)
	.loc 2 347 33 discriminator 5
	addi	a4,a5,1
	lw	a5,-36(s0)
	sw	a4,52(a5)
	.loc 2 349 18 discriminator 5
	lw	a5,-40(s0)
	.loc 2 349 12 discriminator 5
	blez	a5,.L47
	.loc 2 352 28
	call	rt_tick_get
	sw	a0,-20(s0)
...
.L51:
	...
	.loc 2 396 13
	beqz	a5,.L52
	.loc 2 396 41 discriminator 1
	lla	a5,rt_mp_alloc_hook
	lw	a4,0(a5)
	.loc 2 396 63 discriminator 1
	lw	a5,-32(s0)
	addi	a5,a5,4
	.loc 2 396 41 discriminator 1
	mv	a1,a5
...
.LFE22:
	...
	.section	.rodata
	.align	2
	.type	__FUNCTION__.3099, @object
	.size	__FUNCTION__.3099, 11
__FUNCTION__.3099:
	.string	"rt_mp_init"
	.align	2
	.type	__FUNCTION__.3108, @object
	.size	__FUNCTION__.3108, 13
__FUNCTION__.3108:
	.string	"rt_mp_detach"
	.align	2
	.type	__FUNCTION__.3121, @object
	.size	__FUNCTION__.3121, 13
__FUNCTION__.3121:
	.string	"rt_mp_create"
	.align	2
	.type	__FUNCTION__.3131, @object
	.size	__FUNCTION__.3131, 13
__FUNCTION__.3131:
	.string	"rt_mp_delete"
	.align	2
	.type	__FUNCTION__.3143, @object
	.size	__FUNCTION__.3143, 12
__FUNCTION__.3143:
	.string	"rt_mp_alloc"
	.text
.Letext0:
...
.LASF1731:
	.string	"rt-thread/src/mempool.c"
.LASF819:
