...
;
# 126 "rt-thread/src/kservice.c"
void *rt_memset(void *s, int c, rt_ubase_t count)
{
# 136 "rt-thread/src/kservice.c"
...
;
# 210 "rt-thread/src/kservice.c"
void *rt_memcpy(void *dst, const void *src, rt_ubase_t count)
{
# 230 "rt-thread/src/kservice.c"
                        ...
                        va_list args)
{
    ...
    for (; *fmt ; ++fmt)
    {
        ...
        else if (*fmt == '*')
        {
            ...
            field_width = 
# 842 "rt-thread/src/kservice.c" 3 4
                         __builtin_va_arg(
# 842 "rt-thread/src/kservice.c"
                         args
# 842 "rt-thread/src/kservice.c" 3 4
                         ,
# 842 "rt-thread/src/kservice.c"
...
# 842 "rt-thread/src/kservice.c"
        ...
        if (*fmt == '.')
        {
            ...
            else if (*fmt == '*')
            {
                ...
                precision = 
# 861 "rt-thread/src/kservice.c" 3 4
                           __builtin_va_arg(
...
# 861 "rt-thread/src/kservice.c"
        ...
        case 'c':
            ...
            c = (rt_uint8_t)
# 901 "rt-thread/src/kservice.c" 3 4
                           __builtin_va_arg(
# 901 "rt-thread/src/kservice.c"
                           args
# 901 "rt-thread/src/kservice.c" 3 4
                           ,
# 901 "rt-thread/src/kservice.c"
...
# 901 "rt-thread/src/kservice.c"
        ...
        case 's':
            s = 
# 914 "rt-thread/src/kservice.c" 3 4
               __builtin_va_arg(
# 914 "rt-thread/src/kservice.c"
               args
# 914 "rt-thread/src/kservice.c" 3 4
               ,
# 914 "rt-thread/src/kservice.c"
...
# 914 "rt-thread/src/kservice.c"
        ...
        case 'p':
            ...
            str = print_number(str, end,
                               (long)
# 953 "rt-thread/src/kservice.c" 3 4
                                    __builtin_va_arg(
# 953 "rt-thread/src/kservice.c"
                                    args
# 953 "rt-thread/src/kservice.c" 3 4
                                    ,
# 953 "rt-thread/src/kservice.c"
...
# 953 "rt-thread/src/kservice.c"
        ...
        {
            num = 
# 1007 "rt-thread/src/kservice.c" 3 4
                 __builtin_va_arg(
# 1007 "rt-thread/src/kservice.c"
                 args
# 1007 "rt-thread/src/kservice.c" 3 4
                 ,
# 1007 "rt-thread/src/kservice.c"
...
# 1007 "rt-thread/src/kservice.c"
        ...
        {
            num = (rt_uint16_t)
# 1012 "rt-thread/src/kservice.c" 3 4
                              __builtin_va_arg(
# 1012 "rt-thread/src/kservice.c"
                              args
# 1012 "rt-thread/src/kservice.c" 3 4
                              ,
# 1012 "rt-thread/src/kservice.c"
...
# 1012 "rt-thread/src/kservice.c"
        ...
        {
            num = 
# 1017 "rt-thread/src/kservice.c" 3 4
                 __builtin_va_arg(
# 1017 "rt-thread/src/kservice.c"
                 args
# 1017 "rt-thread/src/kservice.c" 3 4
                 ,
# 1017 "rt-thread/src/kservice.c"
...
# 1055 "rt-thread/src/kservice.c" 3 4
   __builtin_va_start(
# 1055 "rt-thread/src/kservice.c"
   args
# 1055 "rt-thread/src/kservice.c" 3 4
   ,
# 1055 "rt-thread/src/kservice.c"
...
# 1057 "rt-thread/src/kservice.c" 3 4
   __builtin_va_end(
# 1057 "rt-thread/src/kservice.c"
   args
# 1057 "rt-thread/src/kservice.c" 3 4
   )
# 1057 "rt-thread/src/kservice.c"
...
# 1087 "rt-thread/src/kservice.c" 3 4
   __builtin_va_start(
# 1087 "rt-thread/src/kservice.c"
   arg_ptr
# 1087 "rt-thread/src/kservice.c" 3 4
   ,
# 1087 "rt-thread/src/kservice.c"
...
# 1089 "rt-thread/src/kservice.c" 3 4
   __builtin_va_end(
# 1089 "rt-thread/src/kservice.c"
   arg_ptr
# 1089 "rt-thread/src/kservice.c" 3 4
   )
# 1089 "rt-thread/src/kservice.c"
...
;
# 1103 "rt-thread/src/kservice.c"
rt_device_t rt_console_get_device(void)
{
    return _console_device;
}
;
# 1118 "rt-thread/src/kservice.c"
rt_device_t rt_console_set_device(const char *name)
{
...
# 1189 "rt-thread/src/kservice.c" 3 4
   __builtin_va_start(
# 1189 "rt-thread/src/kservice.c"
   args
# 1189 "rt-thread/src/kservice.c" 3 4
   ,
# 1189 "rt-thread/src/kservice.c"
...
# 1214 "rt-thread/src/kservice.c" 3 4
   __builtin_va_end(
# 1214 "rt-thread/src/kservice.c"
   args
# 1214 "rt-thread/src/kservice.c" 3 4
   )
# 1214 "rt-thread/src/kservice.c"
