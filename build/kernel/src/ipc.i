...
# 39 "rt-thread/src/ipc.c" 2
# 1 "rt-thread/include/rthw.h" 1
# 18 "rt-thread/include/rthw.h"
#define __RT_HW_H__ 
# 30 "rt-thread/include/rthw.h"
...
rt_isr_handler_t rt_hw_interrupt_install(int vector,
                                         ...
                                         void *param,
                                         const char *name);
# 105 "rt-thread/include/rthw.h"
rt_base_t rt_hw_interrupt_disable(void);
void rt_hw_interrupt_enable(rt_base_t level);
# 117 "rt-thread/include/rthw.h"
...
rt_err_t rt_sem_init(rt_sem_t sem,
                     ...
                     rt_uint8_t flag)
{
    if (!(sem != (0))) { rt_assert_handler("sem != RT_NULL", __FUNCTION__, 203); };
    if (!(value < 0x10000U)) { rt_assert_handler("value < 0x10000U", __FUNCTION__, 204); };
...
rt_err_t rt_sem_detach(rt_sem_t sem)
{
    ...
    if (!(sem != (0))) { rt_assert_handler("sem != RT_NULL", __FUNCTION__, 234); };
    if (!(rt_object_get_type(&sem->parent.parent) == RT_Object_Class_Semaphore)) { rt_assert_handler("rt_object_get_type(&sem->parent.parent) == RT_Object_Class_Semaphore", __FUNCTION__, 235); };
    if (!(rt_object_is_systemobject(&sem->parent.parent))) { rt_assert_handler("rt_object_is_systemobject(&sem->parent.parent)", __FUNCTION__, 236); };
...
rt_sem_t rt_sem_create(const char *name, rt_uint32_t value, rt_uint8_t flag)
{
    ...
    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 264); } } rt_hw_interrupt_enable(level); } while (0);
    if (!(value < 0x10000U)) { rt_assert_handler("value < 0x10000U", __FUNCTION__, 265); };
...
rt_err_t rt_sem_delete(rt_sem_t sem)
{
    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 296); } } rt_hw_interrupt_enable(level); } while (0);


    if (!(sem != (0))) { rt_assert_handler("sem != RT_NULL", __FUNCTION__, 299); };
    if (!(rt_object_get_type(&sem->parent.parent) == RT_Object_Class_Semaphore)) { rt_assert_handler("rt_object_get_type(&sem->parent.parent) == RT_Object_Class_Semaphore", __FUNCTION__, 300); };
    if (!(rt_object_is_systemobject(&sem->parent.parent) == 0)) { rt_assert_handler("rt_object_is_systemobject(&sem->parent.parent) == RT_FALSE", __FUNCTION__, 301); };
...
rt_err_t rt_sem_take(rt_sem_t sem, rt_int32_t time)
{
    ...
    if (!(sem != (0))) { rt_assert_handler("sem != RT_NULL", __FUNCTION__, 329); };
    if (!(rt_object_get_type(&sem->parent.parent) == RT_Object_Class_Semaphore)) { rt_assert_handler("rt_object_get_type(&sem->parent.parent) == RT_Object_Class_Semaphore", __FUNCTION__, 330); };
    ...
    else
    {
        ...
        else
        {
            ...
            do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_thread_self() == (0)) { rt_kprintf("Function[%s] shall not be used before scheduler start\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 362); } } do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 362); } } rt_hw_interrupt_enable(level); } while (0); rt_hw_interrupt_enable(level); } while (0);
...
rt_err_t rt_sem_release(rt_sem_t sem)
{
    ...
    if (!(sem != (0))) { rt_assert_handler("sem != RT_NULL", __FUNCTION__, 438); };
    if (!(rt_object_get_type(&sem->parent.parent) == RT_Object_Class_Semaphore)) { rt_assert_handler("rt_object_get_type(&sem->parent.parent) == RT_Object_Class_Semaphore", __FUNCTION__, 439); };
...
rt_err_t rt_sem_control(rt_sem_t sem, int cmd, void *arg)
{
    ...
    if (!(sem != (0))) { rt_assert_handler("sem != RT_NULL", __FUNCTION__, 487); };
    if (!(rt_object_get_type(&sem->parent.parent) == RT_Object_Class_Semaphore)) { rt_assert_handler("rt_object_get_type(&sem->parent.parent) == RT_Object_Class_Semaphore", __FUNCTION__, 488); };
...
rt_err_t rt_mutex_init(rt_mutex_t mutex, const char *name, rt_uint8_t flag)
{
    ...
    if (!(mutex != (0))) { rt_assert_handler("mutex != RT_NULL", __FUNCTION__, 532); };
...
rt_err_t rt_mutex_detach(rt_mutex_t mutex)
{
    ...
    if (!(mutex != (0))) { rt_assert_handler("mutex != RT_NULL", __FUNCTION__, 564); };
    if (!(rt_object_get_type(&mutex->parent.parent) == RT_Object_Class_Mutex)) { rt_assert_handler("rt_object_get_type(&mutex->parent.parent) == RT_Object_Class_Mutex", __FUNCTION__, 565); };
    if (!(rt_object_is_systemobject(&mutex->parent.parent))) { rt_assert_handler("rt_object_is_systemobject(&mutex->parent.parent)", __FUNCTION__, 566); };
...
rt_mutex_t rt_mutex_create(const char *name, rt_uint8_t flag)
{
    ...
    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 593); } } rt_hw_interrupt_enable(level); } while (0);
...
rt_err_t rt_mutex_delete(rt_mutex_t mutex)
{
    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 626); } } rt_hw_interrupt_enable(level); } while (0);


    if (!(mutex != (0))) { rt_assert_handler("mutex != RT_NULL", __FUNCTION__, 629); };
    if (!(rt_object_get_type(&mutex->parent.parent) == RT_Object_Class_Mutex)) { rt_assert_handler("rt_object_get_type(&mutex->parent.parent) == RT_Object_Class_Mutex", __FUNCTION__, 630); };
    if (!(rt_object_is_systemobject(&mutex->parent.parent) == 0)) { rt_assert_handler("rt_object_is_systemobject(&mutex->parent.parent) == RT_FALSE", __FUNCTION__, 631); };
...
rt_err_t rt_mutex_take(rt_mutex_t mutex, rt_int32_t time)
{
    ...
    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_thread_self() == (0)) { rt_kprintf("Function[%s] shall not be used before scheduler start\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 659); } } do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 659); } } rt_hw_interrupt_enable(level); } while (0); rt_hw_interrupt_enable(level); } while (0);


    if (!(mutex != (0))) { rt_assert_handler("mutex != RT_NULL", __FUNCTION__, 662); };
    if (!(rt_object_get_type(&mutex->parent.parent) == RT_Object_Class_Mutex)) { rt_assert_handler("rt_object_get_type(&mutex->parent.parent) == RT_Object_Class_Mutex", __FUNCTION__, 663); };
...
rt_err_t rt_mutex_release(rt_mutex_t mutex)
{
    ...
    if (!(mutex != (0))) { rt_assert_handler("mutex != RT_NULL", __FUNCTION__, 796); };
    if (!(rt_object_get_type(&mutex->parent.parent) == RT_Object_Class_Mutex)) { rt_assert_handler("rt_object_get_type(&mutex->parent.parent) == RT_Object_Class_Mutex", __FUNCTION__, 797); };

    need_schedule = 0;


    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_thread_self() == (0)) { rt_kprintf("Function[%s] shall not be used before scheduler start\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 802); } } do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 802); } } rt_hw_interrupt_enable(level); } while (0); rt_hw_interrupt_enable(level); } while (0);
...
rt_err_t rt_mutex_control(rt_mutex_t mutex, int cmd, void *arg)
{
    ...
    if (!(mutex != (0))) { rt_assert_handler("mutex != RT_NULL", __FUNCTION__, 895); };
    if (!(rt_object_get_type(&mutex->parent.parent) == RT_Object_Class_Mutex)) { rt_assert_handler("rt_object_get_type(&mutex->parent.parent) == RT_Object_Class_Mutex", __FUNCTION__, 896); };
...
rt_err_t rt_event_init(rt_event_t event, const char *name, rt_uint8_t flag)
{
    ...
    if (!(event != (0))) { rt_assert_handler("event != RT_NULL", __FUNCTION__, 917); };
...
rt_err_t rt_event_detach(rt_event_t event)
{
    ...
    if (!(event != (0))) { rt_assert_handler("event != RT_NULL", __FUNCTION__, 945); };
    if (!(rt_object_get_type(&event->parent.parent) == RT_Object_Class_Event)) { rt_assert_handler("rt_object_get_type(&event->parent.parent) == RT_Object_Class_Event", __FUNCTION__, 946); };
    if (!(rt_object_is_systemobject(&event->parent.parent))) { rt_assert_handler("rt_object_is_systemobject(&event->parent.parent)", __FUNCTION__, 947); };
...
rt_event_t rt_event_create(const char *name, rt_uint8_t flag)
{
    ...
    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 972); } } rt_hw_interrupt_enable(level); } while (0);
...
rt_err_t rt_event_delete(rt_event_t event)
{
    ...
    if (!(event != (0))) { rt_assert_handler("event != RT_NULL", __FUNCTION__, 1002); };
    if (!(rt_object_get_type(&event->parent.parent) == RT_Object_Class_Event)) { rt_assert_handler("rt_object_get_type(&event->parent.parent) == RT_Object_Class_Event", __FUNCTION__, 1003); };
    if (!(rt_object_is_systemobject(&event->parent.parent) == 0)) { rt_assert_handler("rt_object_is_systemobject(&event->parent.parent) == RT_FALSE", __FUNCTION__, 1004); };

    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1006); } } rt_hw_interrupt_enable(level); } while (0);
...
rt_err_t rt_event_send(rt_event_t event, rt_uint32_t set)
{
    ...
    if (!(event != (0))) { rt_assert_handler("event != RT_NULL", __FUNCTION__, 1037); };
    if (!(rt_object_get_type(&event->parent.parent) == RT_Object_Class_Event)) { rt_assert_handler("rt_object_get_type(&event->parent.parent) == RT_Object_Class_Event", __FUNCTION__, 1038); };
                       ...
                       rt_uint32_t *recved)
{
    ...
    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_thread_self() == (0)) { rt_kprintf("Function[%s] shall not be used before scheduler start\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1136); } } do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1136); } } rt_hw_interrupt_enable(level); } while (0); rt_hw_interrupt_enable(level); } while (0);


    if (!(event != (0))) { rt_assert_handler("event != RT_NULL", __FUNCTION__, 1139); };
    if (!(rt_object_get_type(&event->parent.parent) == RT_Object_Class_Event)) { rt_assert_handler("rt_object_get_type(&event->parent.parent) == RT_Object_Class_Event", __FUNCTION__, 1140); };
    ...
    else
    {
        ...
        if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1171); };
    }
...
rt_err_t rt_event_control(rt_event_t event, int cmd, void *arg)
{
    ...
    if (!(event != (0))) { rt_assert_handler("event != RT_NULL", __FUNCTION__, 1253); };
    if (!(rt_object_get_type(&event->parent.parent) == RT_Object_Class_Event)) { rt_assert_handler("rt_object_get_type(&event->parent.parent) == RT_Object_Class_Event", __FUNCTION__, 1254); };
...
rt_err_t rt_mb_init(rt_mailbox_t mb,
                    ...
                    rt_uint8_t flag)
{
    if (!(mb != (0))) { rt_assert_handler("mb != RT_NULL", __FUNCTION__, 1299); };
...
rt_err_t rt_mb_detach(rt_mailbox_t mb)
{
    ...
    if (!(mb != (0))) { rt_assert_handler("mb != RT_NULL", __FUNCTION__, 1334); };
    if (!(rt_object_get_type(&mb->parent.parent) == RT_Object_Class_MailBox)) { rt_assert_handler("rt_object_get_type(&mb->parent.parent) == RT_Object_Class_MailBox", __FUNCTION__, 1335); };
    if (!(rt_object_is_systemobject(&mb->parent.parent))) { rt_assert_handler("rt_object_is_systemobject(&mb->parent.parent)", __FUNCTION__, 1336); };
...
rt_mailbox_t rt_mb_create(const char *name, rt_size_t size, rt_uint8_t flag)
{
    ...
    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1364); } } rt_hw_interrupt_enable(level); } while (0);
...
rt_err_t rt_mb_delete(rt_mailbox_t mb)
{
    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1407); } } rt_hw_interrupt_enable(level); } while (0);


    if (!(mb != (0))) { rt_assert_handler("mb != RT_NULL", __FUNCTION__, 1410); };
    if (!(rt_object_get_type(&mb->parent.parent) == RT_Object_Class_MailBox)) { rt_assert_handler("rt_object_get_type(&mb->parent.parent) == RT_Object_Class_MailBox", __FUNCTION__, 1411); };
    if (!(rt_object_is_systemobject(&mb->parent.parent) == 0)) { rt_assert_handler("rt_object_is_systemobject(&mb->parent.parent) == RT_FALSE", __FUNCTION__, 1412); };
                         ...
                         rt_int32_t timeout)
{
    ...
    if (!(mb != (0))) { rt_assert_handler("mb != RT_NULL", __FUNCTION__, 1450); };
    if (!(rt_object_get_type(&mb->parent.parent) == RT_Object_Class_MailBox)) { rt_assert_handler("rt_object_get_type(&mb->parent.parent) == RT_Object_Class_MailBox", __FUNCTION__, 1451); };
    ...
    while (mb->entry == mb->size)
    {
        ...
        do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_thread_self() == (0)) { rt_kprintf("Function[%s] shall not be used before scheduler start\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1486); } } do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1486); } } rt_hw_interrupt_enable(level); } while (0); rt_hw_interrupt_enable(level); } while (0);
...
rt_err_t rt_mb_recv(rt_mailbox_t mb, rt_ubase_t *value, rt_int32_t timeout)
{
    ...
    if (!(mb != (0))) { rt_assert_handler("mb != RT_NULL", __FUNCTION__, 1596); };
    if (!(rt_object_get_type(&mb->parent.parent) == RT_Object_Class_MailBox)) { rt_assert_handler("rt_object_get_type(&mb->parent.parent) == RT_Object_Class_MailBox", __FUNCTION__, 1597); };
    ...
    while (mb->entry == 0)
    {
        ...
        do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_thread_self() == (0)) { rt_kprintf("Function[%s] shall not be used before scheduler start\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1634); } } do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1634); } } rt_hw_interrupt_enable(level); } while (0); rt_hw_interrupt_enable(level); } while (0);
...
rt_err_t rt_mb_control(rt_mailbox_t mb, int cmd, void *arg)
{
    ...
    if (!(mb != (0))) { rt_assert_handler("mb != RT_NULL", __FUNCTION__, 1730); };
    if (!(rt_object_get_type(&mb->parent.parent) == RT_Object_Class_MailBox)) { rt_assert_handler("rt_object_get_type(&mb->parent.parent) == RT_Object_Class_MailBox", __FUNCTION__, 1731); };
                    ...
                    rt_uint8_t flag)
{
    ...
    if (!(mq != (0))) { rt_assert_handler("mq != RT_NULL", __FUNCTION__, 1791); };
...
;
# 1837 "rt-thread/src/ipc.c"
rt_err_t rt_mq_detach(rt_mq_t mq)
{

    if (!(mq != (0))) { rt_assert_handler("mq != RT_NULL", __FUNCTION__, 1840); };
    if (!(rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue)) { rt_assert_handler("rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue", __FUNCTION__, 1841); };
    if (!(rt_object_is_systemobject(&mq->parent.parent))) { rt_assert_handler("rt_object_is_systemobject(&mq->parent.parent)", __FUNCTION__, 1842); };
                     ...
                     rt_uint8_t flag)
{
    ...
    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1874); } } rt_hw_interrupt_enable(level); } while (0);
...
;
# 1930 "rt-thread/src/ipc.c"
rt_err_t rt_mq_delete(rt_mq_t mq)
{
    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1932); } } rt_hw_interrupt_enable(level); } while (0);


    if (!(mq != (0))) { rt_assert_handler("mq != RT_NULL", __FUNCTION__, 1935); };
    if (!(rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue)) { rt_assert_handler("rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue", __FUNCTION__, 1936); };
    if (!(rt_object_is_systemobject(&mq->parent.parent) == 0)) { rt_assert_handler("rt_object_is_systemobject(&mq->parent.parent) == RT_FALSE", __FUNCTION__, 1937); };
...
rt_err_t rt_mq_send(rt_mq_t mq, const void *buffer, rt_size_t size)
{
    ...
    if (!(mq != (0))) { rt_assert_handler("mq != RT_NULL", __FUNCTION__, 1969); };
    if (!(rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue)) { rt_assert_handler("rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue", __FUNCTION__, 1970); };
    if (!(buffer != (0))) { rt_assert_handler("buffer != RT_NULL", __FUNCTION__, 1971); };
    if (!(size != 0)) { rt_assert_handler("size != 0", __FUNCTION__, 1972); };
...
rt_err_t rt_mq_urgent(rt_mq_t mq, const void *buffer, rt_size_t size)
{
    ...
    if (!(mq != (0))) { rt_assert_handler("mq != RT_NULL", __FUNCTION__, 2059); };
    if (!(rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue)) { rt_assert_handler("rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue", __FUNCTION__, 2060); };
    if (!(buffer != (0))) { rt_assert_handler("buffer != RT_NULL", __FUNCTION__, 2061); };
    if (!(size != 0)) { rt_assert_handler("size != 0", __FUNCTION__, 2062); };
                    ...
                    rt_int32_t timeout)
{
    ...
    if (!(mq != (0))) { rt_assert_handler("mq != RT_NULL", __FUNCTION__, 2149); };
    if (!(rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue)) { rt_assert_handler("rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue", __FUNCTION__, 2150); };
    if (!(buffer != (0))) { rt_assert_handler("buffer != RT_NULL", __FUNCTION__, 2151); };
    if (!(size != 0)) { rt_assert_handler("size != 0", __FUNCTION__, 2152); };
    ...
    while (mq->entry == 0)
    {
        do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_thread_self() == (0)) { rt_kprintf("Function[%s] shall not be used before scheduler start\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 2174); } } do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 2174); } } rt_hw_interrupt_enable(level); } while (0); rt_hw_interrupt_enable(level); } while (0);
...
rt_err_t rt_mq_control(rt_mq_t mq, int cmd, void *arg)
{
    ...
    if (!(mq != (0))) { rt_assert_handler("mq != RT_NULL", __FUNCTION__, 2285); };
    if (!(rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue)) { rt_assert_handler("rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue", __FUNCTION__, 2286); };
