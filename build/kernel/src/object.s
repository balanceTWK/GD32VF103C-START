...
.L13:
	...
	j	.L12
.L11:
	.loc 2 223 59 discriminator 2
	lw	a5,-20(s0)
	addi	a5,a5,1
	sw	a5,-20(s0)
.L10:
	.loc 2 223 5 discriminator 1
	lw	a4,-20(s0)
	li	a5,8
	ble	a4,a5,.L13
	.loc 2 226 12
...
.LBE2:
	...
	sw	a5,-20(s0)
.L16:
	.loc 2 259 21 discriminator 1
	lw	a5,-24(s0)
	addi	a5,a5,4
	.loc 2 258 5 discriminator 1
	lw	a4,-20(s0)
	bne	a4,a5,.L18
	.loc 2 271 5
...
.LBB3:
	...
	.loc 2 347 65
	beqz	a5,.L24
	.loc 2 347 98 discriminator 1
	lla	a1,__FUNCTION__.3152
	lla	a0,.LC3
	call	rt_kprintf
	.loc 2 347 179 discriminator 1
	li	a2,347
	lla	a1,__FUNCTION__.3152
	lla	a0,.LC4
	call	rt_assert_handler
.L24:
	.loc 2 347 226 discriminator 5
	lw	a0,-20(s0)
	call	rt_hw_interrupt_enable
.LBE3:
	.loc 2 350 19 discriminator 5
	lw	a0,-36(s0)
	call	rt_object_get_information
	sw	a0,-24(s0)
	.loc 2 351 8 discriminator 5
	lw	a5,-24(s0)
	bnez	a5,.L25
	.loc 2 351 34 discriminator 1
	li	a2,351
	lla	a1,__FUNCTION__.3152
	lla	a0,.LC0
	call	rt_assert_handler
...
.LBB4:
	...
	.loc 2 490 65
	beqz	a5,.L44
	.loc 2 490 98 discriminator 1
	lla	a1,__FUNCTION__.3174
	lla	a0,.LC3
	call	rt_kprintf
	.loc 2 490 179 discriminator 1
	li	a2,490
	lla	a1,__FUNCTION__.3174
	lla	a0,.LC4
	call	rt_assert_handler
.L44:
	.loc 2 490 226 discriminator 5
	lw	a0,-32(s0)
	call	rt_hw_interrupt_enable
.LBE4:
	.loc 2 493 5 discriminator 5
	call	rt_enter_critical
	.loc 2 496 8 discriminator 5
	lw	a5,-24(s0)
	bnez	a5,.L45
	.loc 2 498 23
	lbu	a5,-37(s0)
...
.L47:
	...
	sw	a5,-20(s0)
.L46:
	.loc 2 502 21 discriminator 1
	lw	a5,-24(s0)
	addi	a5,a5,4
	.loc 2 501 5 discriminator 1
	lw	a4,-20(s0)
	bne	a4,a5,.L48
	.loc 2 516 5
	call	rt_exit_critical
