...
.L76:
	...
	beqz	a5,.L77
	.loc 1 480 49 discriminator 3
	lw	a4,-20(s0)
	lw	a5,-36(s0)
	sub	a5,a4,a5
	.loc 1 480 33 discriminator 3
	mv	a4,a5
...
.L82:
	...
	sw	a5,-20(s0)
.L81:
	.loc 1 499 18 discriminator 1
	lw	a5,-20(s0)
	lbu	a5,0(a5)
	.loc 1 499 5 discriminator 1
	bnez	a5,.L82
	.loc 1 502 15
	lw	a4,-20(s0)
	lw	a5,-36(s0)
...
.LFB33:
	...
	.loc 1 645 47
	beqz	a5,.L97
	.loc 1 645 47 is_stmt 0 discriminator 1
	lla	a5,large_digits.3248
	j	.L98
.L97:
	.loc 1 645 47 discriminator 2
	lla	a5,small_digits.3247
.L98:
	.loc 1 645 12 is_stmt 1 discriminator 4
	sw	a5,-28(s0)
	.loc 1 646 14 discriminator 4
	lw	a5,-76(s0)
	andi	a5,a5,16
	.loc 1 646 8 discriminator 4
	beqz	a5,.L99
	.loc 1 647 14
	lw	a5,-76(s0)
	andi	a5,a5,-2
...
.L99:
	...
	.loc 1 649 7
	beqz	a5,.L100
	.loc 1 649 7 is_stmt 0 discriminator 1
	li	a5,48
	j	.L101
.L100:
	.loc 1 649 7 discriminator 2
	li	a5,32
.L101:
	.loc 1 649 7 discriminator 4
	sb	a5,-29(s0)
	.loc 1 652 10 is_stmt 1 discriminator 4
	sb	zero,-17(s0)
	.loc 1 653 14 discriminator 4
	lw	a5,-76(s0)
	andi	a5,a5,2
	.loc 1 653 8 discriminator 4
	beqz	a5,.L102
	.loc 1 655 17
	lw	a5,-60(s0)
	.loc 1 655 12
...
.L148:
	...
	li	a5,104
	beq	a4,a5,.L151
	.loc 1 871 28 discriminator 1
	lw	a5,-76(s0)
	lbu	a4,0(a5)
	.loc 1 871 25 discriminator 1
	li	a5,108
	bne	a4,a5,.L152
.L151:
	.loc 1 874 25
...
.L172:
	...
	lw	a5,-52(s0)
	blez	a5,.L173
	.loc 1 919 31 discriminator 1
	lw	a4,-28(s0)
	lw	a5,-52(s0)
	ble	a4,a5,.L173
	.loc 1 919 55 discriminator 2
	lw	a5,-52(s0)
	sw	a5,-28(s0)
.L173:
	.loc 1 922 25
...
.L180:
	...
	lw	a5,-40(s0)
	lbu	a4,0(a5)
	.loc 1 933 37 discriminator 1
	lw	a5,-32(s0)
	sb	a4,0(a5)
.L179:
	.loc 1 934 17 discriminator 2
	lw	a5,-32(s0)
	addi	a5,a5,1
	sw	a5,-32(s0)
	.loc 1 935 17 discriminator 2
	lw	a5,-40(s0)
	addi	a5,a5,1
	sw	a5,-40(s0)
	.loc 1 931 34 discriminator 2
	lw	a5,-24(s0)
	addi	a5,a5,1
	sw	a5,-24(s0)
.L178:
	.loc 1 931 13 discriminator 1
	lw	a4,-24(s0)
	lw	a5,-28(s0)
	blt	a4,a5,.L180
	.loc 1 938 19
...
.L187:
	...
	lw	a5,-36(s0)
	bgeu	a4,a5,.L189
	.loc 1 990 39 discriminator 1
	lw	a5,-76(s0)
	lbu	a4,0(a5)
	.loc 1 990 37 discriminator 1
	lw	a5,-32(s0)
	sb	a4,0(a5)
.L189:
	.loc 1 991 17
...
.L191:
	...
	.loc 1 1013 16
	beqz	a5,.L193
	.loc 1 1013 41 discriminator 1
	lw	a5,-20(s0)
	slli	a5,a5,16
	srai	a5,a5,16
	.loc 1 1013 39 discriminator 1
	sw	a5,-20(s0)
	j	.L193
.L194:
	.loc 1 1017 17
...
.L137:
	...
	sw	a5,-76(s0)
.L134:
	.loc 1 810 12 discriminator 1
	lw	a5,-76(s0)
	lbu	a5,0(a5)
	.loc 1 810 5 discriminator 1
	bnez	a5,.L196
	.loc 1 1027 8
	lw	a5,-72(s0)
	beqz	a5,.L197
...
.LFB47:
	...
	nop
.L240:
	.loc 1 1371 26 discriminator 1
	lbu	a5,-17(s0)
	andi	a5,a5,0xff
	.loc 1 1371 19 discriminator 1
	beqz	a5,.L240
	.loc 1 1378 1
	j	.L242
.L239:
...
.LFE47:
	...
	.section	.rodata
	.align	2
	.type	large_digits.3248, @object
	.size	large_digits.3248, 17
large_digits.3248:
	.string	"0123456789ABCDEF"
	.align	2
	.type	small_digits.3247, @object
	.size	small_digits.3247, 17
small_digits.3247:
	.string	"0123456789abcdef"
	.local	rt_log_buf.3358
	.comm	rt_log_buf.3358,128,4
	.text
.Letext0:
	.file 2 "rt-thread/include/rtdef.h"
	.file 3 "/home/tang/toolchains/riscv-none-gcc/8.2.0-2.2-20190521-0004/lib/gcc/riscv-none-embed/8.2.0/include/stdarg.h"
...
.LASF1523:
	.string	"isdigit(c) ((unsigned)((c) - '0') < 10)"
.LASF283:
