...
# 156 "rt-thread/src/object.c"
void rt_object_trytake_sethook(void (*hook)(struct rt_object *object))
{
    rt_object_trytake_hook = hook;
}
# 175 "rt-thread/src/object.c"
void rt_object_take_sethook(void (*hook)(struct rt_object *object))
{
...
# 202 "rt-thread/src/object.c"
void rt_system_object_init(void)
{
}
# 218 "rt-thread/src/object.c"
struct rt_object_information *
rt_object_get_information(enum rt_object_class_type type)
{
    int index;
                    ...
                    const char *name)
{
    ...
    if (!(information != (0))) { rt_assert_handler("information != RT_NULL", __FUNCTION__, 251); };
            ...
            node = node->next)
    {
        ...
        if (obj)
        {
            if (!(obj != object)) { rt_assert_handler("obj != object", __FUNCTION__, 267); };
        }
    }
...
void rt_object_detach(rt_object_t object)
{
    ...
    if (!(object != (0))) { rt_assert_handler("object != RT_NULL", __FUNCTION__, 312); };
...
rt_object_t rt_object_allocate(enum rt_object_class_type type, const char *name)
{
    ...
    information = rt_object_get_information(type);
    if (!(information != (0))) { rt_assert_handler("information != RT_NULL", __FUNCTION__, 351); };
...
void rt_object_delete(rt_object_t object)
{
    ...
    if (!(object != (0))) { rt_assert_handler("object != RT_NULL", __FUNCTION__, 409); };
    if (!(!(object->type & RT_Object_Class_Static))) { rt_assert_handler("!(object->type & RT_Object_Class_Static)", __FUNCTION__, 410); };
...
# 440 "rt-thread/src/object.c"
rt_bool_t rt_object_is_systemobject(rt_object_t object)
{

    if (!(object != (0))) { rt_assert_handler("object != RT_NULL", __FUNCTION__, 443); };
...
# 459 "rt-thread/src/object.c"
rt_uint8_t rt_object_get_type(rt_object_t object)
{

    if (!(object != (0))) { rt_assert_handler("object != RT_NULL", __FUNCTION__, 462); };

    return object->type & ~RT_Object_Class_Static;
}
# 479 "rt-thread/src/object.c"
rt_object_t rt_object_find(const char *name, rt_uint8_t type)
{
    ...
    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 490); } } rt_hw_interrupt_enable(level); } while (0);
    ...
    if (information == (0))
    {
        ...
        if (!(information != (0))) { rt_assert_handler("information != RT_NULL", __FUNCTION__, 499); };
    }
    for (node = information->object_list.next;
            node != &(information->object_list);
            node = node->next)
