...
# 1 "drivers/drv_usart.c"
# 11 "drivers/drv_usart.c"
# 1 "drivers/drv_usart.h" 1
...
# 7 "drivers/drv_usart.h" 2

int rt_hw_usart_init(void);
# 12 "drivers/drv_usart.c" 2
# 21 "drivers/drv_usart.c"
struct gd32_usart {
    char *name;
...
static struct gd32_usart usart_config[] = {
        ...
        { "uart0",
        ((((uint32_t)0x40000000U) + 0x00004400U)+(0x0000F400U)),
        RCU_USART0,
        RCU_GPIOA,
        ((((uint32_t)0x40010000U) + 0x00000800U) + 0x00000000U),
...
static rt_err_t gd32_configure(struct rt_serial_device *serial,
    ...
    if (!(cfg != (0))) { rt_assert_handler("cfg != RT_NULL", __FUNCTION__, 56); };

    usart = (struct gd32_usart *) serial->parent.user_data;
    if (!(usart != (0))) { rt_assert_handler("usart != RT_NULL", __FUNCTION__, 59); };
    ...
    gpio_init(usart->gpio_port, ((uint8_t)0x18U), ((uint8_t)0x03U),
            usart->tx_pin);

    gpio_init(usart->gpio_port, ((uint8_t)0x04U), ((uint8_t)0x03U),
            usart->rx_pin);
    ...
    case 8:
        usart_word_length_set(usart->usart_base, (((uint32_t)((uint32_t)0x01U<<(12))) & ((uint32_t)(0) << 12)));
        break;

    case 9:
        usart_word_length_set(usart->usart_base, (((uint32_t)((uint32_t)0x01U<<(12))) & ((uint32_t)(1) << 12)));
        break;
    default:
        usart_word_length_set(usart->usart_base, (((uint32_t)((uint32_t)0x01U<<(12))) & ((uint32_t)(0) << 12)));
        break;
    ...
    case 0:
        usart_stop_bit_set(usart->usart_base, (((0xFFFFFFFFUL << (12)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(13)))) & ((uint32_t)(0) << 12)));
        break;
    case 1:
        usart_stop_bit_set(usart->usart_base, (((0xFFFFFFFFUL << (12)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(13)))) & ((uint32_t)(2) << 12)));
        break;
    default:
        usart_stop_bit_set(usart->usart_base, (((0xFFFFFFFFUL << (12)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(13)))) & ((uint32_t)(0) << 12)));
        break;
    ...
    switch (cfg->parity) {
    case 0:
        usart_parity_config(usart->usart_base, (((0xFFFFFFFFUL << (9)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(10)))) & ((uint32_t)(0) << 9)));
        break;
    case 1:
        usart_parity_config(usart->usart_base, (((0xFFFFFFFFUL << (9)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(10)))) & ((uint32_t)(3) << 9)));
        break;
    case 2:
        usart_parity_config(usart->usart_base, (((0xFFFFFFFFUL << (9)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(10)))) & ((uint32_t)(2) << 9)));
        break;
    default:
        usart_parity_config(usart->usart_base, (((0xFFFFFFFFUL << (9)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(10)))) & ((uint32_t)(0) << 9)));
        break;
    }
    usart_hardware_flow_rts_config(usart->usart_base, (((uint32_t)((uint32_t)0x01U<<(8))) & ((uint32_t)(0) << 8)));
    usart_hardware_flow_cts_config(usart->usart_base, (((uint32_t)((uint32_t)0x01U<<(8))) & ((uint32_t)(0) << 8)));
    usart_receive_config(usart->usart_base, (((uint32_t)((uint32_t)0x01U<<(2))) & ((uint32_t)(1) << 2)));
    usart_transmit_config(usart->usart_base, (((uint32_t)((uint32_t)0x01U<<(3))) & ((uint32_t)(1) << 3)));
...
static rt_err_t gd32_control(struct rt_serial_device *serial, int cmd,
    ...
    if (!(serial != (0))) { rt_assert_handler("serial != RT_NULL", __FUNCTION__, 127); };
    usart = (struct gd32_usart *) serial->parent.user_data;
    if (!(usart != (0))) { rt_assert_handler("usart != RT_NULL", __FUNCTION__, 129); };
...
static int gd32_putc(struct rt_serial_device *serial, char ch) {
    ...
    usart = (struct gd32_usart *) serial->parent.user_data;
    if (!(usart != (0))) { rt_assert_handler("usart != RT_NULL", __FUNCTION__, 152); };
...
static int gd32_getc(struct rt_serial_device *serial) {
    ...
    if (!(serial != (0))) { rt_assert_handler("serial != RT_NULL", __FUNCTION__, 165); };
    usart = (struct gd32_usart *) serial->parent.user_data;
    if (!(usart != (0))) { rt_assert_handler("usart != RT_NULL", __FUNCTION__, 167); };
...
static void usart_isr(struct rt_serial_device *serial) {
    ...
    if (!(serial != (0))) { rt_assert_handler("serial != RT_NULL", __FUNCTION__, 184); };

    usart = (struct gd32_usart *) serial->parent.user_data;
    if (!(usart != (0))) { rt_assert_handler("usart != RT_NULL", __FUNCTION__, 187); };
...
int rt_hw_usart_init(void) {
    ...
    for (index = 0; index < obj_num; index++) {
        ...
        result = rt_hw_serial_register(&usart_config[index].serial,
                ...
                0x003 | 0x100
                        | 0x400, &usart_config[index]);
        if (!(result == 0)) { rt_assert_handler("result == RT_EOK", __FUNCTION__, 238); };
    }
